...
<p align="center">
  <a href="https://discord.gg/6UyHPeGZAC" target="_blank" >
      <img alt="Discord" src="https://img.shields.io/discord/1114740394715004990?logo=Discord&logoColor=white&label=Discord&labelColor=%235568ee&color=%2355A2DD&link=https%3A%2F%2Fdiscord.gg%2F6UyHPeGZAC" style="vertical-align: middle;">
  </a> |
  <a href="https://github.com/Mintplex-Labs/anything-llm/blob/master/LICENSE" target="_blank">
      <img src="https://img.shields.io/github/license/Mintplex-Labs/anything-llm?color=white" alt="License" style="vertical-align: middle;">
  </a> |
  <a href="https://docs.useanything.com" target="_blank">
    <img src="https://img.shields.io/badge/docs-reference-blue" alt="Docs" style="vertical-align: middle;">
  </a> |
   <a href="https://my.mintplexlabs.com/aio-checkout?product=anythingllm" target="_blank">
    <img src="https://img.shields.io/badge/host-instance-blue" alt="Hosting Instance" style="vertical-align: middle;">
  </a>
</p>

A full-stack application that enables you to turn any document, resource, or piece of content into context that any LLM can use as references during chatting. This application allows you to pick and choose which LLM or Vector Database you want to use. Currently this project supports [Pinecone:link:](https://pinecone.io), [ChromaDB:link:](https://trychroma.com) & more for vector storage and [OpenAI:link:](https://openai.com) for LLM/chatting.
...
You can verify these claims by finding all locations `Telemetry.sendTelemetry` is called. Additionally these events are written to the output log so you can also see the specific data which was sent - if enabled. No IP or other identifying information is collected. The Telemetry provider is [PostHog:link:](https://posthog.com/) - an open-source telemetry collection service.
