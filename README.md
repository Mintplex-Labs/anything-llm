# hempGPT 🧠🌿
An AI-powered factory assistant for your business

hempGPT is a drop-in GPT-style chat agent trained on your internal documentation—SOPs, order volumes, health & safety, machine operations, and more. It helps your team get answers fast, stay safe, and keep things moving.

## 💼 Built for factory floors
Drop in your own business context—hemp, food production, warehousing, whatever—and hempGPT becomes the assistant your team wishes they had.

✅ Ask about shift procedures  
📦 Look up order or production volumes  
🛠️ Troubleshoot common machine issues  
🔐 Check safety protocols  
🚨 Report hazards or incidents  

## ⚙️ How it works
1. Upload your internal docs
2. Run the app locally or deploy to the web
3. Employees log in and start asking questions

## 🔒 Private & secure
Your data stays yours—no third-party logging, no external API calls unless you want them.

## 🚀 Roadmap
- [ ] Admin dashboard
- [ ] Voice-to-text input for on-floor use
- [ ] Slack/Teams integration
- [ ] Live doc sync (Notion, Google Drive)

## 👷 Made for real teams
We built this because answering the same questions 100 times a week gets old. With hempGPT, you train once—then let your assistant do the rest.
