...
These packs are native SPARKY Wiki reference knowledge for current SWARMSY workspaces. They are docs/spec-only, workspace-scoped, local-first, and cannot override current app truth, provider routing, runtime behavior, user memory, or workspace permissions.

- [`packs/swarmsy-core-truth-archive/`](./packs/swarmsy-core-truth-archive/) — SWARMSY truth, manifesto, and persona references; draft-importable only, never current app truth.
...
- [`packs/local-user-support-and-troubleshooting-archive/`](./packs/local-user-support-and-troubleshooting-archive/) — Draft support archive for local/Ollama/user setup context.
...
- [`packs/swarmsy-app-brain-reference-archive/`](./packs/swarmsy-app-brain-reference-archive/) — SPARKY app-brain reference roles for broad operator/campaign/research/safety context.
