...
source_path: docs/product/SWARMSY_DESIGN_CANON.md
...
# SWARMSY Design Canon (LIVE MULTI-AGENT MODE)

**Locked 2026-05-26**

UI must support clear agent swarm visualization and tool calling transparency.

Clean tactical ops aesthetic remains. The swarm does the heavy lifting behind simple controls.
