...
source_path: docs/brain/README_SANDBOX.md
...
# Street Swarm Brain Sandbox

Full rebuilt sandbox pack.

Contains:
- Brain files 00-76
- repo enhanced-copy/addendum drafts
- manifest

Status: local sandbox export only unless copied into repo.
