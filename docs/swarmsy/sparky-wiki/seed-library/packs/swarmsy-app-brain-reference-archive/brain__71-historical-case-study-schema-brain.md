---
title: 71 Historical Case Study Schema Brain
...
source_path: docs/brain/71-historical-case-study-schema-brain.md
...
# 71 Historical Case Study Schema Brain

Last source check: 2026-05-22

Historical/documentary files should use consistent schema.

## Schema

subject, period, sources, what happened, public pattern, why it mattered, risks/harms, lawful creative conversion, not-to-do boundary, related modules, tags.
