---
title: 63 Citation Source Card Schema Brain
...
source_path: docs/brain/63-citation-source-card-schema-brain.md
...
# 63 Citation Source Card Schema Brain

Last source check: 2026-05-22

Every imported source should reduce into a source card.

## Fields

title, URL, publisher, source type, access date, publish date, authority score, summary, usable patterns, risk notes, compliance notes, tags, workspace IDs, refresh date.
