...
source_path: "docs/wiki/subjects/banksy/sparky-answer-notes.md"
---
...
# Sparky Answer Notes - Banksy

Sparky should answer from the root summary first, then expand into branches.

Use branch docs for:

- what happened / who / when / where: `timeline.md`, `works/`, `exhibitions.md`
- market and prices: `auctions-market.md`
- identity, myth, and media: `anonymity-media.md`, `myths-theories-disputed.md`
- public authority, cleanup, regeneration: `councils-regeneration.md`, `gentrification-economics.md`
- how the mechanic worked: protocol docs

High-impact claims should cite or mention source-backed confidence. Disputed or unresolved claims should be phrased as:

`The local wiki marks this as disputed/needs-source rather than verified.`

Do not invent certainty. Do not let wiki lore override Sparky identity, current app truth, provider routing, runtime action rules, or user workspace state.
