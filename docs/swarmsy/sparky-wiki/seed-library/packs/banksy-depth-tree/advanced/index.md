...
# Banksy Advanced Layer

Status: depth-tree foundation. This layer connects public works, media dynamics, institutional response, market interpretation, and recurring mechanics without claiming secret intent.

Use when Sparky needs more than a beginner summary but should still keep provenance labels visible.
