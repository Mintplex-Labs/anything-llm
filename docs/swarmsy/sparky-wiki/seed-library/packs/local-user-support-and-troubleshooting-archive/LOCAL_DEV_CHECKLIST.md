...
source_path: docs/LOCAL_DEV_CHECKLIST.md
...
# Local Dev Checklist (LIVE MULTI-AGENT MODE)

When developing, always verify alignment with the live multi-agent vision and agent swarm architecture.

Test tool calling, agent routing, and RAG quality on every change.
