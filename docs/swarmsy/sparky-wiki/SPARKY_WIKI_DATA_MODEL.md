...
| Old SWARMSY legacy salvage notes | Source-mapped reference knowledge from `docs/swarmsy/legacy-salvage/`. |
...
```json
{
  ...
  "related_files_assets": [
    "local-assets/hidden-identity/reference-board.png"
  ]
}
```
