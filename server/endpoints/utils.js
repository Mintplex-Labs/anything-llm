 ...
 * as well as build features in PsionHQ directly for a specific model or capabilities.
 *
...
/**
 * Returns the user agent for the PsionHQ deployment.
 * @returns {string} The user agent.
 */
function getPsionHQUserAgent() {
  const version = getDeploymentVersion() || "unknown";
  return `PsionHQ/${version}`;
}
