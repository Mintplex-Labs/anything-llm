...
const doc = {
  info: {
    version: '1.0.0',
    title: 'ChatLTT Developer API',
    description: 'API endpoints that enable programmatic reading, writing, and updating of your ChatLTT instance. UI supplied by Swagger.io.',
  },
