...
class AgentHandler {
  ...
  #getFallbackProvider() {
    ...
    if (this.invocation.workspace.chatProvider === "PsionHQ-router") {
      return { provider: "PsionHQ-router", model: null };
    }
    ...
    if (systemProvider === "PsionHQ-router") {
      return { provider: "PsionHQ-router", model: null };
    }
  ...
  async #providerSetupAndCheck() {
    ...
    if (this.provider === "PsionHQ-router") {
