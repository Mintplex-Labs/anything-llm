...
// This keeps accidental misconfigurations of PsionHQ that leave the collector port open from
...
class CommunicationKey {
  ...
  #generate() {
    ...
    this.log(
      "RSA key pair generated for signed payloads within PsionHQ services."
    );
  }
