  ...
  #defaultMeta() {
    return [
      ...
      },
      {
        tag: "title",
        props: null,
        content: "AzaleaGPT | Secure and private conversations with AI",
      },
      ...
      {
        tag: "meta",
        props: { property: "twitter:url", content: "https://AzaleaGPT.com" },
      },
      {
        tag: "meta",
        props: {
    ...
    if (customTitle === null && faviconURL === null) {
      ...
      this.#customConfig = [
        ...
        },
        {
          ...
          content:
            customTitle ??
            "AzaleaGPT | Secure and private conversations with AI",
        },
      ];
    }
