...
function dumpENV() {
  ...
  const protectedKeys = [
    ...
    "GENERIC_OPEN_AI_TOP_P",
    "GENERIC_OPEN_AI_FREQUENCY_PENALTY",
    "GENERIC_OPEN_AI_PRESENCE_PENALTY",
    "GENERIC_OPEN_AI_SEED",
    "GENERIC_OPEN_AI_STOP",
    "GENERIC_OPEN_AI_EXTRA_PARAMS",
