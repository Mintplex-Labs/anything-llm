 ...
 * @param {('pinecone' | 'chroma' | 'chromacloud' | 'lancedb' | 'weaviate' | 'qdrant' | 'milvus' | 'zilliz' | 'astra' | 'pgvector' | 'oceanbase') | null} getExactly - If provided, this will return an explit provider.
