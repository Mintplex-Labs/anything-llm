...
Write-Host "  https://cdn.PsionHQ.com/support/open-computer/base-images/<DATE>/$TarName"
Write-Host "  https://cdn.PsionHQ.com/support/open-computer/base-images/<DATE>/$ShaName"
