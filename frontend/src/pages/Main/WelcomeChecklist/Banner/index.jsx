...
export default function WelcomeBanner() {
  return (
    <div className="max-w-[680px] w-full h-[60px] bg-[#142227] rounded-lg flex items-center p-[10px]">
      ...
      <div className="flex flex-col ml-[21px]">
        ...
        <p className="text-[#B6B7B7] text-xs">
          Let&apos;s get you started with some quick steps.
        </p>
      </div>
    </div>
  );
