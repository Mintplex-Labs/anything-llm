...
export default function WelcomeChecklist() {
  return (
    <div className="w-full h-full flex flex-col items-center justify-center pr-4">
        <WelcomeBanner />
      <div className="w-full max-w-[680px] min-h-[450px] flex flex-col rounded-[24px] border border-white/20 py-8 px-9">
        <div className="flex justify-between items-center mb-8">
          ...
          <p className="text-[#9F9FA0] text-xs">{CHECKLIST_ITEMS.filter(item => !item.completed).length} tasks left</p>
        </div>
      ...
      <button className="text-white text-sm hover:opacity-70 transition-opacity mt-5">Skip</button>
