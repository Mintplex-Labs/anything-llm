          ...
          >
            <div className="px-7 py-6">
              <div className="space-y-6 max-h-[60vh] overflow-y-auto pr-2">
                ...
                <div className="flex flex-col w-full">
                  <div className="border border-red-800 bg-zinc-800 light:bg-slate-100 light:bg-red-200/50 p-4 rounded-lg flex items-center gap-x-2 text-sm text-red-400 light:text-red-500">
                  ...
                  <label className="block mb-2 text-sm font-medium text-white light:text-theme-text-primary mt-4">
                ...
                <div className="flex flex-col w-full">
                  <label className="block mb-2 text-sm font-medium text-white light:text-theme-text-primary">
                    Connection name
                  </label>
                  <input
                    type="text"
                    name="name"
                    className="border-none bg-theme-settings-input-bg w-full text-white light:text-theme-text-primary placeholder:text-theme-settings-input-placeholder text-sm rounded-lg focus:outline-primary-button active:outline-primary-button outline-none block w-full p-2.5"
            ...
            <div className="flex justify-between items-center mt-6 pt-6 border-t border-theme-modal-border px-7 pb-6">
              <button
                type="button"
                onClick={handleClose}
                className="transition-all duration-300 text-white light:text-theme-text-primary hover:bg-zinc-700 light:hover:bg-slate-200 light:hover:bg-theme-bg-primary px-4 py-2 rounded-lg text-sm"
              >
                Cancel
              </button>
              <button
...
function DBEngine({ provider, active, onClick }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className={`flex flex-col p-4 border border-white/40 bg-zinc-800 light:bg-slate-100 light:bg-theme-settings-input-bg rounded-lg w-fit hover:bg-zinc-700 light:hover:bg-slate-200 ${
