    ...
    <div className="flex gap-x-4 items-center">
      ...
      <div className="flex w-full items-center justify-between">
        <div className="flex flex-col">
          <div className="text-sm font-semibold text-white light:text-theme-text-primary">{database_id}</div>
          <div className="mt-1 text-xs text-description">{engine}</div>
        </div>
        <button
          type="button"
          onClick={removeConfirmation}
          className="border-none text-white light:text-theme-text-primary hover:text-red-500"
        >
          <X size={24} />
        </button>
      </div>
