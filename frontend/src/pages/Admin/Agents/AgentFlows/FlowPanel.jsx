      ...
      <div className="p-2">
        <div className="flex flex-col gap-y-[18px] max-w-[500px]">
          <div className="flex items-center gap-x-2">
            <FlowArrow size={24} weight="bold" className="text-white light:text-theme-text-primary" />
          ...
          <p className="whitespace-pre-wrap text-white light:text-theme-text-primary text-opacity-60 text-xs font-medium py-1.5">
