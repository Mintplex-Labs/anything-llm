              ...
              {invite && (
                <div className="relative">
                  <input
                    ...
                    disabled={true}
                    className="border-none bg-theme-settings-input-bg text-white light:text-theme-text-primary placeholder:text-theme-settings-input-placeholder text-sm rounded-lg outline-none block w-full p-2.5 pr-10"
                  />
                  <button
                    type="button"
                  ...
                  >
                    {copied ? (
                      ...
                      <Copy size={20} className="text-white light:text-theme-text-primary" weight="bold" />
                    )}
                  </button>
                </div>
              )}
              ...
              <div className="mt-6">
                <div className="w-full">
                  <div className="flex flex-col gap-y-1 mb-2">
                    ...
                    <p className="text-white light:text-theme-text-primary text-opacity-60 text-xs">
              ...
              {!invite ? (
                <>
                  <button
                    onClick={closeModal}
                    type="button"
                    className="transition-all duration-300 text-white light:text-theme-text-primary hover:bg-zinc-700 light:hover:bg-slate-200 px-4 py-2 rounded-lg text-sm mr-2"
                  >
                    Cancel
                  </button>
                  <button
