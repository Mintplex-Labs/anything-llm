            ...
            <form onSubmit={acceptTos}>
              <div className="py-7 px-9 space-y-4 flex-col">
                <div className="w-full text-white text-md flex flex-col gap-y-4 custom-text-secondary">
                  <p>
                    Experimental features of {process.env.APPLICATION_FALLBACK_NAME || "Prism"} are features that we
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>Potential bugs or issues using {process.env.APPLICATION_FALLBACK_NAME || "Prism"}.</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>
                        ...
                        configurations, or subscriptions of {process.env.APPLICATION_FALLBACK_NAME || "Prism"}.
                      </li>
                      <li>
