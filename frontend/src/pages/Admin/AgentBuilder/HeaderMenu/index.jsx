      ...
      <div className="flex justify-between items-start max-w-[1700px] mx-auto">
        ...
        <div className="flex flex-col gap-y-1 items-end">
          <div className="flex items-center gap-x-[15px]">
            ...
            <button
              onClick={onSaveFlow}
              className="border-none bg-primary-button hover:opacity-80 text-white px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 flex items-center justify-center gap-2"
            >
              Save
            </button>
          </div>
