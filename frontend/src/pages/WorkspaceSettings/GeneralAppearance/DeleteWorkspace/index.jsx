  ...
  return (
    <div className="flex flex-col mt-10">
      ...
      <button
        ...
        type="button"
        className="w-60 mt-4 transition-all duration-300 border border-transparent rounded-sm whitespace-nowrap text-sm px-5 py-2.5 focus:z-10 bg-red-500/25 text-red-200 light:text-red-500 hover:light:text-foreground hover:text-foreground hover:bg-red-600 disabled:bg-red-600 disabled:text-red-200 disabled:animate-pulse"
      >
