...
export default function DeleteWorkspace({ workspace }) {
  ...
  return (
    <div className="flex flex-col mt-10">
      <label className="block input-label custom-text-secondary">{t("general.delete.title")}</label>
      <p className="text-theme-text-secondary text-xs font-medium py-1.5 custom-text-secondary">
