...
export default function WorkspaceSettings() {
  ...
  return (
    <div
      ...
      className="transition-all duration-500 relative bg-main-gradient w-full h-full overflow-y-scroll border-4 border-accent"
    >
      <Link
      ...
      <div className="flex flex-col w-full px-1 md:px-20 md:py-12 py-16">
        ...
        <div className="my-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs mt-6 w-full justify-center max-w-[600px]">
            {suggestedMessages.map((suggestion, index) => (
              <div key={index} className="relative w-full">
                ...
                >
                  <X className="m-[1px]" size={18} />
                </button>
                <button
                  key={index}
                  onClick={() => startEditing(index)}
                  className={`text-white/60 border-none text-left p-2.5 border rounded-xl w-full border-white/20 bg-sidebar hover:bg-workspace-item-selected-gradient ${
            ...
            <div className="flex flex-col gap-y-4 mr-2 mt-8">
              <div className="w-1/2">
                ...
                <input
                  ...
                  className="border-none bg-sidebar text-white placeholder-white placeholder-opacity-60 text-sm rounded-lg focus:border-white block w-full p-2.5"
          ...
          {hasChanges && (
            <div className="flex justify-center py-6">
              <button
                type="button"
                className="border-none transition-all duration-300 border border-slate-200 px-4 py-2 rounded-lg text-white text-sm items-center flex gap-x-2 hover:bg-slate-200 hover:text-slate-800 focus:ring-gray-800"
