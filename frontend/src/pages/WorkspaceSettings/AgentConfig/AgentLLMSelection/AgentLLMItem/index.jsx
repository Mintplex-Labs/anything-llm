          ...
          <form id="provider-form" onSubmit={handleUpdate}>
            ...
            <div className="flex w-full justify-between items-center p-3 space-x-2 border-t rounded-b border-gray-500/50">
              ...
              <button
                type="submit"
                form="provider-form"
                className="border-none text-xs px-2 py-1 font-semibold rounded-lg bg-[#FF5757] hover:bg-[#2C2F36] border-2 border-transparent hover:border-[#FF5757] hover:text-white h-[32px] w-fit -mr-8 whitespace-nowrap shadow-[0_4px_14px_rgba(0,0,0,0.25)]"
              >
