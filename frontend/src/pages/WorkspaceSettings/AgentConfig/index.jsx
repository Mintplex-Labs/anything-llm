        ...
        {!hasChanges && (
          <div className="flex flex-col gap-y-4">
            <Link to={paths.settings.agentSkills()}>
              <div className="w-fit transition-all duration-300 border border-slate-200 px-5 py-2.5 rounded-lg text-white text-sm items-center flex gap-x-2 hover:bg-slate-200 hover:text-slate-800 focus:ring-gray-800">
