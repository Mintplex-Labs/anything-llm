      ...
      >
        ...
        <div className="flex gap-x-4 items-center">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-1 text-xs text-white/60 custom-text-secondary">{description}</div>
          </div>
        </div>
      </div>
      <SetupProvider
          ...
          <form id="provider-form" onSubmit={handleUpdate}>
            <div className="px-7 py-6">
              <div className="space-y-6 max-h-[60vh] overflow-y-auto pr-2">
                ...
                <div className="custom-llm-provider-modal">{LLMOption.options({ credentialsOnly: true })}</div>
              </div>
            </div>
