        ...
        <div className="flex gap-x-4 items-center justify-between">
          ...
          {checked && !NO_SETTINGS_NEEDED.includes(value) && (
            <button
              ...
              className="p-2 text-white/60 light:text-theme-text-secondary hover:text-white light:hover:text-theme-text-primary hover:bg-theme-bg-hover rounded-md transition-all duration-300"
              title="Edit Settings"
            >
