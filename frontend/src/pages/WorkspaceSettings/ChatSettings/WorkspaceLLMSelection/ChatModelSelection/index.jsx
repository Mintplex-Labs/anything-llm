  ...
  return (
    <div>
      ...
      <select
        ...
        className="bg-theme-bg-input-dark text-white text-sm rounded-lg focus:outline-primary-button active:outline-primary-button outline-none block w-full p-2.5"
      >
