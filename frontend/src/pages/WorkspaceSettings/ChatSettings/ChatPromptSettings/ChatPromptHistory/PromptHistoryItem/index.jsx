...
export default function PromptHistoryItem({
  ...
  return (
    <div className="text-white light:text-theme-text-primary">
      <div className="flex items-center justify-between">
        <div className="text-xs">
          {user && (
            <>
              <span className="text-primary-button">{user.username}</span>{" "}
              <span className="mx-1 text-white light:text-theme-text-primary">•</span>
            </>
          )}
          <span className="text-white light:text-theme-text-primary opacity-50 light:opacity-100">
          ...
          <div className="relative">
            ...
            {showMenu && (
              ...
              >
                <button
                  type="button"
                  className="px-[10px] py-[6px] text-sm text-white light:text-theme-text-primary hover:bg-theme-sidebar-item-hover rounded-t-lg cursor-pointer border-none w-full text-left whitespace-nowrap"
                  onClick={() => {
                    setShowMenu(false);
                ...
                <button
                  type="button"
                  className="px-[10px] py-[6px] text-sm text-white light:text-theme-text-primary hover:bg-red-500/60 light:hover:bg-red-300/80 rounded-b-lg cursor-pointer border-none w-full text-left whitespace-nowrap"
                  onClick={() => {
                    setShowMenu(false);
                    deleteHistory(id);
                  }}
