      ...
      <div className="flex flex-col gap-y-1 mt-2">
        <div className="w-fit flex gap-x-1 items-center p-1 rounded-lg bg-theme-settings-input-bg ">
          ...
          <button
            ...
            className="transition-bg duration-200 px-6 py-1 text-md text-white/60 light:text-theme-text-secondary disabled:text-white light:text-theme-text-primary bg-transparent disabled:bg-[#687280] rounded-md"
          >
