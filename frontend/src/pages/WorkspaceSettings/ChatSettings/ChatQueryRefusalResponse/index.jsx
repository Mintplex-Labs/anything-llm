  ...
  return (
    <div>
      ...
      <textarea
        ...
        className="border-none bg-zinc-900 placeholder:text-theme-settings-input-placeholder text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mt-2"
