    ...
    <div className="relative w-full md:max-w-2xl max-h-full">
      <div className="w-full max-w-2xl bg-theme-bg-secondary rounded-lg shadow border-2 border-theme-modal-border overflow-hidden">
        ...
        <div className="w-full p-6">
          <pre className="w-full h-[200px] py-2 px-4 whitespace-pre-line overflow-auto rounded-lg bg-zinc-900 light:bg-slate-50 light:bg-theme-bg-secondary border border-gray-500 light:border-gray-300 text-white light:text-theme-text-primary text-sm">
            {text}
          </pre>
        </div>
      </div>
