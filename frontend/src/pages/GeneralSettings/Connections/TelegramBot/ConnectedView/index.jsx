        ...
        {connected && (
          <div className="flex flex-col gap-y-2 rounded-lg bg-theme-bg-primary p-4">
            ...
            <button
              ...
              className="flex items-center justify-center gap-x-2 text-sm font-medium text-white bg-red-800 hover:bg-red-700 rounded-lg px-4 py-0.5 w-fit transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {disconnecting ? (
                <>
                  <CircleNotch className="h-4 w-4 animate-spin" />
