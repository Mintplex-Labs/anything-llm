...
const PROVIDERS = [
  ...
  },
  {
    ...
    description:
      "Connect to an OpenAI compatible STT service (Whisper API) running locally or remotely.",
  },
];
...
export default function SpeechToTextProvider({ settings }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (error) {
      showToast(t("toast.audio.stt-error", { error }), "error");
    } else {
      showToast(t("toast.audio.stt-saved"), "success");
    }
    setSaving(false);
    setHasChanges(!!error);
  };
