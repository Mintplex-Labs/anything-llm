    ...
    <form className="mb-6" onSubmit={updateCustomAppName}>
      ...
      <div className="flex items-center gap-x-4">
        <input
          name="customAppName"
          type="text"
          className="bg-zinc-900 mt-3 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 max-w-[275px] placeholder:text-theme-settings-input-placeholder"
