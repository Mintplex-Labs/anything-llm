  ...
  return (
    <form onSubmit={handleSubmit} className="flex items-center gap-x-1.5">
      ...
      <input
        ...
        className="bg-zinc-900 text-white placeholder:text-theme-settings-input-placeholder text-sm rounded-md p-2.5 w-[300px] h-[32px] focus:outline-primary-button active:outline-primary-button outline-none"
        required
      />
      {selectedIcon !== "Plus" && (
        <>
