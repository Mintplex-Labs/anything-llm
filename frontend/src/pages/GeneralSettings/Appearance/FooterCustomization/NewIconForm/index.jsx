  ...
  return (
    <form onSubmit={handleSubmit} className="flex items-center gap-x-1.5">
      ...
      <input
        ...
        className="bg-dark-highlight text-white placeholder-white/20 text-sm rounded-md p-2.5 w-[300px] h-[32px] focus:outline-primary-button active:outline-primary-button outline-none"
        required
      />
      {selectedIcon !== "Plus" && (
        <>
