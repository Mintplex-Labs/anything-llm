        ...
        <div className="flex flex-col w-full px-1 md:pl-6 md:pr-[50px] md:py-6 py-16">
          <div className="w-full flex flex-col gap-y-1 pb-6 border-theme-modal-border border-b-2">
            ...
            <p className="text-xs leading-[18px] font-base text-theme-text-secondary mt-2">
              Manage reusable workspace templates. Templates allow you to
              quickly create new workspaces with pre-configured settings like
              system prompts, chat modes, and LLM preferences.
            </p>
          </div>
          ...
          <div className="overflow-x-auto mt-6">
            {loading ? (
              ...
              <table className="w-full text-xs text-left rounded-lg min-w-[640px] border-spacing-0">
                <thead className="text-theme-text-secondary text-xs leading-[18px] font-bold uppercase border-theme-modal-border border-b">
                  <tr>
                  ...
                  {templates.length === 0 ? (
                    <tr className="bg-transparent text-theme-text-secondary text-sm font-medium">
                      <td colSpan="4" className="px-6 py-4 text-center">
                        No workspace templates found. Create one from any
