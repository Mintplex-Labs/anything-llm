          ...
          {editingName ? (
            <div className="flex items-center gap-x-1">
              <input
                ...
                disabled={saving}
                className="bg-theme-settings-input-bg text-white text-xs rounded px-2 py-1 outline-none focus:outline-primary-button w-40"
              />
            </div>
          ) : (
          ...
          {editingDesc ? (
            <div className="flex items-center gap-x-1">
              <input
                ...
                className="bg-theme-settings-input-bg text-white text-xs rounded px-2 py-1 outline-none focus:outline-primary-button w-48"
              />
            </div>
          ) : (
            <div className="flex items-center gap-x-2 group">
