...
export default function CustomSiteSettings() {
  ...
  return (
    <form
      className="flex flex-col gap-y-0.5 my-4 border-t border-white light:border-theme-modal-border border-opacity-20 light:border-black/20 pt-6"
    ...
    >
      ...
      <div className="w-fit">
        <p className="text-sm leading-6 font-medium text-white light:text-theme-text-primary mt-2">
