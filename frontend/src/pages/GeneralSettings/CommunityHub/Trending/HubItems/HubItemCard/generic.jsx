...
export default function GenericHubCard({ item }) {
  return (
    <div
      key={item.id}
      className="bg-zinc-800 light:bg-slate-100 rounded-lg p-3 transition-all duration-200 border custom-button-secondary"
    >
...
export function VisibilityIcon({ visibility = "public" }) {
  ...
  return (
    <>
      ...
      >
        <Icon className="w-4 h-4 text-white/60 custom-text-secondary" />
      </div>
      <Tooltip
        id="visibility-icon"
        place="top"
