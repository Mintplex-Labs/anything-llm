    ...
    <div className="flex flex-col mt-4 gap-y-4">
      <div className="flex flex-col gap-y-1">
        ...
        {item.creatorUsername && (
          <p className="text-white/60 text-xs font-mono custom-text-secondary">
            Created by{" "}
            <a
      ...
      <div className="flex flex-col gap-y-[25px] text-white/80 light:text-theme-text-secondary text-sm custom-text-secondary">
        ...
        <div className="flex flex-col gap-y-2 mt-2">
          <div className="w-full text-theme-text-primary text-md gap-x-2 flex items-center">
            <p className="text-white/60 light:text-theme-text-secondary w-fit font-mono bg-zinc-900 light:bg-slate-200 px-2 py-1 rounded-md text-sm whitespace-pre-line custom-theme-bg-tertiary custom-text-secondary custom-border-secondary">
              {item.command}
            </p>
          </div>

          <div className="w-full text-theme-text-primary text-md flex flex-col gap-y-2">
            <p className="text-white/60 light:text-theme-text-secondary font-mono bg-zinc-900 light:bg-slate-200 p-4 rounded-md text-sm whitespace-pre-line max-h-[calc(200px)] overflow-y-auto custom-theme-bg-tertiary custom-text-secondary custom-border-secondary">
              {item.prompt}
            </p>
          </div>
        </div>
