  ...
  return (
    <>
      <tr className="bg-transparent text-white light:text-theme-text-primary text-opacity-80 text-xs font-medium border-b border-white/10 h-10">
        <td className="px-6 font-medium whitespace-nowrap text-white light:text-theme-text-primary">
          <a
            href={paths.settings.embedChatWidgets()}
            target="_blank"
            rel="noreferrer"
            className="text-white light:text-theme-text-primary flex items-center hover:underline"
          >
    ...
    <div className="relative w-full md:max-w-2xl max-h-full">
      <div className="w-full max-w-2xl bg-theme-bg-secondary rounded-lg shadow border-2 border-theme-modal-border overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b rounded-t border-theme-modal-border">
          <h3 className="text-xl font-semibold text-white light:text-theme-text-primary">Viewing Text</h3>
          <button
            onClick={closeModal}
            type="button"
        ...
        <div className="w-full p-6">
          <div className="w-full h-[60vh] py-2 px-4 whitespace-pre-line overflow-auto rounded-lg bg-zinc-900 light:bg-slate-50 light:bg-theme-bg-secondary border border-gray-500 light:border-gray-300 text-white light:text-theme-text-primary text-sm">
            {text}
          </div>
        </div>
      </div>
