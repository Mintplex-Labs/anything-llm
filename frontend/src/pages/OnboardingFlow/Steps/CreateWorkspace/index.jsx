...
import illustration from "@/assets/illustrations/create-workspace.png";
      ...
      <div className="flex flex-col gap-y-4 w-full max-w-[600px]">
        ...
        <div className="w-full mt-4">
          ...
          <input
            name="name"
            type="text"
            className="border-none bg-zinc-900 text-white placeholder:text-white/20 text-sm rounded-lg block w-full p-2.5"
