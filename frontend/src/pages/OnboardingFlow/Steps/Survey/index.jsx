...
const TITLE = "Welcome to Raiqa Assistant";
const DESCRIPTION = "Help us make Raiqa Assistant built for your needs. Optional.";
      ...
      <form onSubmit={handleSubmit} ref={formRef} className="">
        ...
        <div className="mt-8">
          <label
            ...
            htmlFor="use_case"
          >
            What will you use Raiqa Assistant for?{" "}
          </label>
