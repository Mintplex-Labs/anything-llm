            ...
            <div className="flex justify-center items-center">
              {forwardBtn.showing && (
                <button
                  ...
                  className="group p-2 rounded-lg border-2 border-zinc-300 disabled:border-zinc-600 h-fit w-fit disabled:not-allowed hover:bg-card disabled:hover:bg-transparent"
                >
                  <ArrowRight
      ...
      <div className="flex w-1/5 h-screen justify-center items-center">
        {forwardBtn.showing && (
          <button
            disabled={forwardBtn.disabled}
            onClick={forwardBtn.onClick}
            className="group p-2 rounded-lg border-2 border-theme-sidebar-border h-fit w-fit disabled:cursor-not-allowed hover:bg-card disabled:hover:bg-transparent"
            aria-label="Continue"
          >
            <ArrowRight
