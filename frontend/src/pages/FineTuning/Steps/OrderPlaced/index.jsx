    ...
    <div className="flex-[2] flex flex-col gap-y-[18px] mt-10">
      <div className="bg-theme-bg-secondary rounded-xl flex-1 p-6 custom-theme-bg-secondary">
        <div className="w-full flex flex-col gap-y-2 max-w-[700px]">
          ...
          <div className="flex flex-col gap-y-[25px] text-theme-text-secondary text-xs custom-text-secondary">
            <p>
            ...
            <div className="flex flex-col gap-y-2">
              <p className="text-theme-text-secondary font-medium custom-text-secondary">
