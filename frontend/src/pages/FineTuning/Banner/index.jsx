...
export function FineTuningAlert() {
  ...
  if (!isEligible || !document.getElementById("titlebar")) return null;
  return createPortal(
    <div className="relative">
      <div
        className={`fixed ${className} left-0 right-0 h-14 bg-orange-400 flex items-center justify-end px-4 z-[998]`}
      >
        <Link
