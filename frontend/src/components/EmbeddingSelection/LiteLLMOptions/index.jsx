      ...
      <div className="w-full flex items-center gap-[36px] mt-1.5">
        ...
        <div className="flex flex-col w-60">
          ...
          <input
            ...
            className="border-none bg-zinc-900 text-white placeholder-white/20 text-sm rounded-lg focus:outline-primary-button active:outline-primary-button outline-none block w-full p-2.5"
            placeholder="8192"
            min={1}
