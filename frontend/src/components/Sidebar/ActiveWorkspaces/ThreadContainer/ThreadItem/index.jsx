...
export default function ThreadItem({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`flex w-full items-center justify-between pr-2 group relative ${isActive ? "bg-theme-sidebar-subitem-selected" : "hover:bg-theme-sidebar-subitem-hover"} rounded-[4px]`}
      >
        {thread.deleted ? (
