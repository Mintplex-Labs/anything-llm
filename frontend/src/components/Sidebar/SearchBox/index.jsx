  ...
  return (
    <>
      <button
        ...
        className="border-none flex items-center justify-center bg-card rounded-sm p-[8px] hover:bg-card transition-all duration-300"
      >
        <Plus size={16} weight="bold" className="text-foreground" />
      </button>
      <Tooltip
