...
export default function MiniMaxOptions({ settings }) {
  ...
  const [miniMaxKey, setMiniMaxKey] = useState(settings?.MiniMaxApiKey);
    ...
    <div className="flex gap-[36px] mt-1.5">
      <div className="flex flex-col w-60">
        ...
        <input
          ...
          onBlur={() => setMiniMaxKey(inputValue)}
        />
      </div>
      {!settings?.credentialsOnly && (
        <MiniMaxModelSelection settings={settings} apiKey={miniMaxKey} />
      )}
    </div>
  );
}
