            ...
            <>
              {!basePathValue.value && (
                <button
                  ...
                  className="bg-primary-button text-white text-xs font-medium px-2 py-1 rounded-lg hover:bg-secondary hover:text-white light:hover:text-theme-text-primary shadow-[0_4px_14px_rgba(0,0,0,0.25)]"
                >
                  Auto-Detect
                </button>
              )}
