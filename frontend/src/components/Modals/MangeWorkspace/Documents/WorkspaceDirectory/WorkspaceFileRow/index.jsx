...
export default function WorkspaceFileRow({
  ...
  return (
    <div
      className={`items-center transition-all duration-200 text-white/80 text-xs grid grid-cols-12 py-2 pl-3.5 pr-8 border-white/20 hover:bg-sky-500/20 cursor-pointer
