...
function FileUploadProgressComponent({
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col">
          <p className="text-white light:text-theme-text-primary light:text-red-600 text-xs font-semibold">
  ...
  return (
    <div
      className={`${
        isFadingOut ? "file-upload-fadeout" : "file-upload"
      } h-14 px-2 py-2 flex items-center gap-x-4 rounded-lg bg-zinc-800 light:bg-slate-100 light:border-solid light:border-theme-modal-border light:bg-theme-bg-sidebar border border-white/20 shadow-md`}
    >
      <div className="w-6 h-6 flex-shrink-0">
        {status !== "complete" ? (
