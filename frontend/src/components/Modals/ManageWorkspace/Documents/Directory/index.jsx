        ...
        <div className="flex items-center justify-between w-[560px] px-5 relative">
          ...
          <div className="relative">
            <input
              ...
              className="search-input border-none bg-zinc-900 text-white placeholder-white/40 text-sm rounded-lg pl-9 pr-2.5 py-2 w-[250px] h-[32px]"
            />
            <MagnifyingGlass
              size={14}
          ...
          <button
            className="border-none flex items-center gap-x-2 cursor-pointer px-[14px] py-[7px] -mr-[14px] rounded-lg hover:bg-[#222628]/60 z-20 relative"
