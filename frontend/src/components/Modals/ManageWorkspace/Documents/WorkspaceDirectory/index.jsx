  ...
  if (loading) {
    return (
      <div className="px-8">
        ...
        <div className="relative w-full h-[445px] bg-theme-settings-input-bg rounded-2xl mt-5 border border-theme-modal-border">
  ...
  return (
    <>
      <div className="px-8">
        ...
        <div className="relative w-full h-[445px] mt-5">
          <div
