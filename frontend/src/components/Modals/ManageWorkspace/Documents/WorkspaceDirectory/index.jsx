      ...
      <div className="w-full max-w-2xl bg-theme-bg-secondary rounded-lg shadow border-2 border-theme-modal-border overflow-hidden">
        ...
        <div className="py-7 px-9 space-y-2 flex-col">
          <div className="w-full text-white text-md flex flex-col gap-y-2">
            <p>
              When you <b>pin</b> a document in {process.env.APPLICATION_FALLBACK_NAME || "Prism"} we will inject the
            ...
            <p>
              If you are not getting the answers you desire from {process.env.APPLICATION_FALLBACK_NAME || "Prism"} by
    ...
    <ModalWrapper isOpen={showAlert} noPortal={true}>
      <div className="w-full max-w-2xl bg-theme-bg-secondary rounded-lg shadow border-2 border-theme-modal-border overflow-hidden">
        ...
        <div className="py-7 px-9 space-y-2 flex-col">
          <div className="w-full text-white text-md flex flex-col gap-y-2">
            <p>
              When you <b>watch</b> a document in {process.env.APPLICATION_FALLBACK_NAME || "Prism"} we will{" "}
