            ...
            <div className="w-full flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-y-1 mb-4">
                  <label className="text-white text-sm font-bold flex gap-x-2 items-center">
                    <p className="font-bold text-theme-text-primary">
                      {t("connectors.jira.deployment_type")}
                    </p>
                  </label>
              ...
              <div className="flex flex-col pr-10">
                ...
                >
                  {[
                    {
                      name: t("connectors.jira.auth_type_username"),
                      value: "username",
                    },
                    {
                      name: t("connectors.jira.auth_type_personal"),
                      value: "personalToken",
                    },
                  ].map((type) => {
                    return (
                  ...
                  <div className="flex flex-col pr-10">
                    <div className="flex flex-col gap-y-1 mb-4">
                      <label className="text-white text-sm font-bold flex gap-x-2 items-center">
                        ...
                        >
                          <p className="text-sm">
                            {t("connectors.jira.token_explained_start")}
                            <a
                            ...
                            >
                              {t("connectors.jira.token_explained_link")}
                            </a>
                            .
                          </p>
                        </Tooltip>
