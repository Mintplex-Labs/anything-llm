              ...
              <div className="flex flex-col">
                ...
                <div className="flex gap-x-2">
                  <input
                    ...
                    readOnly
                  />
                  <label className="px-3 py-2 bg-theme-settings-input-bg border border-none rounded-lg text-white light:text-theme-text-primary hover:bg-theme-settings-input-bg/80 cursor-pointer">
                    <FolderOpen size={20} />
                    <input
                      type="file"
                      webkitdirectory=""
                ...
                {selectedFiles.length > 0 && (
                  <>
                    <p className="text-xs text-white light:text-theme-text-primary mt-2 font-bold">
                    ...
                    {selectedFiles.map((file, i) => (
                      <p key={i} className="text-xs text-white light:text-theme-text-primary mt-2">
