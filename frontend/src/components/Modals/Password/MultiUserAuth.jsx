...
const RecoveryCodeModal = ({ isOpen, onClose, recoveryCodes }) => {
          ...
          <div className="py-[17px] px-[20px]">
            ...
            <div className="mt-4">
              <p className="text-sm text-white">
                Please save these recovery codes in a secure location. You can
                use them to recover your account if you lose access to your
                password.
              </p>
