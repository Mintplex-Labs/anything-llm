            ...
            <div className="flex flex-col gap-y-4 w-full p-6 text-center">
              ...
              <div className="flex flex-col gap-y-2  mt-4 ">
                <p className="text-sm text-white/80">
                  By making a one-time, "pay what you want" supporter payment,
                  you can contribute to the continuous development of
                  AnythingLLM Desktop.
                </p>
              ...
              <div className="flex flex-col w-full justify-center items-center mt-4 gap-y-1">
                ...
                <p className="text-[10px] text-white/60">
                  payment portal may not be available depending on your
