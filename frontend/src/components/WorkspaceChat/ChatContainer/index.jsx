...
export default function ChatContainer({ workspace, knownHistory = [] }) {
  ...
  return (
    <div
      ...
      className="transition-all duration-500 relative md:ml-[2px] md:mr-[16px] md:my-[16px] md:rounded-[16px] bg-hemp-neutral w-full h-full overflow-y-scroll no-scroll z-[2] border border-hemp-accent shadow-sm"
    >
