          ...
          <form onSubmit={handleSubmit}>
              ...
              <div className="w-full flex flex-col gap-y-4">
                <div>
                  ...
                  <div className="flex items-center">
                    <span className="text-white light:text-theme-text-primary text-sm mr-2 font-bold">/</span>
                    <input
                      name="command"
                      type="text"
                      id="command"
            ...
            <div className="flex w-full justify-end items-center p-6 space-x-2 border-t border-theme-modal-border rounded-b">
              <button
                onClick={onClose}
                type="button"
                className="transition-all duration-300 bg-transparent text-white light:text-theme-text-primary hover:opacity-60 px-4 py-2 rounded-lg text-sm"
              >
