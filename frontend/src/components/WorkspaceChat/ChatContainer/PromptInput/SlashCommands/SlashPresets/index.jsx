    ...
    >
      ...
      {showMenu && (
        ...
        >
          ...
          <button
            type="button"
            className="px-[10px] py-[6px] text-sm text-white light:text-theme-text-primary hover:bg-theme-sidebar-item-hover rounded-b-lg cursor-pointer border-none w-full text-left whitespace-nowrap"
            onClick={(e) => {
              e.stopPropagation();
              setShowMenu(false);
              onPublish(preset);
