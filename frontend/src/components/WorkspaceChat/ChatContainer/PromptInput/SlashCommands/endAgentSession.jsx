  ...
  return (
    ...
    >
      <div className="w-full flex-col text-left flex pointer-events-none">
        <div className="text-white light:text-theme-text-primary text-sm font-bold">/exit</div>
        <div className="text-white light:text-theme-text-primary text-opacity-60 text-sm">
