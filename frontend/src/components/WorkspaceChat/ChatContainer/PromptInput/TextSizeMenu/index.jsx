      ...
      >
        ...
        >
          <div className="w-full flex-col text-left flex pointer-events-none">
            <div className="text-theme-text-primary text-xs">{t("text_size.small")}</div>
          </div>
        </button>
        ...
        >
          <div className="w-full flex-col text-left flex pointer-events-none">
            <div className="text-theme-text-primary text-sm">{t("text_size.normal")}</div>
          </div>
        </button>
        ...
        >
          <div className="w-full flex-col text-left flex pointer-events-none">
            <div className="text-theme-text-primary text-[16px]">{t("text_size.large")}</div>
          </div>
        </button>
      </div>
    </div>
