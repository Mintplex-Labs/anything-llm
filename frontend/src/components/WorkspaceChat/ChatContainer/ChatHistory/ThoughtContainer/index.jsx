            ...
            >
              ...
              {canExpand && (
                <button
                  ...
                  className="absolute top-4 right-4 border-none text-zinc-200 light:text-infinite-night transition-colors"
              ...
              >
                <div className="text-zinc-200 light:text-infinite-night font-mono text-sm leading-[18px] [&_p]:m-0">
                  <span
