...
export function Chartable({ props, workspace }) {
  ...
  const renderChart = () => {
    switch (chartType) {
      case "area":
        return (
          <div className="bg-theme-bg-primary p-8 rounded-xl text-white light:text-theme-text-primary light:border light:border-theme-border-primary">
      ...
      case "line":
        return (
          <div className="bg-theme-bg-primary p-8 pb-12 rounded-xl text-white light:text-theme-text-primary h-[500px] w-full light:border light:border-theme-border-primary">
            <h3 className="text-lg text-theme-text-primary font-medium">
              {title}
            </h3>
            <LineChart
...
const customTooltip = (props) => {
  ...
  return (
    <div className="w-56 bg-theme-bg-primary rounded-lg border p-2 text-white light:text-theme-text-primary">
