    ...
    return (
      <div className="flex flex-col h-full md:mt-0 pb-44 md:pb-40 w-full justify-end items-center">
        <div className="flex flex-col items-center md:items-start md:max-w-[600px] w-full px-4">
          <p className="text-white/60 light:text-theme-text-secondary text-lg font-base py-4">
            {t("chat_window.welcome")}
          </p>
          {!user || user.role !== "default" ? (
            <p className="w-full items-center text-white/60 light:text-theme-text-secondary text-lg font-base flex flex-col md:flex-row gap-x-1">
      ...
      {!isAtBottom && (
        <div className="fixed bottom-40 right-10 md:right-20 z-50 cursor-pointer animate-pulse">
          <div className="flex flex-col items-center">
            <div
              className="p-1 rounded-full border border-white/10 bg-white/10 hover:bg-white/20 hover:text-white light:hover:text-theme-text-primary"
              onClick={() => {
                scrollToBottom(true);
                setIsUserScrolling(false);
              }}
