          ...
          <div className="flex flex-col gap-y-2">
            {mode === "multi" && !!user && (
              <button
                ...
                className="border-none text-white light:text-theme-text-primary hover:bg-theme-action-menu-item-hover w-full text-left px-4 py-1.5 rounded-md"
              >
            ...
            <a
              href={supportEmail}
              className="text-white light:text-theme-text-primary hover:bg-theme-action-menu-item-hover w-full text-left px-4 py-1.5 rounded-md"
            >
