  ...
  return (
    <div className="absolute top-3 right-4 md:top-9 md:right-10 w-fit h-fit z-40">
      <button
        ...
        type="button"
        className="uppercase transition-all duration-300 w-[35px] h-[35px] text-base font-semibold rounded-full flex items-center bg-theme-action-menu-bg hover:bg-white/20 light:hover:bg-black/10 justify-center text-white light:text-theme-text-primary hover:text-white light:hover:text-theme-text-primary p-2 hover:border-slate-100 hover:border-opacity-50 border-transparent border"
      >
