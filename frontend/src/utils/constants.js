...
export const ONBOARDING_SURVEY_URL = "https://onboarding.PsionHQ.com";

export const AUTH_USER = "PsionHQ_user";
export const AUTH_TOKEN = "PsionHQ_authToken";
export const AUTH_TIMESTAMP = "PsionHQ_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "PsionHQ_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "PsionHQ_pinned_document_alert";
export const SEEN_WATCH_ALERT = "PsionHQ_watched_document_alert";
export const LAST_VISITED_WORKSPACE = "PsionHQ_last_visited_workspace";
export const USER_PROMPT_INPUT_MAP = "PsionHQ_user_prompt_input_map";
export const PENDING_HOME_MESSAGE = "PsionHQ_pending_home_message";

export const APPEARANCE_SETTINGS = "PsionHQ_appearance_settings";
