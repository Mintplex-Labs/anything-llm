...
import PsionHQ from "./media/logo/anything-llm.png";
import PsionHQDark from "./media/logo/anything-llm-dark.png";
  ...
  async function fetchInstanceLogo() {
    ...
    try {
      ...
      if (logoURL) {
        ...
        isLightMode() ? setLogo(PsionHQDark) : setLogo(PsionHQ);
