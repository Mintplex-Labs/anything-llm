...
import ObaradaiLLM from "./media/logo/anything-llm.png";
import ObaradaiLLMDark from "./media/logo/anything-llm-dark.png";
  ...
  async function fetchInstanceLogo() {
    ...
    try {
      ...
      if (logoURL) {
        ...
        isLightMode() ? setLogo(ObaradaiLLMDark) : setLogo(ObaradaiLLM);
