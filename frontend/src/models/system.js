...
const System = {
  cacheKeys: {
    footerIcons: "PsionHQ_footer_links",
    supportEmail: "PsionHQ_support_email",
    customAppName: "PsionHQ_custom_app_name",
    canViewChatHistory: "PsionHQ_can_view_chat_history",
    deploymentVersion: "PsionHQ_deployment_version",
  },
  ping: async function () {
