...
const TRANSLATIONS = {
    ...
    "exploreMore": {
      ...
      "features": {
        ...
        "slashCommands": {
          ...
          "description": "Ietaupiet laiku un ievietojiet uzvednes izmantojot pielāgotas slīpsvītras komandas.",
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        ...
        "description": "sniedz atbildes, izmantojot LLM vispārīgo zināšanu un dokumenta kontekstu, kas ir pieejams.<br />Lai izmantotu rīkus, jums jāizmantojat komandu \"@agent\"."
      },
      "query": {
        "title": "Vaicājums",
        ...
        "description": "sniedz atbildes <b> tikai </b>, ja dokumenta konteksts ir atrasts. <br />Lai izmantotu rīkus, jums būs jāizmanto komanda \"@agent\"."
      },
      "automatic": {
        "title": "Automobiļs",
        "description": "automātiski izmantos rīkus, ja modelis un sniedzējs atbalsta vietējo rīku izmantošanu. <br />Ja vietējā rīku izmantošana netiek atbalstīta, jums būs jāizmantojas \"@agent\" komanda, lai izmantotu rīkus."
      }
    },
    "history": {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "description": "Uzlabojiet noklusējuma aģenta dabiskās spējas ar šīm iepriekš izveidotajām prasmēm. Šis uzstādījums attiecas uz visām darba telpām.",
      "rag": {
      ...
      "save": {
        ...
        "description": "Iespējot noklusējuma aģentam ģenerēt un rakstīt failus, kas saglabājas un var tikt lejupielādēti jūsu pārlūkā."
      },
      "web": {
        "title": "Tiešsaistes tīmekļa meklēšana un pārlūkošana",
        "desc-start": "Ļaujiet savam aģentam meklēt tīmeklī, lai atbildētu uz jūsu jautājumiem, savienojoties ar tīmekļa meklēšanas (SERP) pakalpojumu sniedzēju.",
  ...
  "customization": {
    ...
    "items": {
      ...
      "welcome-messages": {
        ...
        "description": "Pielāgojiet sveiciena ziņojumus, kas tiek rādīti lietotājiem. Tikai ne-administratori redzēs šos ziņojumus.",
        "new": "Jauns",
        "system": "sistēma",
        "user": "lietotājs",
        "message": "ziņojums",
  ...
  "chat_window": {
    ...
    "custom_agents_coming_soon": "Nedaudz drīzumā būs pieejami individuāli pakalpojumi!",
    "slash_reset": "/reset",
  ...
  "community_hub": {
    "publish": {
      ...
      "slash_command": {
        ...
        "command_description": "Šis ir komandu, ko lietotāji ievadīs, lai aktivizētu šo iepriekš noteikto.",
