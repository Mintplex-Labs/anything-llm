  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        ...
        "beta-badge": "BETA",
        description:
          "Kad ir aktivizēts, aģenti var pārtraukt darbību, lai uzdotu īsas, skaidrotas jautājumus, ja jūsu lūdzes formulējums ir neprecīzs. Pamatojums ir izslēgts pēc nokārtas. Nav pieejams API/programmātiskai aģentu darbībai.",
        "max-per-turn": {
          title: "Maksimālais jautājumu skaits vienā runda",
          description:
            "Cik jautājumus aģents var uzdot vienā atbildē? Mazāks skaits nozīmē mazāku traucējumu.",
        },
        timeout: {
          title: "Atbildes laiks (sekundes)",
          description:
            "Ja lietotājs neatbildēs šajā laikā, aģents turpinās darbību, izmantojot savu labāko spriedi.",
        },
      },
    },
  },
  ...
  chat_window: {
    ...
    agent_invocation: {
      ...
      clarifying_question_header:
        "Aģentam ir nepieciešama papildu informācija.",
