  ...
  customization: {
    ...
    items: {
      ...
      "display-currency": {
        title: "Vis valuta",
        description:
          "Valutaen, der bruges til at vise omkostningerne ved brug af LLM i denne instans. Omkostningerne registreres altid i USD og konverteres til den aktuelle kurs kun til visning.",
      },
    },
  },
  "main-page": {
