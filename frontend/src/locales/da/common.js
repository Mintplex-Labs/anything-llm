...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      "search-document": "Søg i dokumenter...",
      "no-documents": "Ingen dokumenter fundet",
      no_docs: "Ingen dokumenter i arbejdsområdet",
      "new-folder": "Ny mappe",
      "create-folder": "Opret mappe",
      "folder-name": "Mappenavn",
      "enter-folder-name": "Indtast mappenavn",
      "add-tag": "Tilføj tag",
      "enter-tag": "Indtast tagnavn",
      "move-to-folder": "Flyt til mappe",
      "select-folder": "Vælg mappe",
      "document-count": "{{count}} dokumenter",
      "rename-document": "Omdøb dokument",
      "new-name": "Nyt navn",
      ...
      "move-success": "{{count}} dokumenter flyttet med succes.",
      date: "Dato",
      type: "Type",
      select_all: "Vælg alle",
      deselect_all: "Fravælg alle",
      remove_selected: "Fjern valgte",
      costs: "*Engangsomkostning for indlejring",
