...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "userSetup": {
      ...
      "adminUsernameReq": "Brugernavnet skal være mindst 6 tegn langt og må kun indeholde små bogstaver, tal, understregninger og bindestreger uden mellemrum.",
  ...
  "welcomeMessage": {
    ...
    "part2": "AnythingLLM er den nemmeste måde at samle kraftfulde AI-produkter som OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB og andre tjenester i en praktisk pakke uden besvær, så du kan øge din produktivitet 100 gange.",
    "part3": "AnythingLLM kan køre helt lokalt på din maskine med minimal overhead, så du næsten ikke bemærker, at den er der! Ingen GPU er nødvendig. Installation i skyen og on-premises er også tilgængelig.\nAI-værktøjsøkosystemet bliver mere kraftfuldt hver dag. AnythingLLM gør det nemt at bruge.",
    "githubIssue": "Opret et issue på GitHub",
    "user1": "Hvordan kommer jeg i gang?!",
    "part4": "Det er enkelt. Alle samlinger er organiseret i beholdere, som vi kalder \"arbejdsområder\". Arbejdsområder er beholdere med filer, dokumenter, billeder, PDF'er og andre filer, som vil blive transformeret til noget, LLM'er kan forstå og bruge i samtale.\n\nDu kan tilføje og fjerne filer når som helst.",
    "createWorkspace": "Opret dit første arbejdsområde",
    "user2": "Er dette som en AI-dropbox eller noget? Hvad med chat? Det er jo en chatbot, ikke sandt?",
    "part5": "AnythingLLM er mere end en smartere Dropbox.\n\nAnythingLLM tilbyder to måder at kommunikere med dine data på:\n\n<i>Forespørgsel:</i> Dine chats vil returnere data eller inferenser fundet i de dokumenter, som dit arbejdsområde har adgang til. Tilføjelse af flere dokumenter til arbejdsområdet gør det klogere! \n\n<i>Samtalende:</i> Dine dokumenter + din løbende chat-historik bidrager begge til LLM'ens viden samtidigt. Perfekt til at tilføje realtids tekstbaserede oplysninger eller rette fejl og misforståelser, som LLM'en måtte have. \n\nDu kan skifte mellem de to tilstande \n<i>midt i en samtale!</i>",
  ...
  "appearance": {
    ...
    "message": {
      ...
      "description": "Tilpas de automatiske beskeder, der vises for dine brugere.",
      "new": "Ny",
      "system": "system",
      "user": "bruger",
      "message": "besked",
  ...
  "embedding": {
    ...
    "provider": {
      ...
      "description": "Ingen opsætning er nødvendig, når du bruger AnythingLLM's indbyggede indlejringsmotor."
    }
  },
  "text": {
  ...
  "profile_settings": {
    ...
    "username": "Brugernavn",
    "username_description": "Brugernavnet må kun indeholde små bogstaver, tal, understregninger og bindestreger uden mellemrum",
