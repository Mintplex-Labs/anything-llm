...
const TRANSLATIONS = {
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        ...
        "description": "vil give svar baseret på LLM's generelle viden og den relevante kontekst fra dokumentet. Du skal bruge kommandoen \"@agent\" for at bruge værktøjerne."
      },
      "query": {
        "title": "Forespørgsel",
        ...
        "description": "vil give svar <b>kun</b>, hvis dokumentets kontekst er fundet.<br />Du skal bruge kommandoen @agent for at bruge værktøjerne."
      },
      "automatic": {
        "title": "Bil",
        "description": "vil automatisk bruge værktøjer, hvis modellen og leverandøren understøtter native værktøjskald.<br />Hvis native værktøjskald ikke understøttes, skal du bruge kommandoen \"@agent\" for at bruge værktøjer."
      }
    },
    "history": {
      "title": "Chat-historik",
  ...
  "agent": {
    ...
    "skill": {
      ...
      "description": "Forbedr standardagentens naturlige evner med disse forudbyggede færdigheder. Denne opsætning gælder for alle arbejdsområder.",
      "rag": {
      ...
      "save": {
        ...
        "description": "Gør det muligt for standardagenten at generere og skrive til filer, der gemmes og kan downloades i din browser."
      },
      "web": {
        "title": "Live web-søgning og browsing",
        "desc-start": "Gør det muligt for din agent at søge på internettet for at besvare dine spørgsmål ved at forbinde til en web-søgeudbyder (SERP).",
  ...
  "customization": {
    ...
    "items": {
      ...
      "welcome-messages": {
        ...
        "description": "Tilpas de velkomstbeskeder, der vises til dine brugere. Kun ikke-administratorer vil se disse beskeder.",
        "new": "Ny",
        "system": "system",
  ...
  "main-page": {
    "noWorkspaceError": "Vær venligst oprettet et arbejdsområde, før du starter en samtale.",
    "checklist": {
    ...
    "exploreMore": {
      ...
      "features": {
        "customAgents": {
          "title": "Skræddersyede AI-agenter\n\nCustom AI Agents\n\nSkræddersyede AI-agenter",
          "description": "Opret kraftfulde AI-agenter og automatiseringer uden kode.",
          "primaryAction": "Brug chatfunktionen til at kommunikere med agenten.\n\nBrug chatfunktionen til at kommunikere med agenten.",
          "secondaryAction": "Opret en agentflow"
        },
        "slashCommands": {
          "title": "Slash-kommandoer",
          "description": "Spar tid og indsæt kommandoer ved hjælp af brugerdefinerede kommandoer.",
          "primaryAction": "Opret en Slash-kommando",
          "secondaryAction": "Udforsk på Hub"
        },
        "systemPrompts": {
          "title": "System Prompts\n\nSystem prompts",
          "description": "Tilpas systemprompten for at tilpasse AI's svar i et arbejdsområde.",
  ...
  "community_hub": {
    "publish": {
      ...
      "slash_command": {
        ...
        "command_description": "Dette er kommandoen, som brugerne vil indtaste for at aktivere denne forudindstillede funktion.",
