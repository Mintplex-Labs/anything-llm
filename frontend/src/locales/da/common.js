  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        ...
        "beta-badge": "BETA",
        description:
          "Når de er aktiveret, kan agenter pause for at stille korte, afklarende spørgsmål, hvis din anmodning er tvetydig. De er deaktiveret som standard. Ikke tilgængelige for API- eller programmerede agentkørsler.",
        "max-per-turn": {
          title: "Maksimalt antal spørgsmål pr. runde",
          description:
            "Hvor mange spørgsmål agenten må stille i et enkelt svar. Jo færre, jo mindre afbrydende.",
        },
        timeout: {
          title: "Timeout-tid (sekunder)",
          description:
            "Hvis brugeren ikke svarer inden for denne tidsramme, vil medarbejderen handle ud fra sit bedste skøn.",
        },
      },
    },
  },
