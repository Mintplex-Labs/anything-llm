...
const TRANSLATIONS = {
  ...
  "welcomeMessage": {
    "part1": "AnythingLLM'e hoş geldiniz. AnythingLLM, Mintplex Labs tarafından geliştirilen açık kaynaklı bir yapay zeka aracıdır ve her şeyi, sorgulayabileceğiniz ve sohbet edebileceğiniz eğitimli bir chatbota dönüştürür. AnythingLLM, BYOK (kendi anahtarlarınızı getirin) yazılımıdır; bu nedenle, kullanmak istediğiniz hizmetler dışında herhangi bir abonelik, ücret ya da ek masraf yoktur.",
    "part2": "AnythingLLM, OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB ve benzeri güçlü yapay zeka ürünlerini zahmetsizce, düzenli bir paket içinde bir araya getirmenin en kolay yoludur; böylece verimliliğinizi 100 kat artırabilirsiniz.",
    "part3": "AnythingLLM tamamen yerel olarak makinenizde çok az kaynakla çalışabilir—orada olduğunu bile fark etmezsiniz! GPU gerekmez. Bulut veya şirket içi (on-premises) kurulum da mevcuttur.\nYapay zeka araç ekosistemi her geçen gün daha da güçleniyor. AnythingLLM bu gücü kolayca kullanmanızı sağlar.",
  ...
  "appearance": {
    ...
    "logo": {
      ...
      "description": "Özel bir logo yükleyerek chatbot'unuzu kendinize ait hale getirin.",
    ...
    "message": {
      ...
      "description": "Kullanıcılarınıza gösterilen otomatik mesajları özelleştirin.",
      "new": "Yeni",
      "system": "sistem",
      "user": "kullanıcı",
      "message": "mesaj",
    ...
    "icons": {
      ...
      "description": "Kenar çubuğunun altında görüntülenen altbilgi simgelerini özelleştirin.",
      "icon": "Simge",
      "link": "Bağlantı"
    }
  },
  ...
  "embedding": {
    ...
    "provider": {
      ...
      "description": "AnythingLLM'nin yerel gömme motoru kullanıldığında ek bir kurulum gerekmez."
    }
  },
  "text": {
