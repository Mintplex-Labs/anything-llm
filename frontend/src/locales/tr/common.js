...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "workspace": {
      ...
      "description": "İlk çalışma alanınızı oluşturun ve AnythingLLM ile başlayın."
    }
  },
  "common": {
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        ...
        "description": "LLM'nin genel bilgisi ve bulunan doküman bağlamıyla cevaplar sunacaktır. Araçları kullanmak için @agent komutunu kullanmanız gerekecektir."
      },
      "query": {
        "title": "Sorgu",
        ...
        "description": "yalnızca doküman bağlamı bulunursa yanıtlar sağlayacaktır.<b>İhtiyaç duyacağınız araçları kullanmak için @agent komutunu kullanmanız gerekecektir.</b>"
      },
      "automatic": {
        "title": "Oto",
        "description": "<br />Varsa, model ve sağlayıcı tarafından desteklenen yerel araçları otomatik olarak kullanacaktır. Yerel araç kullanımı desteklenmiyorsa, araçları kullanmak için @agent komutunu kullanmanız gerekecektir."
      }
    },
    "history": {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "description": "Varsayılan ajanın doğal yeteneklerini, hazır oluşturulmuş bu becerilerle geliştirin. Bu yapılandırma tüm çalışma alanları için geçerlidir.",
      "rag": {
      ...
      "save": {
        ...
        "description": "Varsayılan ajanın, oluşturduğu dosyaları kaydetmesine ve tarayıcıda indirilebilir hale getirmesine izin verin."
      },
      "web": {
        "title": "Canlı web araması ve gezinme",
        "desc-start": "Ajanınızın, bir web arama (SERP) sağlayıcısına bağlanarak sorularınızı yanıtlamak için web üzerinde arama yapmasına izin verin.",
        "desc-end": "Ajan oturumlarında web araması, bu ayar etkinleştirilene kadar çalışmayacaktır."
      }
    }
  },
  "recorded": {
  ...
  "customization": {
    ...
    "items": {
      ...
      "chat-message-alignment": {
        ...
        "description": "Sohbet arayüzünü kullanırken mesaj hizalama modunu seçin."
      },
      "display-language": {
      ...
      "welcome-messages": {
        ...
        "description": "Kullanıcılarınıza gösterilen karşılama mesajlarını özelleştirin. Yalnızca yönetici olmayan kullanıcılar bu mesajları görecektir.",
        "new": "Yeni",
        "system": "sistem",
        "user": "kullanıcı",
        "message": "mesaj",
  ...
  "main-page": {
    "noWorkspaceError": "Sohbete başlamadan önce lütfen bir çalışma alanı oluşturun.",
    "checklist": {
      "title": "Başlarken",
    ...
    "exploreMore": {
      ...
      "features": {
        "customAgents": {
          ...
          "description": "Kod yazmadan güçlü AI Ajanları ve otomasyonlar oluşturun.",
          "primaryAction": "@agent kullanarak sohbet et",
          "secondaryAction": "Bir ajan akışı oluştur"
        },
        "slashCommands": {
          "title": "Eğik Çizgi Komutları",
          "description": "Özel eğik çizgi komutları kullanarak zaman kazanın ve promptlar enjekte edin.",
          "primaryAction": "Eğik Çizgi Komutu Oluştur",
          "secondaryAction": "Hub'da Keşfet"
        },
        "systemPrompts": {
          "title": "Sistem Promptları",
          "description": "Bir çalışma alanının AI yanıtlarını özelleştirmek için sistem promptunu değiştirin.",
  ...
  "community_hub": {
    "publish": {
      ...
      "slash_command": {
        ...
        "command_label": "Komut",
        "command_description": "Bu, kullanıcıların bu ön ayarı tetiklemek için yazacağı eğik çizgi komutudur.",
