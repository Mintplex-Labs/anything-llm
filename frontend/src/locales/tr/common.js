...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      "no-documents": "Belge bulunamadı",
      no_docs: "Çalışma alanında belge yok",
      "new-folder": "Yeni klasör",
      "create-folder": "Klasör oluştur",
      "folder-name": "Klasör adı",
      "enter-folder-name": "Klasör adını girin",
      "add-tag": "Etiket ekle",
      "enter-tag": "Etiket adını girin",
      "move-to-folder": "Klasöre taşı",
      "select-folder": "Klasör seç",
      "document-count": "{{count}} belge",
      "rename-document": "Belgeyi yeniden adlandır",
      "new-name": "Yeni ad",
      "enter-new-name": "Yeni adı girin",
      "delete-confirmation":
        "Bu dosya ve klasörleri silmek istediğinizden emin misiniz?\nBu, dosyaları sistemden kaldıracak ve mevcut tüm çalışma alanlarından otomatik olarak kaldıracaktır.\nBu işlem geri alınamaz.",
      "removing-message":
        "{{count}} belge ve {{folderCount}} klasör siliniyor. Lütfen bekleyin.",
      ...
      costs: "*Gömme için tek seferlik maliyet",
