...
const TRANSLATIONS = {
  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        title:
          "Temsilcinin, konuyla ilgili daha fazla açıklama istemesine izin verin.",
        "beta-badge": "BETA",
        description:
          "Bu özellik etkinleştirildiğinde, ajanlar, sorgunuzun belirsiz olması durumunda kısa açıklayıcı sorular sorabilme imkanı elde eder. Varsayılan olarak devre dışıdır. API/programatik ajan çalıştırma için kullanılabilir değildir.",
        "max-per-turn": {
          title: "Her turda sorulabilecek maksimum soru sayısı",
          description:
            "Bir yanıt içinde, müşteri temsilcisi kaç soru sorabilir? Daha az soru sormak, daha az kesintiye neden olur.",
        },
        timeout: {
          title: "Yanıt süresi (saniye)",
          description:
            "Eğer kullanıcı bu süre içinde yanıt vermezse, temsilci en iyi görüşü doğrultusunda hareket eder.",
        },
      },
    },
  },
  ...
  chat_window: {
    ...
    agent_invocation: {
      ...
      batch_progress:
        "{{answered}}'ın {{total}}'den gelen sorusuna yanıt verildi.",
