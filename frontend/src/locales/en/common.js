const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Welcome to Prism, Prism is an AI tool by Saal.ai that turns anything into a trained chatbot you can query and chat with. Prism is a BYOK (bring-your-own-keys) software so there is no subscription, fee, or charges for this software outside of the services you want to use with it.",
    part2:
