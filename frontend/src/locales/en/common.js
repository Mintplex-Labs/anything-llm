const TRANSLATIONS = {
  ...
  "model-router": {
    ...
    "rule-form": {
      ...
      "new-title": "New Rule",
      "title-label": "Title",
      "title-help": "Lowercase with underscores only. Auto-formatted on save.",
      "rule-type": "Rule Type",
      ...
      "match-description-help":
        "Describe when this rule should match. The router's fallback model will read the user's message and decide if it fits this description.",
