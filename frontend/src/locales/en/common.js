const TRANSLATIONS = {
  ...
  lark: {
    ...
    setup: {
      ...
      instructions:
        "Create a self-built Lark or Feishu app, enable the bot and WebSocket events, then enter its credentials.",
      platform: "Platform",
      "app-id": "App ID",
      ...
      reconnect: "Reconnect",
      "saved-secret":
        "The saved App Secret will be reused unless you enter a new one.",
    ...
    users: {
      title: "User access",
      description:
        "Match pending pairing codes with users, then approve or deny access.",
      pending: "Pending approval",
      approved: "Approved users",
      "empty-pending": "No pending users.",
      "empty-approved": "No approved users.",
      "no-pending": "No pending users.",
    ...
    errors: {
      format_error: "The message format was rejected.",
      target_revoked: "The original message is no longer available.",
      rate_limited: "The Lark rate limit was reached. Try again shortly.",
      permission_denied: "Check the app permissions and published app version.",
      upload_failed: "The attachment could not be uploaded.",
      ssrf_blocked: "The attachment source was blocked for safety.",
      send_timeout: "Lark timed out while sending the message.",
      not_connected: "The Lark channel is not connected.",
      unknown: "An unexpected Lark channel error occurred.",
      connect: "Could not connect the Lark channel.",
      disconnect: "Could not disconnect the Lark channel.",
      save: "Could not save the Lark channel settings.",
      load: "Could not load the Lark channel settings.",
      status: "Could not refresh the Lark channel status.",
      users: "Could not update user access.",
    },
  },
  security: {
    title: "Security",
