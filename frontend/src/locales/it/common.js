...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      "search-document": "Cerca documenti...",
      "no-documents": "Nessun documento trovato",
      no_docs: "Nessun documento nell'area di lavoro",
      "new-folder": "Nuova cartella",
      "create-folder": "Crea cartella",
      "folder-name": "Nome della cartella",
      "enter-folder-name": "Inserisci il nome della cartella",
      "add-tag": "Aggiungi tag",
      "enter-tag": "Inserisci il nome del tag",
      "move-to-folder": "Sposta in cartella",
      "select-folder": "Seleziona cartella",
      "document-count": "{{count}} documenti",
      "rename-document": "Rinomina documento",
      "new-name": "Nuovo nome",
      "enter-new-name": "Inserisci il nuovo nome",
      "delete-confirmation":
        "Sei sicuro di voler eliminare questi file e cartelle?\nQuesto rimuoverà i file dal sistema e li rimuoverà automaticamente da tutti gli spazi di lavoro esistenti.\nQuesta azione non può essere annullata.",
      "removing-message":
        "Eliminazione di {{count}} documenti e {{folderCount}} cartelle. Attendere prego.",
      "move-success": "{{count}} documenti spostati con successo.",
      date: "Data",
      type: "Tipo",
      select_all: "Seleziona tutto",
      deselect_all: "Deseleziona tutto",
      remove_selected: "Rimuovi selezionati",
      costs: "*Costo una tantum per l'incorporamento",
