...
const TRANSLATIONS = {
  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        title: "Permetti all'agente di porre domande chiarificatrici.",
        "beta-badge": "Fase di test",
        description:
          "Quando abilitato, gli agenti possono mettere in pausa per porre brevi domande chiarificatrici se la tua richiesta è ambigua. Disabilitato per impostazione predefinita. Non disponibile per l'esecuzione di agenti tramite API o programmazione.",
        "max-per-turn": {
          title: "Numero massimo di domande per turno",
          description:
            "Quante domande di chiarimento può porre l'agente in una singola risposta. Meno domande, meno interruzioni.",
        },
        timeout: {
          title: "Tempo massimo di attesa (secondi)",
          description:
            "Se l'utente non risponde entro questo periodo, l'operatore procederà adottando il suo giudizio più appropriato.",
        },
      },
    },
  },
  ...
  chat_window: {
    ...
    agent_invocation: {
      ...
      clarifying_question_header:
        "L'agente necessita di maggiori informazioni.",
