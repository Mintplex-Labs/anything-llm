  ...
  customization: {
    ...
    items: {
      ...
      "display-currency": {
        title: "عرض العملة",
        description:
          "العملة المستخدمة لعرض تكاليف استخدام نموذج اللغة الكبير (LLM) في هذا النظام. يتم تسجيل التكاليف دائمًا بالدولار الأمريكي، ويتم تحويلها إلى العملات الأخرى فقط لأغراض العرض.",
      },
    },
  },
  "main-page": {
