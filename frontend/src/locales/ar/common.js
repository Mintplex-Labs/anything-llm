  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        title: "اسمح للمتخصص بسؤل أسئلة توضيحية.",
        "beta-badge": "مرحلة تجريبية",
        description:
          "عند تفعيلها، يمكن للوكلاء التوقف وطلب أسئلة توضيحية قصيرة إذا كان طلبك غامضًا. يتم تعطيلها افتراضيًا. غير متوفرة للاستخدام مع واجهات برمجة التطبيقات أو عمليات الوكلاء التلقائية.",
        "max-per-turn": {
          title: "الحد الأقصى لعدد الأسئلة في كل دور",
          description:
            "كم عدد الأسئلة التوضيحية التي يمكن للمتحدث طرحها في رد واحد؟ كلما قل عدد الأسئلة، كان ذلك أقل تطفلاً.",
        },
        timeout: {
          title: "مهلة الاستجابة (ثواني)",
          description:
            "إذا لم يستجب المستخدم خلال هذا الإطار الزمني، فسيقوم الموظف باتخاذ أفضل قرار بناءً على المعلومات المتاحة.",
        },
      },
    },
  },
