...
const TRANSLATIONS = {
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        ...
        "description": "سيوفر إجابات بناءً على المعرفة العامة للنموذج اللغوي الكبير، بالإضافة إلى سياق المستندات.<br />ستحتاج إلى استخدام الأمر \"@agent\" لاستخدام الأدوات."
      },
      "query": {
        "title": "استعلام",
      ...
      "automatic": {
        "title": "سيارة",
        "description": "سيتم استخدام الأدوات تلقائيًا إذا كان النموذج ومزود الخدمة يدعمان استدعاء الأدوات الأصلية. إذا لم يتم دعم الأدوات الأصلية، فستحتاج إلى استخدام الأمر \"@agent\" لاستخدام الأدوات."
      }
    },
    "history": {
      "title": "سجل المحادثة",
  ...
  "connectors": {
    ...
    "github": {
      ...
      "token_information": "بسبب قيود معدل الوصول إلى واجهة برمجة التطبيقات العامة الخاصة بـ GitHub، لن يتمكن هذا الموصل من جمع الملفات ذات المستوى الأعلى فقط.",
    ...
    "gitlab": {
      ...
      "branch_loading": "-- تحميل الفروع المتاحة --",
      "branch_explained": "المجلد الذي ترغب في استرداد الملفات منه.",
      "token_information": "بسبب قيود معدل الوصول إلى واجهة برمجة التطبيقات العامة لـ GitLab، لن يتمكن هذا الموصل من البيانات من جمع الملفات ذات المستوى الأعلى فقط في المستودع.",
    ...
    "upload": {
      ...
      "privacy-notice": "سيتم تحميل هذه الملفات إلى معالج المستندات الذي يعمل على هذه نسخة من AnythingLLM. هذه الملفات لا يتم إرسالها أو مشاركتها مع طرف ثالث."
    },
    "pinning": {
      "what_pinning": "ما هو عمل \"تثبيت المستندات\"؟",
      "pin_explained_block1": "عندما تقوم بإرفاق مستند في AnythingLLM، سنقوم بإدخال محتوى المستند بالكامل في نافذة المطالبة الخاصة بـ LLM الخاص بك، وذلك حتى يتمكن LLM من فهم المحتوى بالكامل.",
      "pin_explained_block2": "يعمل هذا بشكل أفضل مع **نماذج ذات سياق كبير** أو ملفات صغيرة ولكنها ضرورية لأساس المعرفة الخاص بها.",
      "pin_explained_block3": "إذا لم تحصل على الإجابات التي ترغب بها بشكل افتراضي من AnythingLLM، فإن استخدام ميزة \"التثبيت\" هو طريقة رائعة للحصول على إجابات ذات جودة أعلى في نقرة واحدة.",
      "accept": "حسناً، فهمت."
    },
    "watching": {
      "what_watching": "ما الذي يفعله مشاهدة فيلم وثائقي؟",
      "watch_explained_block1": "عندما **تشاهد** مستندًا في AnythingLLM، سيتم **مزامنة** محتوى المستند تلقائيًا من مصدره الأصلي على فترات منتظمة. وهذا سيؤدي إلى تحديث المحتوى تلقائيًا في كل مساحة عمل حيث يتم إدارة هذا الملف.",
  ...
  "customization": {
    ...
    "branding": {
      ...
      "description": "قم بتخصيص نسخة AnythingLLM الخاصة بك باستخدام العلامات التجارية الخاصة بك."
    },
    "chat": {
      "title": "دردشة",
    ...
    "items": {
      ...
      "display-language": {
        ...
        "description": "حدد اللغة المفضلة لعرض واجهة مستخدم AnythingLLM - عند توفر الترجمات."
      },
      "logo": {
      ...
      "welcome-messages": {
        "title": "أهلاً وسهلاً",
        "description": "خصص الرسائل الترحيبية المعروضة لمستخدميك. سيتمكن المستخدمون غير المسؤولين فقط من رؤية هذه الرسائل.",
        "new": "جديد",
        "system": "نظام",
    ...
    "exploreMore": {
      ...
      "features": {
        "customAgents": {
          ...
          "description": "قم ببناء وكلاء ذكاء اصطناعي قويين وأتمتيات بدون الحاجة إلى كتابة التعليمات البرمجية.",
        ...
        "systemPrompts": {
          ...
          "description": "عدّل مطالبة النظام لتخصيص ردود الذكاء الاصطناعي في مساحة العمل.",
  ...
  "community_hub": {
    "publish": {
      ...
      "generic": {
        "unauthenticated": {
          "title": "يتطلب التحقق",
          "description": "يجب عليك التحقق من هويتك مع مركز مجتمع AnythingLLM قبل نشر أي محتوى.",
      ...
      "slash_command": {
        ...
        "command_label": "أمر",
        "command_description": "هذا هو الأمر الذي سيدخله المستخدمون لتفعيل هذا الإعداد المسبق.",
