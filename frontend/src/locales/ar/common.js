...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      "search-document": "البحث في المستندات...",
      "no-documents": "لم يتم العثور على مستندات",
      no_docs: "لا توجد مستندات في مساحة العمل",
      "new-folder": "مجلد جديد",
      "create-folder": "إنشاء مجلد",
      "folder-name": "اسم المجلد",
      "enter-folder-name": "أدخل اسم المجلد",
      "add-tag": "إضافة علامة",
      "enter-tag": "أدخل اسم العلامة",
      "move-to-folder": "نقل إلى مجلد",
      "select-folder": "اختر مجلد",
      "document-count": "{{count}} مستند",
      "rename-document": "إعادة تسمية المستند",
      "new-name": "الاسم الجديد",
      "enter-new-name": "أدخل الاسم الجديد",
      "delete-confirmation":
        "هل أنت متأكد أنك تريد حذف هذه الملفات والمجلدات؟\nسيتم إزالة الملفات من النظام وإزالتها تلقائياً من جميع مساحات العمل الموجودة.\nلا يمكن التراجع عن هذا الإجراء.",
      "removing-message":
        "جاري إزالة {{count}} مستند و {{folderCount}} مجلد. يرجى الانتظار.",
      ...
      costs: "*تكلفة لمرة واحدة للتضمين",
