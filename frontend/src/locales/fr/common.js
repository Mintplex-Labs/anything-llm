  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        title: "Permettre à l'agent de poser des questions pour clarifier.",
        "beta-badge": "Version préliminaire",
        description:
          "Lorsque cette fonctionnalité est activée, les agents peuvent faire des pauses pour poser des questions de clarification si votre requête est ambiguë. Désactivée par défaut. Non disponible pour les exécutions d'agents via API/programmation.",
        "max-per-turn": {
          title: "Nombre maximum de questions par tour",
          description:
            "Combien de questions de clarification l'agent peut poser dans une seule réponse. Moins il y en a, moins cela sera perturbant.",
        },
        timeout: {
          title: "Délai maximal de réponse (secondes)",
          description:
            "Si l'utilisateur ne répond pas dans ce délai, l'agent procède en fonction de son meilleur jugement.",
        },
      },
    },
  },
