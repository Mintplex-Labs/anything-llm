...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      "search-document": "Rechercher des documents...",
      "no-documents": "Aucun document trouvé",
      no_docs: "Aucun document dans l'espace de travail",
      "new-folder": "Nouveau Dossier",
      "create-folder": "Créer un Dossier",
      "folder-name": "Nom du Dossier",
      "enter-folder-name": "Entrez le nom du dossier",
      "add-tag": "Ajouter une Étiquette",
      "enter-tag": "Entrez le nom de l'étiquette",
      ...
      "delete-confirmation":
        "Êtes-vous sûr de vouloir supprimer ces fichiers et dossiers ?\nCela supprimera les fichiers du système et les retirera automatiquement de tous les espaces de travail existants.\nCette action est irréversible.",
      "removing-message":
      ...
      costs: "*Coût unique pour les intégrations",
      save_embed: "Enregistrer et Intégrer",
    },
    upload: {
