  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        ...
        "description": "fournira des réponses en utilisant les connaissances générales du LLM et le contexte du document correspondant. <br />Vous devrez utiliser la commande \"@agent\" pour utiliser les outils."
      },
      "query": {
        "title": "Requête",
      ...
      "automatic": {
        "title": "Voiture",
        "description": "utilisera automatiquement les outils si le modèle et le fournisseur prennent en charge l'appel de outils natifs. <br />Si l'utilisation d'outils natifs n'est pas prise en charge, vous devrez utiliser la commande \"@agent\" pour utiliser les outils."
      }
    },
    "history": {
