...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "llm": {
      ...
      "description": "AnythingLLM poate funcționa cu mulți furnizori LLM. Acesta va fi serviciul care gestionează conversațiile."
    },
    "userSetup": {
      ...
      "adminUsernameReq": "Numele de utilizator trebuie să aibă cel puțin 6 caractere și să conțină numai litere mici, cifre, underscore și liniuțe fără spații.",
  ...
  "welcomeMessage": {
    "part1": "Bine ai venit la AnythingLLM, AnythingLLM este un instrument AI open-source creat de Mintplex Labs care transformă orice într-un chatbot antrenat cu care poți interacționa. AnythingLLM este un software BYOK (bring-your-own-keys) fără abonamente sau taxe în afară de serviciile pe care dorești să le folosești.",
    "part2": "AnythingLLM este cea mai simplă modalitate de a combina produse AI puternice precum OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB și alte servicii într-un pachet ordonat care îți crește productivitatea de 100x.",
    "part3": "AnythingLLM poate rula complet local pe calculatorul tău cu un consum redus de resurse, pe care nici nu îl vei observa! Nu este necesar GPU. Instalarea în cloud sau local este, de asemenea, disponibilă.\nEcosistemul de unelte AI devine tot mai puternic zilnic. AnythingLLM face aceste tehnologii ușor de folosit.",
    "githubIssue": "Creează un issue pe GitHub",
    "user1": "Cum încep?!",
    "part4": "Este simplu. Toate colecțiile sunt organizate în bucket-uri pe care le numim \"Spații de Lucru\". Acestea sunt containere de fișiere, documente, imagini, PDF-uri și alte fișiere care vor fi transformate într-un format pe care LLM-urile îl pot înțelege și folosi în conversație.\n\nPoți adăuga și elimina fișiere oricând.",
    "createWorkspace": "Creează primul tău spațiu de lucru",
    "user2": "Este ca un Dropbox AI sau ceva de genul? Dar ce fac cu chat-ul? Este un chatbot, nu?",
    "part5": "AnythingLLM este mai mult decât un Dropbox mai inteligent.\n\nAnythingLLM oferă două moduri de a discuta cu datele tale:\n\nQuery: Chaturile tale vor returna date sau inferențe găsite în documentele din spațiul de lucru accesat. Adăugarea mai multor documente face sistemul mai inteligent! \n\nConversational: Documentele tale + istoricul conversațiilor contribuie împreună la cunoașterea LLM-ului în timp real. Ideal pentru a adăuga corecții și informații textuale în timp real.\n\nPoți comuta între cele două moduri chiar în timpul conversației!",
  ...
  "general": {
    ...
    "delete": {
      ...
      "confirm-end": "spațiu de lucru. Aceasta va elimina toate vectorii integrați în baza vectorială.\n\nFișierele originale rămân neatinse. Această acțiune este ireversibilă."
    }
  },
  "chat": {
    "llm": {
    ...
    "model": {
      ...
      "description": "Modelul specific chat folosit de acest spațiu de lucru. Dacă e gol, folosește preferința LLM a sistemului.",
    ...
    "refusal": {
      ...
      "tooltip-description": "Ești în modul interogare, care folosește doar informațiile din documente. Treci la chat pentru conversații mai flexibile sau vizitează documentația pentru mai multe detalii."
    },
    "temperature": {
  ...
  "embeddable": {
    ...
    "description": "Widget-urile chat embeddable sunt interfețe chat destinate publicului, legate de un singur spațiu de lucru. Acestea îți permit să construiești spații de lucru pe care apoi le poți publica în lume.",
  ...
  "event": {
    ...
    "description": "Vizualizează toate acțiunile și evenimentele care au loc pe această instanță pentru monitorizare.",
  ...
  "connectors": {
    ...
    "website-depth": {
      ...
      "description": "Culege o pagină web și link-urile sale din subpaginile până la o anumită adâncime.",
      "URL": "URL site web",
    ...
    "confluence": {
      ...
      "deployment_type_explained": "Determină dacă instanța ta Confluence este găzduită în cloud Atlassian sau self-hosted.",
      ...
      "space_key_explained": "Cheia spațiului din instanța ta Confluence care va fi folosită. De obicei începe cu ~",
  ...
  "profile_settings": {
    ...
    "username_description": "Numele de utilizator trebuie să conțină doar litere mici, cifre, underscore și liniuțe fără spații",
