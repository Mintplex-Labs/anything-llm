const TRANSLATIONS = {
  ...
  manage: {
    ...
    "desktop-only": "Editarea acestor setări este disponibilă doar pe dispozitive desktop. Accesează această pagină pe un desktop pentru a continua.",
    dismiss: "Închide",
    editing: "Editare",
  },
  ...
  directory: {
    ...
    "search-document": "Caută document",
    "no-documents": "Niciun document",
    "move-workspace": "Mută în spațiu de lucru",
    name: "Nume",
    "delete-confirmation": "Ești sigur că dorești să ștergi aceste fișiere și foldere?\nAceasta va elimina fișierele din sistem și le va elimina automat din toate spațiile de lucru existente.\nAceastă acțiune nu poate fi anulată.",
    "removing-message": "Se elimină {{count}} documente și {{folderCount}} foldere. Te rugăm să aștepți.",
    "move-success": "Au fost mutate cu succes {{count}} documente.",
    date: "Dată",
    type: "Tip",
    no_docs: "Niciun document",
    select_all: "Selectează toate",
    deselect_all: "Deselectează toate",
    remove_selected: "Șterge selecția",
    costs: "*Cost unic pentru embeddings",
    save_embed: "Salvează și inserează",
  },

  upload: {
    "processor-offline": "Procesor document indisponibil",
    "processor-offline-desc": "Momentan nu putem încărca fișiere deoarece procesorul documentelor este offline. Încearcă mai târziu.",
    "click-upload": "Click pentru a încărca sau trage fișiere",
    "file-types": "acceptă fișiere text, csv, foi de calcul, audio și multe altele!",
    "or-submit-link": "sau trimite un link",
    "placeholder-link": "https://exemplu.com",
    fetching: "Se încarcă...",
    "fetch-website": "Preia website",
    "privacy-notice": "Aceste fișiere vor fi încărcate către procesorul documentelor care rulează pe această instanță AnythingLLM. Fișierele nu sunt trimise sau împărtășite cu terți.",
  },

  pinning: {
    what_pinning: "Ce este pinning-ul unui document?",
    pin_explained_block1: "Atunci când pui un document în AnythingLLM, întreg conținutul acestuia va fi injectat în fereastra promptului pentru ca LLM să îl înțeleagă complet.",
    pin_explained_block2: "Acest lucru funcționează cel mai bine cu modele cu context mare sau fișiere mici esențiale pentru baza lor de cunoștințe.",
    pin_explained_block3: "Dacă nu primești răspunsurile dorite din AnythingLLM implicit, pinning-ul este o modalitate excelentă de a obține răspunsuri de calitate mai bună cu un singur clic.",
    accept: "Înțeles, mulțumesc",
  },

  watching: {
    what_watching: "Ce înseamnă să urmărești un document?",
    watch_explained_block1: "Când urmărești un document în AnythingLLM vom sincroniza automat conținutul documentului de la sursa originală la intervale regulate. Aceasta va actualiza conținutul în fiecare spațiu de lucru unde fișierul este gestionat.",
    watch_explained_block2: "Această funcție suportă în prezent conținut online și nu este disponibilă pentru documentele încărcate manual.",
    watch_explained_block3_start: "Poți gestiona ce documente sunt urmărite din ",
    watch_explained_block3_link: "Managerul de fișiere",
    watch_explained_block3_end: " vizualizarea administrator.",
    accept: "Înțeles, mulțumesc",
  },
  ...
  community_hub: {
    ...
    generic: {
      unauthenticated: {
        ...
        description: "Trebuie să te autentifici la AnythingLLM Community Hub înainte de a publica elemente.",
