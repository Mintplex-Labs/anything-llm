  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        title:
          "Permiteți agentului să pună întrebări suplimentare pentru a clarifica anumite aspecte.",
        "beta-badge": "Versiune de test",
        description:
          "Când este activată, agenții pot întrerupe comunicarea pentru a pune întrebări suplimentare, dacă solicitarea dumneavoastră este ambiguă. Este dezactivată în mod implicit. Nu este disponibilă pentru rularea agenților prin API sau programatic.",
        "max-per-turn": {
          title: "Numărul maxim de întrebări per tur",
          description:
            "Câte întrebări de clarificare poate adresa agentul într-un singur răspuns. Un număr mai mic înseamnă un răspuns mai puțin întrerupt.",
        },
        timeout: {
          title: "Timpul maxim de așteptare (secunde)",
          description:
            "Dacă utilizatorul nu răspunde în acest interval de timp, agentul ia o decizie bazată pe propria sa expertiză.",
        },
      },
    },
  },
