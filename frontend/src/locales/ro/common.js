...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "workspace": {
      ...
      "description": "Creează primul tău spațiu de lucru și începe să folosești AnythingLLM."
    }
  },
  "common": {
    ...
    "exploreMore": {
      ...
      "features": {
        "customAgents": {
          ...
          "description": "Construiește agenți AI puternici și automatizări fără cod.",
          "primaryAction": "Chatează cu @agent",
          "secondaryAction": "Construiește un flux agent"
        },
        "slashCommands": {
          "title": "Comenzi Slash",
          "description": "Economisește timp și folosește prompturi cu comenzi personalizate.",
          "primaryAction": "Creează o comandă slash",
          "secondaryAction": "Explorează pe Hub"
        },
        "systemPrompts": {
          "title": "System Prompts",
          "description": "Modifică system prompt pentru a personaliza răspunsurile AI ale unui spațiu de lucru.",
  ...
  "general": {
    ...
    "pfp": {
      ...
      "description": "Personalizează imaginea de profil a asistentului pentru acest spațiu de lucru.",
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        "title": "Chat",
        "desc-start": "oferă răspunsuri bazate pe cunoștințele generale ale LLM-ului",
        "and": "și",
        "desc-end": "context document care este găsit.",
        "description": "va oferi răspunsuri folosind cunoștințele generale ale modelului LLM și contextul documentului respectiv.<br />Va trebui să utilizați comanda \"@agent\" pentru a utiliza instrumentele."
      },
      "query": {
        "title": "Interogare",
        ...
        "description": "vor oferi răspunsuri **doar** dacă contextul documentului este identificat. Veți avea nevoie să utilizați comanda \"@agent\" pentru a utiliza instrumentele."
      },
      "automatic": {
        "title": "Mașină",
  ...
  "connectors": {
    ...
    "youtube": {
      ...
      "language_explained": "Selectează limba transcrierii pe care dorești să o colectezi.",
  ...
  "chat_window": {
    ...
    "at_agent": "@agent",
    "default_agent_description": " - agentul implicit pentru acest spațiu de lucru.",
  ...
  "community_hub": {
    "publish": {
      ...
      "slash_command": {
        ...
        "command_description": "Aceasta este comanda slash pe care utilizatorii o vor scrie pentru a o activa.",
