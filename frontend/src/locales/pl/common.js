  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        title:
          "Pozwól agentowi zadawać pytania, które pomogą wyjaśnić wątpliwości.",
        "beta-badge": "BEta",
        description:
          "Po włączeniu, agenci mogą wstrzymać działanie, aby zadać krótkie, wyjaśniające pytania, jeśli zapytanie jest niejednoznaczne. Domyślnie wyłączone. Nie jest dostępne dla uruchomień agentów za pomocą API/programatyzacji.",
        "max-per-turn": {
          title: "Maksymalna liczba pytań na turę",
          description:
            "Ile pytań wyjaśniających agent może zadać w jednej odpowiedzi? Im mniej, tym mniej zakłóca.",
        },
        timeout: {
          title: "Limit czasu oczekiwania (sekundy)",
          description:
            "Jeśli użytkownik nie odpowie w tym czasie, agent podejmuje decyzję na podstawie najlepszej dostępnej informacji.",
        },
      },
    },
  },
