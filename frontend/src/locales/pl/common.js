...
const TRANSLATIONS = {
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        ...
        "description": "zapewni odpowiedzi, wykorzystując ogólną wiedzę LLM oraz kontekst dokumentu, w którym ta wiedza znajduje się.<br />Będziesz musiał użyć komendy `@agent` w celu korzystania z narzędzi."
      },
      "query": {
        "title": "Zapytanie (wyszukiwanie)",
        "desc-start": "dostarczy odpowiedzi",
        "only": "tylko",
        "desc-end": "na podstawie znalezionego kontekstu (dokumenty, źródła danych) - w przeciwnym razie odmówi odpowiedzi.",
        "description": "będzie dostarczać odpowiedzi <b>tylko</b>, jeśli zostanie zidentyfikowany kontekst dokumentu.<br />Będziesz musiał użyć komendy `@agent` w celu korzystania z narzędzi."
      },
      "automatic": {
        "title": "Samochód",
        "description": "automatycznie będzie wykorzystywał narzędzia, jeśli model i dostawca obsługują natywne wywoływanie narzędzi. Jeśli natywne narzędzia nie są obsługiwane, konieczne będzie użycie polecenia `@agent` w celu wykorzystania narzędzi."
      }
    },
    "history": {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "description": "Ulepsz naturalne zdolności domyślnego agenta za pomocą tych gotowych umiejętności. Ta konfiguracja dotyczy wszystkich obszarów roboczych.",
      "rag": {
      ...
      "save": {
        ...
        "description": "Pozwól domyślnemu agentowi generować i zapisywać pliki, które można zapisać i pobrać w przeglądarce."
      },
      "web": {
        "title": "Wyszukiwanie i przeglądanie stron internetowych na żywo",
        "desc-start": "Pozwól swojemu agentowi przeszukiwać Internet w celu uzyskania odpowiedzi na pytania, łącząc się z dostawcą wyszukiwania internetowego (SERP).",
        "desc-end": "Wyszukiwanie w sieci podczas sesji agenta nie będzie działać, dopóki nie zostanie to skonfigurowane."
      }
    }
  },
  "recorded": {
  ...
  "customization": {
    ...
    "items": {
      ...
      "welcome-messages": {
        ...
        "description": "Dostosuj komunikaty wyświetlane użytkownikom na ekranie powitalnym. Będą widoczne tylko dla użytkowników, którzy nie są administratorami.",
        "new": "Nowa wiadomość",
        "system": "systemu",
        "user": "użytkownika",
        "message": "wiadomość",
  ...
  "community_hub": {
    "publish": {
      ...
      "slash_command": {
        ...
        "command_description": "Jest to polecenie slash, które użytkownicy będą wpisywać, aby uruchomić to ustawienie wstępne.",
