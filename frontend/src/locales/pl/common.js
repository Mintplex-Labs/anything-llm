...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "userSetup": {
      ...
      "adminUsernameReq": "Nazwa użytkownika musi składać się z co najmniej 6 znaków i zawierać wyłącznie małe litery, cyfry, podkreślenia i myślniki bez spacji.",
  ...
  "profile_settings": {
    ...
    "username_description": "Nazwa użytkownika musi zawierać tylko małe litery, cyfry, podkreślenia i myślniki bez spacji.",
