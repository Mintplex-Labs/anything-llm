  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        title: "대리인이 추가적인 질문을 할 수 있도록 허용",
        "beta-badge": "베타",
        description:
          "활성화되면, 에이전트는 요청이 모호한 경우 간단한 확인 질문을 할 수 있습니다. 기본적으로 비활성화되어 있습니다. API 또는 프로그래밍 방식으로 에이전트를 실행하는 경우 사용할 수 없습니다.",
        "max-per-turn": {
          title: "각 턴에서 가능한 질문 수",
          description:
            "에이전트가 단 한 번의 응답에서 질문할 수 있는 횟수는 적을수록 좋습니다.",
        },
        timeout: {
          title: "응답 시간 초과 (초)",
          description:
            "사용자가 이 기간 내에 응답하지 않으면, 담당자는 최선의 판단에 따라 조치를 취합니다.",
        },
      },
    },
  },
