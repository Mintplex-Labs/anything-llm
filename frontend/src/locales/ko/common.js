...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "llm": {
      "title": "LLM 기본 설정",
      "description": "AnythingLLM은 다양한 LLM 제공자와 연동할 수 있습니다. 여기서 선택한 서비스가 채팅을 담당하게 됩니다."
    },
    "userSetup": {
      "title": "사용자 설정",
      ...
      "teamHint": "기본적으로 본인이 유일한 관리자가 됩니다. 온보딩이 완료되면 다른 사용자를 초대하거나 관리자로 지정할 수 있습니다. 비밀번호를 분실하면 관리자만 비밀번호를 재설정할 수 있으니 꼭 기억해 두세요."
    },
    "data": {
      "title": "데이터 처리 및 개인정보 보호",
      "description": "AnythingLLM은 여러분의 개인정보에 대한 투명성과 제어권을 최우선으로 생각합니다.",
  ...
  "common": {
    ...
    "no": "아니오",
    "search": "검색",
    "username_requirements": "사용자 이름은 2-32자여야 하고, 소문자로 시작해야 하며, 소문자, 숫자, 밑줄, 하이픈, 마침표만 포함할 수 있습니다.",
    "on": "~에 대해",
    "none": "없음",
    "stopped": "멈춤",
    "loading": "로딩 중",
  ...
  "general": {
    ...
    "delete": {
      "title": "워크스페이스 삭제",
      "description": "이 워크스페이스와 모든 데이터를 삭제합니다. 이 작업은 모든 사용자에 대해 워크스페이스를 삭제합니다.",
      "delete": "워크스페이스 삭제",
      "deleting": "워크스페이스 삭제 중...",
      "confirm-start": "이 작업은",
      "confirm-end": "워크스페이스 전체를 삭제합니다. 이 작업은 벡터 데이터베이스에 있는 모든 벡터 임베딩을 제거합니다.\n\n원본 소스 파일은 그대로 유지됩니다. 이 작업은 되돌릴 수 없습니다."
    }
  },
  "chat": {
    "llm": {
      "title": "워크스페이스 LLM 제공자",
      "description": "이 워크스페이스에서 사용할 특정 LLM 제공자와 모델입니다. 기본적으로 시스템 LLM 제공자와 설정을 사용합니다.",
      "search": "모든 LLM 제공자 검색"
    },
    "model": {
      "title": "워크스페이스 채팅 모델",
      "description": "이 워크스페이스에서 사용할 특정 채팅 모델입니다. 비어 있으면 시스템 LLM 기본 설정을 사용합니다."
    },
    "mode": {
      "title": "채팅 모드",
      "chat": {
        "title": "채팅",
        "description": "LLM의 일반적인 지식과 문서 컨텍스트를 활용하여 답변을 제공합니다. 도구를 사용하려면 @agent 명령을 사용해야 합니다."
      },
      "query": {
        "title": "쿼리",
        "description": "문서의 맥락이 발견되면 답변만 제공합니다.<b>필요한 경우, @agent 명령어를 사용하여 도구를 사용해야 합니다.</b>"
      },
      "automatic": {
        "title": "자동",
        "description": "모델과 제공업체가 네이티브 도구 호출을 지원하는 경우, 자동으로 도구를 사용합니다. <br />네이티브 도구 호출이 지원되지 않는 경우, 도구를 사용하려면 @agent 명령을 사용해야 합니다."
      }
    },
    "history": {
      "title": "채팅 기록",
    ...
    "prompt": {
      "title": "시스템 프롬프트",
      "description": "이 워크스페이스에서 사용할 프롬프트입니다. AI가 응답을 생성하기 위해 문맥과 지침을 정의합니다. AI가 질문에 대하여 정확한 응답을 생성할 수 있도록 신중하게 프롬프트를 제공해야 합니다.",
      "history": {
        "title": "시스템 프롬프트 기록",
        "clearAll": "전체 삭제",
    ...
    "refusal": {
      ...
      "tooltip-description": "현재 쿼리 모드에서는 문서의 정보만을 사용합니다. 더 자유로운 대화를 원하시면 채팅 모드로 전환하거나, 채팅 모드에 대한 자세한 내용은 문서를 참고하세요."
    },
    "temperature": {
      "title": "LLM 온도",
      "desc-start": "이 설정은 LLM 응답이 얼마나 \"창의적\"일지를 제어합니다.",
      "desc-end": "숫자가 높을수록 창의적입니다. 일부 모델에서는 너무 높게 설정하면 일관성 없는 응답이 나올 수 있습니다.",
  ...
  "vector-workspace": {
    ...
    "doc": {
      "title": "문서 유사성 임계값",
      "description": "채팅과 관련이 있다고 판단되는 문서의 유사성 점수입니다. 숫자가 높을수록 질문에 대한 문서의 내용이 유사합니다.",
      "zero": "제한 없음",
      "low": "낮음 (유사성 점수 ≥ .25)",
      "medium": "중간 (유사성 점수 ≥ .50)",
      "high": "높음 (유사성 점수 ≥ .75)"
    ...
    "reset": {
      "reset": "벡터 데이터베이스 재설정",
      "resetting": "벡터 지우는 중...",
      "confirm": "이 워크스페이스의 벡터 데이터베이스를 재설정하려고 합니다. 현재 임베딩된 모든 벡터 임베딩을 제거합니다.\n\n원본 소스 파일은 그대로 유지됩니다. 이 작업은 되돌릴 수 없습니다.",
      "error": "워크스페이스 벡터 데이터베이스를 재설정할 수 없습니다!",
      "success": "워크스페이스 벡터 데이터베이스가 재설정되었습니다!"
    }
  },
  "agent": {
    "performance-warning": "도구 호출을 명시적으로 지원하지 않는 LLM의 성능은 모델의 기능과 정확도에 크게 좌우됩니다. 일부 기능은 제한되거나 작동하지 않을 수 있습니다.",
    "provider": {
    ...
    "skill": {
      "rag": {
        "title": "RAG와 장기 메모리",
        "description": "에이전트가 제공된 문서를 활용하여 쿼리에 답변하거나 에이전트에게 \"기억\"할 내용을 요청하여 장기 메모리 검색을 허용합니다."
      },
      "view": {
        "title": "문서 보기 및 요약",
        "description": "에이전트가 현재 임베딩된 워크스페이스의 문서 내용을 나열하고 요약할 수 있도록 합니다."
      },
      "scrape": {
        "title": "웹사이트 스크래핑",
      ...
      "generate": {
        "title": "차트 생성",
        "description": "기본 에이전트가 채팅에서 제공된 데이터를 이용하여 다양한 유형의 차트를 생성할 수 있도록 합니다."
      },
      "web": {
        "title": "실시간 웹 검색 및 탐색",
        "description": "웹 검색 (SERP) 제공업체와 연결하여 에이전트가 웹을 검색하고 질문에 답변하도록 설정합니다."
      },
      "sql": {
        "title": "SQL 연결기",
        "description": "여러 SQL 데이터베이스 제공업체에 연결하여 에이전트가 SQL을 활용하여 질문에 답변할 수 있도록 지원합니다."
      },
      "default_skill": "기본적으로 이 기능은 활성화되어 있지만, 에이전트에게 이 기능을 사용하지 않도록 설정할 수도 있습니다.",
      "filesystem": {
        "title": "파일 시스템 접근",
        "description": "제 에이전트가 지정된 디렉토리 내에서 파일을 읽고, 쓰고, 검색하고, 관리할 수 있도록 합니다. 파일 편집, 디렉토리 탐색, 콘텐츠 검색을 지원합니다.",
        "learnMore": "이 기술을 사용하는 방법에 대해 자세히 알아보세요.",
        "configuration": "구성",
        "readActions": "실행 내용 보기",
        "writeActions": "실행 내용",
        "warning": "파일 시스템 접근은 위험할 수 있습니다. 왜냐하면 파일 내용을 변경하거나 삭제할 수 있기 때문입니다. 사용하기 전에 반드시 <a>문서</a>를 참조하십시오.",
        "skills": {
          "read-text-file": {
            "title": "파일 읽기",
            "description": "파일(텍스트, 코드, PDF, 이미지 등)의 내용을 읽습니다."
          },
          "read-multiple-files": {
            "title": "여러 파일을 읽기",
          ...
          "write-text-file": {
            "title": "텍스트 파일 작성",
            "description": "새로운 텍스트 파일을 생성하거나 기존 텍스트 파일을 덮어쓰기"
          }
        }
      },
      "createFiles": {
        "title": "문서 생성",
        "description": "에이전트가 파워포인트 프레젠테이션, 엑셀 스프레드시트, 워드 문서, PDF 등 이진 파일 형식의 문서를 생성할 수 있도록 지원합니다. 파일은 채팅 창에서 직접 다운로드할 수 있습니다.",
        "configuration": "사용 가능한 문서 유형",
        "skills": {
          "create-text-file": {
            "title": "텍스트 파일",
            "description": "원하는 내용과 확장자(.txt, .md, .json, .csv 등)를 사용하여 텍스트 파일을 생성합니다."
          },
          "create-pptx": {
            "title": "파워포인트 프레젠테이션",
            "description": "슬라이드, 제목, 마크다운 등을 포함하여 새로운 파워포인트 프레젠테이션을 만드세요."
          },
          "create-pdf": {
            "title": "PDF 문서",
            "description": "기본 스타일을 적용하여 마크다운 또는 일반 텍스트에서 PDF 문서를 생성합니다."
          },
          "create-xlsx": {
            "title": "엑셀 스프레드시트",
            "description": "표와 스타일을 포함한 표 형태의 데이터를 위한 엑셀 문서를 만드세요."
          },
          "create-docx": {
            "title": "워드 문서",
            "description": "기본적인 스타일과 서식을 사용하여 워드 문서를 만드세요."
          }
        }
      },
      "gmail": {
        "title": "GMail 연결기",
        "description": "제 에이전트가 Gmail과 상호 작용할 수 있도록 설정하세요 - 이메일 검색, 스레드 읽기, 초안 작성, 이메일 전송, 그리고 받은 메일 관리 기능을 사용하세요. <a>문서를 참조하세요</a>.",
        "multiUserWarning": "Gmail 통합 기능은 보안상의 이유로 다중 사용자 모드에서는 사용할 수 없습니다. 이 기능을 사용하려면 다중 사용자 모드를 비활성화해 주세요.",
        "configuration": "Gmail 설정",
        "deploymentId": "배포 ID",
        "deploymentIdHelp": "당신의 Google Apps Script 웹 앱의 배포 ID",
        "apiKey": "API 키",
        "apiKeyHelp": "당신이 Google Apps Script 배포 시 설정한 API 키",
        "configurationRequired": "Gmail 기능을 사용하려면 배포 ID와 API 키를 설정해 주세요.",
        "configured": "설정됨",
        "searchSkills": "검색 기술...",
        ...
        "categories": {
          ...
          "threads": {
            "title": "이메일 스레드 관리",
            "description": "이메일 스레드 관리 - 읽음/미읽음 표시, 아카이브, 삭제"
          },
          "account": {
            "title": "통합 통계",
      ...
      "outlook": {
        "title": "아웃룩 연결",
        "description": "Microsoft Outlook와 상호 작용할 수 있도록 에이전트에게 Microsoft Graph API를 사용하도록 설정합니다. 이메일 검색, 스레드 읽기, 초안 작성, 이메일 전송, 그리고 Microsoft Graph API를 통해 이메일함을 관리할 수 있습니다. 자세한 내용은 <a>문서를 참조하세요</a>.",
        "multiUserWarning": "Outlook 통합 기능은 보안상의 이유로 다중 사용자 모드에서는 사용할 수 없습니다. 이 기능을 사용하려면 다중 사용자 모드를 비활성화해 주십시오.",
        "configuration": "아웃룩 설정",
        "authType": "계정 유형",
        "authTypeHelp": "인증할 수 있는 Microsoft 계정 유형을 선택합니다. '모든 계정'은 개인 및 업무/학교 계정을 모두 지원합니다. '개인 계정만'은 개인 Microsoft 계정에만 적용됩니다. '특정 Azure AD 테넌트의 계정만'은 특정 Azure AD 테넌트의 업무/학교 계정에만 적용됩니다.",
        ...
        "clientIdHelp": "당신의 Azure AD 애플리케이션 등록 시 얻은 애플리케이션(클라이언트) ID",
        "tenantId": "임대인 ID",
        "tenantIdHelp": "Azure AD 애플리케이션 등록 시 얻은 (임차인) ID. 조직 내 사용자만 인증하는 경우에만 필요합니다.",
        "clientSecret": "고객 비밀",
        "clientSecretHelp": "Azure AD 애플리케이션 등록 시 얻은 클라이언트 비밀",
        "configurationRequired": "아웃룩 기능을 사용하려면 클라이언트 ID와 클라이언트 비밀을 설정해 주세요.",
        "authRequired": "먼저 사용자 정보를 저장한 다음, Microsoft를 통해 계정을 인증하여 설정 과정을 완료하십시오.",
        ...
        "skills": {
          ...
          "createDraft": {
            "title": "초안 작성",
            "description": "새로운 이메일 초안을 작성하거나 기존 메시지에 대한 답변 초안을 작성합니다."
          },
          "updateDraft": {
            "title": "초안 업데이트",
            "description": "기존 이메일 초안을 업데이트합니다."
      ...
      "googleCalendar": {
        "title": "구글 캘린더 연동",
        "description": "에이전트가 Google 캘린더와 상호 작용할 수 있도록 설정하세요 - 캘린더 보기, 이벤트 확인, 이벤트 생성 및 업데이트, RSVP 관리 등을 수행할 수 있습니다. <a>문서를 참조하세요</a>.",
        "multiUserWarning": "Google 캘린더 통합 기능은 보안상의 이유로 다중 사용자 모드에서는 사용할 수 없습니다. 이 기능을 사용하려면 다중 사용자 모드를 비활성화해주세요.",
        "configuration": "구글 캘린더 설정",
        "deploymentId": "배포 ID",
        "deploymentIdHelp": "당신의 구글 앱스 스크립트 웹 앱의 배포 ID",
        "apiKey": "API 키",
        "apiKeyHelp": "Google Apps Script 배포 시 설정한 API 키",
        "configurationRequired": "구글 캘린더 기능을 사용하려면 배포 ID와 API 키를 설정해 주세요.",
        "configured": "설정됨",
        "searchSkills": "검색 기술...",
        "noSkillsFound": "검색하신 조건과 일치하는 기술이 없습니다.",
        "categories": {
        ...
        "skills": {
          "listCalendars": {
            "title": "달력 목록",
            "description": "자신이 소유하거나 구독하고 있는 모든 캘린더 목록을 작성하세요."
          },
          "getCalendar": {
            "title": "달력 세부 정보 보기",
          ...
          "getUpcomingEvents": {
            "title": "다가오는 행사 보기",
            "description": "오늘, 이번 주 또는 이번 달의 이벤트를 간단한 키워드를 사용하여 검색"
          },
          "quickAdd": {
            "title": "빠르게 이벤트 추가",
            "description": "자연어 (예: \"내일 오후 3시에 회의\")를 사용하여 이벤트를 생성합니다."
          },
          "createEvent": {
            "title": "이벤트 생성",
            "description": "모든 속성에 대한 완전한 제어 기능을 갖춘 새로운 이벤트를 생성합니다."
          },
          "updateEvent": {
            "title": "이벤트 업데이트",
    ...
    "mcp": {
      ...
      "tool-warning": "최상의 성능을 위해, 불필요한 도구를 비활성화하여 컨텍스트를 보존하는 것을 고려해 보세요.",
      "stop-server": "MCP 서버 중단",
      "start-server": "MCP 서버 시작",
      "delete-server": "MCP 서버 삭제",
      "tool-count-warning": "이 MCP 서버에는 <b>에 설정된 {{count}} 도구가 있으며, 이는 모든 채팅에서 컨텍스트를 소비합니다. </b> 불필요한 도구를 비활성화하여 컨텍스트를 절약하는 것을 고려해 보세요.",
      "startup-command": "시작 명령어",
      "command": "명령",
      "arguments": "논쟁",
      "not-running-warning": "이 MCP 서버는 현재 실행 상태가 아닙니다. 중단되었거나, 시작 시 오류가 발생했을 수 있습니다.",
    ...
    "settings": {
      ...
      "max-tool-calls": {
        ...
        "description": "에이전트가 단일 응답을 생성하기 위해 사용할 수 있는 최대 툴의 개수입니다. 이를 통해 불필요한 툴 호출과 무한 루프를 방지합니다."
      },
      "intelligent-skill-selection": {
        "title": "지능형 기술 선택",
        "beta-badge": "베타",
        "description": "쿼리당 무제한의 도구 사용 및 컷 토큰 사용량을 최대 80%까지 줄일 수 있습니다 – AnythingLLM은 모든 프롬프트에 적합한 기술을 자동으로 선택합니다.",
        "max-tools": {
          "title": "맥스 툴스",
          "description": "각 쿼리에 사용할 수 있는 최대 도구 수입니다. 큰 컨텍스트 모델의 경우, 이 값을 더 높은 값으로 설정하는 것을 권장합니다."
        }
      }
    }
  },
  "recorded": {
    "title": "워크스페이스 채팅",
    "description": "이것들은 사용자들이 보낸 모든 채팅과 메시지입니다. 생성 날짜별로 정렬되어 있습니다.",
    "export": "내보내기",
    "table": {
      "id": "ID",
      "by": "보낸 사람",
  ...
  "customization": {
    ...
    "items": {
      ...
      "display-language": {
        "title": "표시 언어",
        "description": "AnythingLLM의 UI에 사용할 언어를 선택하세요. 번역이 제공되는 경우에만 적용됩니다."
      },
      "logo": {
        "title": "브랜드 로고",
      ...
      "render-html": {
        "title": "채팅에서 HTML 렌더링",
        "description": "어시스턴트 응답에 HTML 응답을 표시합니다.\n이는 응답 품질의 훨씬 더 높은 수준을 달성할 수 있지만, 잠재적인 보안 위험으로 이어질 수도 있습니다."
      }
    }
  },
  "api": {
    "title": "API 키",
    "description": "API 키는 소유자가 프로그래밍 방식으로 이 AnythingLLM 인스턴스에 액세스하고 관리할 수 있도록 합니다.",
    "link": "API 문서 읽기",
    "generate": "새 API 키 생성",
    ...
    "modal": {
      ...
      "close": "닫기",
      "create": "API 키 만들기",
      "helper": "생성된 API 키는 이 AnythingLLM 인스턴스에 프로그래밍 방식으로 접근하고 구성하는 데 사용할 수 있습니다.",
      "name": {
        "label": "이름",
        "placeholder": "프로덕션 통합",
        "helper": "선택 사항입니다. 나중에 쉽게 식별할 수 있도록 알아보기 쉬운 이름을 사용하세요."
      }
    },
    "row": {
      "copy": "API 키 복사",
      "copied": "복사됨",
      "unnamed": "--",
      "deleteConfirm": "이 API 키를 비활성화하시겠습니까?\n비활성화하면 더 이상 사용할 수 없습니다.\n\n이 작업은 되돌릴 수 없습니다."
    },
    "table": {
      "name": "이름",
      "key": "API 키",
  ...
  "llm": {
    "title": "LLM 기본 설정",
    "description": "이것은 채팅과 임베딩을 하기 위한 선호하는 LLM 제공자의 인증입니다. 이 키가 현재 활성 상태이고 정확해야 AnythingLLM이 제대로 작동합니다.",
    "provider": "LLM 제공자",
    "providers": {
      "azure_openai": {
        ...
        "default": "기본값",
        "reasoning": "추론",
        "model_type_tooltip": "만약 귀하의 배포가 추론 모델(o1, o1-mini, o3-mini 등)을 사용한다면, 이 옵션을 \"추론\"으로 설정하십시오. 그렇지 않으면, 챗봇 요청이 실패할 수 있습니다."
      }
    }
  },
  "transcription": {
    "title": "텍스트 변환 모델 기본 설정",
    "description": "이것은 선호하는 텍스트 변환 모델 제공자의 인증입니다. 이 키가 현재 활성 상태이고 정확해야 미디어 파일 및 오디오가 텍스트 변환됩니다.",
    "provider": "텍스트 변환 제공자",
    "warn-start": "RAM 또는 CPU 성능이 제한된 머신에서 로컬 위스퍼 모델을 사용하면 미디어 파일을 처리할 때 AnythingLLM이 중단될 수 있습니다.",
    "warn-recommend": "최소 2GB RAM과 10Mb 보다 작은 파일 업로드를 권장합니다.",
    "warn-end": "내장된 모델은 첫 번째 사용 시 자동으로 다운로드됩니다."
  },
  "embedding": {
    "title": "임베딩 기본 설정",
    "desc-start": "임베딩 엔진을 지원하지 않는 LLM을 사용할 때 텍스트를 임베딩하는 데 다른 임베딩 엔진 제공자의 인증이 필요할 수 있습니다.",
    "desc-end": "임베딩은 텍스트를 벡터로 변환하는 과정입니다. 파일과 프롬프트를 AnythingLLM이 처리할 수 있는 형식으로 변환하려면 이러한 인증이 필요합니다.",
    "provider": {
      "title": "임베딩 제공자"
    }
  },
  "text": {
    ...
    "desc-start": "새 문서를 벡터 데이터베이스에 삽입하기 전에 기본 텍스트 분할 방식을 변경할 수 있습니다.",
  ...
  "vector": {
    "title": "벡터 데이터베이스",
    "description": "이것은 AnythingLLM 인스턴스가 벡터 데이터베이스 사용을 위한 인증 설정입니다. 이 키가 활성 상태이고 정확해야 합니다.",
    "provider": {
      "title": "벡터 데이터베이스 제공자",
  ...
  "embeddable": {
    "title": "임베드 가능한 채팅 위젯",
    "description": "임베드 가능한 채팅 위젯은 하나의 워크스페이스에 연결된 공개용 채팅방입니다. 이를 통해 워크스페이스 설정이 적용된 채팅방을 일반인들에게 공개할 수 있습니다.",
    "create": "임베드 생성",
    "table": {
      "workspace": "워크스페이스",
      "chats": "보낸 채팅",
  ...
  "connectors": {
    ...
    "github": {
      ...
      "token_explained_middle": "이 없으면 GitHub API의 요청 제한으로 인해 가져올 수 있는 파일 수가 제한될 수 있습니다. ",
      "token_explained_link2": "임시 액세스 토큰을 생성",
      "token_explained_end": "하여 이 문제를 피할 수 있습니다.",
      "ignores": "파일 무시 목록",
      "git_ignore": "수집 중 무시할 파일을 .gitignore 형식으로 입력하세요. 저장하려면 각 항목 입력 후 엔터를 누르세요.",
      "task_explained": "가져오기가 완료되면 모든 파일이 문서 선택기에서 워크스페이스에 임베딩할 수 있도록 제공됩니다.",
      "branch": "가져올 브랜치",
      "branch_loading": "-- 사용 가능한 브랜치 불러오는 중 --",
      "branch_explained": "가져오려는 브랜치를 선택하세요.",
      "token_information": "<b>GitHub 액세스 토큰</b>을 입력하지 않으면 GitHub의 공개 API 요청 제한으로 인해 이 데이터 커넥터는 저장소의 <b>최상위</b> 파일만 수집할 수 있습니다.",
    ...
    "gitlab": {
      ...
      "token_explained_start": "무엇보다 중요한 것은,",
      "token_explained_link1": "개인 액세스 토큰",
      "token_explained_middle": "이 없으면 GitLab API의 요청 제한으로 인해 가져올 수 있는 파일 수가 제한될 수 있습니다. ",
      "token_explained_link2": "임시 액세스 토큰을 생성",
      "token_explained_end": "하여 이 문제를 피할 수 있습니다.",
      ...
      "branch_loading": "-- 사용 가능한 브랜치 불러오는 중 --",
      "branch_explained": "가져오려는 브랜치를 선택하세요.",
      "token_information": "<b>GitLab 액세스 토큰</b>을 입력하지 않으면 GitLab의 공개 API 요청 제한으로 인해 이 데이터 커넥터는 저장소의 <b>최상위</b> 파일만 수집할 수 있습니다.",
    ...
    "youtube": {
      ...
      "task_explained": "가져오기가 완료되면 자막이 문서 선택기에서 워크스페이스에 임베딩할 수 있도록 제공됩니다."
    },
    "website-depth": {
      "name": "웹사이트 대량 링크 수집",
      ...
      "task_explained": "수집이 완료되면 모든 크롤링된 콘텐츠가 문서 선택기에서 워크스페이스에 임베딩할 수 있도록 제공됩니다."
    },
    "confluence": {
      "name": "Confluence",
      "description": "한 번의 클릭으로 전체 Confluence 페이지를 가져옵니다.",
      "deployment_type": "Confluence 배포 유형",
      "deployment_type_explained": "Confluence 인스턴스가 Atlassian 클라우드에 호스팅되어 있는지, 자체 서버에 설치되어 있는지 선택하세요.",
      ...
      "task_explained": "가져오기가 완료되면 페이지 내용이 문서 선택기에서 워크스페이스에 임베딩할 수 있도록 제공됩니다.",
      "bypass_ssl": "SSL 인증서 유효성 검사 우회",
      "bypass_ssl_explained": "자체 서명된 인증서를 사용하는 자체 호스팅 Confluence 인스턴스에 대해 SSL 인증서 유효성 검사를 우회하기 위해 이 옵션을 활성화합니다."
    },
    "manage": {
      "documents": "문서 관리",
      "data-connectors": "데이터 커넥터",
      "desktop-only": "이 설정은 데스크톱 환경에서만 편집할 수 있습니다. 계속하려면 데스크톱에서 이 페이지에 접속해 주세요.",
      "dismiss": "닫기",
      "editing": "편집 중"
    },
    "directory": {
      ...
      "delete-confirmation": "이 파일과 폴더를 삭제하시겠습니까?\n삭제 시 시스템에서 완전히 제거되며, 기존 워크스페이스에서도 자동으로 삭제됩니다.\n이 작업은 되돌릴 수 없습니다.",
      "removing-message": "{{count}}개의 문서와 {{folderCount}}개의 폴더를 삭제하는 중입니다. 잠시만 기다려 주세요.",
    ...
    "upload": {
      ...
      "processor-offline-desc": "현재 문서 처리기가 오프라인이어서 파일을 업로드할 수 없습니다. 잠시 후 다시 시도해 주세요.",
      ...
      "privacy-notice": "이 파일들은 이 AnythingLLM 인스턴스에서 실행 중인 문서 처리기로 업로드됩니다. 파일은 제3자에게 전송되거나 공유되지 않습니다."
    },
    "pinning": {
      "what_pinning": "문서 고정이란 무엇인가요?",
      "pin_explained_block1": "AnythingLLM에서 문서를 <b>고정</b>하면 해당 문서의 전체 내용을 프롬프트 창에 삽입하여 LLM이 완전히 이해할 수 있도록 합니다.",
      "pin_explained_block2": "이 기능은 <b>대용량 컨텍스트 모델</b>이나 지식 기반에 중요한 소형 파일에 가장 적합합니다.",
      "pin_explained_block3": "기본 설정만으로 원하는 답변을 얻지 못할 때, 문서 고정은 한 번의 클릭으로 더 높은 품질의 답변을 얻을 수 있는 좋은 방법입니다.",
      "accept": "확인했습니다"
    },
    "watching": {
      "what_watching": "문서 감시는 무엇을 하나요?",
      "watch_explained_block1": "AnythingLLM에서 문서를 <b>감시</b>하면 원본 소스에서 정기적으로 문서 내용을 <i>자동으로</i> 동기화합니다. 이 파일이 관리되는 모든 워크스페이스의 내용이 자동으로 업데이트됩니다.",
      "watch_explained_block2": "이 기능은 현재 온라인 기반 콘텐츠만 지원하며, 수동으로 업로드한 문서에는 사용할 수 없습니다.",
  ...
  "chat_window": {
    ...
    "submit": "제출",
    "edit_info_user": "\"제출\"은 AI 응답을 다시 생성합니다. \"저장\"은 사용자 메시지만 업데이트합니다.",
    ...
    "agent_skills_disabled_in_session": "활성 에이전트 세션 중에 기술을 변경할 수 없습니다. 먼저 /exit 명령을 사용하여 세션을 종료하십시오.",
    "start_agent_session": "에이전트 세션 시작",
    "use_agent_session_to_use_tools": "채팅에서 도구를 사용하려면, 프롬프트의 시작 부분에 '@agent'을 사용하여 에이전트 세션을 시작할 수 있습니다.",
    "agent_invocation": {
      ...
      "clarifying_question_header": "담당자는 추가 정보가 필요합니다.",
      "clarifying_skip": "에이전트에게 결정하도록 맡깁니다.",
  ...
  "community_hub": {
    "publish": {
      "system_prompt": {
        ...
        "tags_label": "태그",
        "tags_description": "태그를 추가하면 시스템 프롬프트를 더 쉽게 검색할 수 있습니다. 여러 개의 태그를 추가할 수 있습니다. 최대 5개, 태그당 20자 이내로 입력해 주세요.",
      ...
      "agent_flow": {
        ...
        "tags_label": "태그",
        "tags_description": "태그를 추가하면 에이전트 플로우를 더 쉽게 검색할 수 있습니다. 여러 개의 태그를 추가할 수 있습니다. 최대 5개, 태그당 20자 이내로 입력해 주세요.",
        "tags_placeholder": "태그 입력 후 Enter를 눌러 추가",
        "visibility_label": "공개 범위",
        "submitting": "게시 중...",
        "submit": "커뮤니티 허브에 게시",
        "privacy_note": "에이전트 플로우는 민감한 데이터를 보호하기 위해 항상 비공개로 업로드됩니다. 게시 후 커뮤니티 허브에서 공개 범위를 변경할 수 있습니다. 게시 전에 플로우에 민감하거나 개인 정보가 포함되어 있지 않은지 꼭 확인해 주세요."
      },
      "slash_command": {
        "success_title": "성공!",
        ...
        "tags_label": "태그",
        "tags_description": "태그를 추가하면 슬래시 커맨드를 더 쉽게 검색할 수 있습니다. 여러 개의 태그를 추가할 수 있습니다. 최대 5개, 태그당 20자 이내로 입력해 주세요.",
        "tags_placeholder": "태그 입력 후 Enter를 눌러 추가",
        "visibility_label": "공개 범위",
  ...
  "security": {
    ...
    "multiuser": {
      ...
      "enable": {
        ...
        "description": "당신은 기본 관리자가 됩니다. 관리자로서 모든 신규 사용자 또는 관리자의 계정을 생성해야 합니다. 비밀번호를 잃어버리면 관리자만 비밀번호를 재설정할 수 있습니다.",
    ...
    "password": {
      "title": "비밀번호 보호",
      "description": "AnythingLLM 인스턴스를 비밀번호로 보호하십시오. 이 비밀번호를 잊어버리면 복구 방법이 없으므로 반드시 저장하세요.",
  ...
  "home": {
    ...
    "notAssigned": "현재 워크스페이스에 할당되지 않았습니다.\n워크스페이스에 대한 접근을 요청하려면 관리자에게 문의하세요.",
    "goToWorkspace": "워크스페이스로 이동 \"{{workspace}}\""
  },
  "telegram": {
    "title": "텔레그램 봇",
    "description": "AnyLLM 인스턴스를 Telegram과 연결하여, 어떤 기기에서든 워크스페이스와 채팅할 수 있도록 합니다.",
    "setup": {
      "step1": {
        "title": "1단계: 텔레그램 봇을 만드세요",
        "description": "텔레그램에서 @BotFather를 열고, <code>/newbot</code>를 <code>@BotFather</code>에게 보내고, 안내에 따라 진행하여 API 토큰을 복사합니다.",
        "open-botfather": "BotFather 시작",
        "instruction-1": "1. 링크를 열거나 QR 코드를 스캔",
        "instruction-2": "2. <code>/newbot</code>를 <code>@BotFather</code>에게 전송",
        "instruction-3": "3. 봇의 이름과 사용자 이름을 선택하세요.",
        "instruction-4": "4. 받은 API 토큰을 복사합니다."
      },
      "step2": {
        "title": "2단계: 봇을 연결합니다.",
        "description": "@BotFather로부터 받은 API 토큰을 복사하여, 봇이 채팅할 기본 워크스페이스를 선택하세요.",
        "bot-token": "봇 토큰",
        "connecting": "연결 중...",
        "connect-bot": "연결 봇"
      },
      "security": {
        "title": "권장 보안 설정",
        "description": "추가적인 보안을 위해, @BotFather에서 다음 설정을 구성해 주세요.",
        "disable-groups": "— 그룹에 봇 추가 방지",
        "disable-inline": "— 인라인 검색에서 봇 사용을 방지",
        "obscure-username": "자명한 봇 사용자 이름을 피하고, 발견 가능성을 줄이기 위해"
      },
    ...
    "connected": {
      "status": "연결된",
      "status-disconnected": "연결되지 않음 – 토큰이 만료되었거나 유효하지 않을 수 있습니다",
    ...
    "users": {
      "pending-description": "승인 대기 중인 사용자. 여기 표시된 매칭 코드를 자신의 Telegram 채팅에서 표시된 코드로 일치시켜 주세요.",
      "unknown": "알 수 없음"
    }
  }
}
