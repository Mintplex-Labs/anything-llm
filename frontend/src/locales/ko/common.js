...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      "no-documents": "문서를 찾을 수 없습니다",
      no_docs: "작업 공간에 문서가 없습니다",
      "new-folder": "새 폴더",
      ...
      "select-folder": "폴더 선택",
      "document-count": "{{count}}개의 문서",
      "rename-document": "문서 이름 변경",
      "new-name": "새 이름",
      "enter-new-name": "새 이름 입력",
      "delete-confirmation":
        "이 파일과 폴더를 삭제하시겠습니까?\n이 작업은 파일을 시스템에서 제거하고 모든 기존 작업 공간에서 자동으로 제거합니다.\n이 작업은 취소할 수 없습니다.",
      "removing-message":
        "{{count}}개의 문서와 {{folderCount}}개의 폴더를 삭제 중입니다. 잠시만 기다려주세요.",
