...
const TRANSLATIONS = {
  ...
  "main-page": {
    ...
    "exploreMore": {
      ...
      "features": {
        ...
        "systemPrompts": {
          "title": "시스템 프롬프트",
          "description": "시스템 프롬프트를 수정해 워크스페이스의 AI 답변을 원하는 대로 맞춤 설정하세요.",
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        ...
        "description": "LLM의 일반적인 지식과 관련 문맥 정보를 활용하여 답변을 제공합니다. 도구를 사용하려면 @agent 명령어를 사용해야 합니다."
      },
      "query": {
        "title": "쿼리",
        ...
        "only": "때만",
        "desc-end": "답변을 제공합니다.",
        "description": "문서 맥락이 발견되면 <b>에만</b> 답변을 제공합니다.<br /> 도구를 사용하려면 @agent 명령을 사용해야 합니다."
      },
      "automatic": {
        "title": "자동",
  ...
  "agent": {
    ...
    "skill": {
      "title": "기본 에이전트 스킬",
      "description": "기본 에이전트의 능력을 사전 정의된 스킬을 사용하여 향상시킵니다. 이 설정은 모든 워크스페이스에 적용됩니다.",
      "rag": {
        "title": "RAG와 장기 메모리",
