  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        title: "Luba esindajale esitada selgitavaid küsimusi",
        "beta-badge": "BEETA",
        description:
          "Kui see funktsioon on sisse lülitatud, võivad agentid peatuda ja esitada lühikesi selgitavaid küsimusi, kui teie palge on ebaselge. Vaikimisi välja lülitatud. Ei ole saadaval API/programmatöö jaoks.",
        "max-per-turn": {
          title: "Maximaalne küsimuste arv ühes voorus",
          description:
            "Kuivõrd agent võib vastuses esitada selgitavaid küsimusi? Mida vähem küsimusi, seda vähem häiriv.",
        },
        timeout: {
          title: "Vastus aja piir (sekundites)",
          description:
            "Kui kasutaja ei vastata määru ajaga, siis esindaja kasutab oma parimat arvamust.",
        },
      },
    },
  },
