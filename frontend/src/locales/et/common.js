...
const TRANSLATIONS = {
    ...
    "exploreMore": {
      ...
      "features": {
        ...
        "systemPrompts": {
          ...
          "description": "Muuda süsteemprompti, et kohandada AI vastuseid tööruumis.",
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        ...
        "description": "teenab vastuseid, kasutades LLM-i üldist teadmist ja dokumentide konteksti, mida on leitav.<br /> Selleks peate kasutama käsku \"@agent\"."
      },
      "query": {
        "title": "Päring",
        ...
        "description": "teenib vastuseid <b>ainult__, kui dokumendi kontekst on leitud.</b> Vajate kasutama käesu \"agent\", et kasutada tööriime."
      },
      "automatic": {
        "title": "Automaailm",
        "description": "kasutab automaatselt tööriistu, kui mudel ja pakkuja toetavad native tööriistade kasutamist. <br />Kui native tööriistade kasutamine pole toetatud, peate kasutama käsku \"@agent\", et tööriiste kasutada."
      }
    },
    "history": {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "description": "Paranda vaikimisi agendi loomulikke oskusi nende eelnevalt ehitatud võimetega. Kehtib kõikidele tööruumidele.",
      "rag": {
      ...
      "save": {
        ...
        "description": "Lubab agendil luua faile, mis salvestatakse ja allalaaditakse brauseris."
      },
      "web": {
        "title": "Reaalajas veebihaku tugi",
        "desc-start": "Lubab agendil kasutada veebiotsingut küsimustele vastamiseks, ühendudes SERP-teenusega.",
  ...
  "customization": {
    ...
    "items": {
      ...
      "welcome-messages": {
        ...
        "description": "Kohanda sõnumeid, mida kasutajad näevad sisselogimisel. Ainult mitte-adminid näevad neid.",
        "new": "Uus",
        "system": "süsteem",
        "user": "kasutaja",
        "message": "sõnum",
  ...
  "community_hub": {
    "publish": {
      ...
      "slash_command": {
        ...
        "command_label": "Käsk",
        "command_description": "Käsk, mille kasutajad sisestavad selle preseti käivitamiseks.",
