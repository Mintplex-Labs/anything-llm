  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        ...
        description:
          "Quando ativado, os agentes podem pausar para fazer perguntas curtas e esclarecedoras se a sua solicitação for ambígua. Desativado por padrão. Não está disponível para execução de agentes via API/programática.",
        "max-per-turn": {
          title: "Número máximo de perguntas por rodada",
          description:
            "Quantas perguntas de esclarecimento o agente pode fazer em uma única resposta. Quanto menos, menos interrompe.",
        },
        timeout: {
          title: "Tempo limite de resposta (segundos)",
          description:
            "Caso o usuário não responda dentro deste prazo, o agente prossegue com o melhor julgamento possível.",
        },
      },
    },
  },
