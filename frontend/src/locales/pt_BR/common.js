...
const TRANSLATIONS = {
  ...
  "chat": {
    ...
    "mode": {
      ...
      "automatic": {
        "title": "Automóvel",
        "description": "utilizará automaticamente as ferramentas, se o modelo e o provedor suportarem a chamada nativa de ferramentas. Se a chamada nativa de ferramentas não for suportada, você precisará usar o comando \"@agent\" para utilizar as ferramentas."
      }
    },
    "history": {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "description": "Melhore as habilidades naturais do agente com estas funções pré-configuradas. Aplica-se a todos os workspaces.",
      "rag": {
      ...
      "web": {
        "title": "Busca na web",
        "desc-start": "Permite ao agente pesquisar na web para responder perguntas conectando-se a um provedor de busca.",
        "desc-end": "Buscas na web durante sessões de agente não funcionarão até que isso seja configurado."
      }
    }
  },
  "recorded": {
