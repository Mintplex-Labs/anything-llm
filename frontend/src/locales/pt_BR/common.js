const TRANSLATIONS = {
  "onboarding": {
    ...
    "userSetup": {
      ...
      "adminUsernameReq": "O nome deve ter pelo menos 6 caracteres e conter apenas letras minúsculas, números, sublinhados e hífens, sem espaços.",
  ...
  "welcomeMessage": {
    "part1": "Bem-vindo ao AnythingLLM, uma ferramenta de IA open-source da Mintplex Labs que transforma qualquer conteúdo em um chatbot treinado. AnythingLLM é um software BYOK (bring-your-own-keys), sem taxas ou assinaturas.",
    "part2": "AnythingLLM é a maneira mais fácil de integrar poderosas ferramentas de IA como OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB e outros serviços em um pacote simples.",
    "part3": "AnythingLLM pode rodar localmente na sua máquina com baixo consumo de recursos. Sem GPU necessária. Disponível para instalação na nuvem ou on-premises.\nO ecossistema de IA evolui rapidamente. AnythingLLM facilita seu uso.",
  ...
  "agent": {
    ...
    "skill": {
      ...
      "generate": {
        ...
        "description": "Permite ao agent padrão gerar diversos tipos de gráficos a partir de dados armazenados ou informados no chat."
      },
      "save": {
  ...
  "embedding": {
    ...
    "provider": {
      ...
      "description": "Nenhuma configuração é necessária ao usar o mecanismo nativo do AnythingLLM."
    }
  },
  "text": {
