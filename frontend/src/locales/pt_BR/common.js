...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      "search-document": "Pesquisar documentos...",
      "no-documents": "Nenhum documento encontrado",
      no_docs: "Nenhum documento no espaço de trabalho",
      "new-folder": "Nova pasta",
      "create-folder": "Criar pasta",
      "folder-name": "Nome da pasta",
      "enter-folder-name": "Digite o nome da pasta",
      "add-tag": "Adicionar tag",
      "enter-tag": "Digite o nome da tag",
      ...
      "delete-confirmation":
        "Tem certeza que deseja excluir estes arquivos e pastas?\nIsso removerá os arquivos do sistema e os removerá automaticamente de todos os espaços de trabalho existentes.\nEsta ação não pode ser desfeita.",
      "removing-message":
        "Removendo {{count}} documentos e {{folderCount}} pastas. Por favor, aguarde.",
      ...
      costs: "*Custo único para incorporação",
      save_embed: "Salvar e incorporar",
    },
    upload: {
