...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "data": {
      ...
      "description": "Estamos comprometidos com a transparência e o controle quando se trata de seus dados pessoais.",
      "settingsHint": "Essas configurações podem ser reconfiguradas a qualquer momento nas configurações."
    },
    "workspace": {
  ...
  "login": {
    ...
    "password-reset": {
      ...
      "description": "Forneça as informações necessárias abaixo para redefinir sua senha.",
  ...
  "general": {
    ...
    "message": {
      ...
      "description": "Personalize as mensagens que serão sugeridas aos usuários do seu workspace.",
    ...
    "pfp": {
      ...
      "description": "Personalize a imagem de perfil do assistente para este workspace.",
      "image": "Imagem do Workspace",
      "remove": "Remover Imagem do Workspace"
    },
    "delete": {
      "title": "Excluir Workspace",
      "description": "Excluir este workspace e todos os seus dados. Isso excluirá o workspace para todos os usuários.",
      "delete": "Excluir Workspace",
      "deleting": "Excluindo Workspace...",
      "confirm-start": "Você está prestes a excluir todo o seu",
      "confirm-end": "workspace. Isso removerá todas as incorporações vetoriais no seu banco de dados vetorial.\n\nOs arquivos de origem originais permanecerão intactos. Esta ação é irreversível."
    }
  },
  "chat": {
    "llm": {
      "title": "Provedor de LLM do Workspace",
      "description": "O provedor e modelo específico de LLM que será usado para este workspace. Por padrão, usa o provedor e as configurações do sistema LLM.",
      "search": "Pesquisar todos os provedores de LLM"
    },
    "model": {
      "title": "Modelo de Chat do Workspace",
      "description": "O modelo de chat específico que será usado para este workspace. Se vazio, usará a preferência do LLM do sistema.",
    ...
    "history": {
      ...
      "desc-end": "Qualquer coisa acima de 45 provavelmente levará a falhas contínuas de chat dependendo do tamanho da mensagem."
    },
    "prompt": {
      "title": "Prompt",
      "description": "O prompt que será usado neste workspace. Defina o contexto e as instruções para que a IA gere uma resposta. Você deve fornecer um prompt cuidadosamente elaborado para que a IA possa gerar uma resposta relevante e precisa.",
      "history": {
        "title": null,
        "clearAll": null,
        "noHistory": null,
    ...
    "temperature": {
      ...
      "desc-end": "Quanto maior o número, mais criativa será a resposta. Para alguns modelos, isso pode levar a respostas incoerentes quando configurado muito alto.",
  ...
  "vector-workspace": {
    ...
    "snippets": {
      ...
      "description": "Esta configuração controla a quantidade máxima de trechos de contexto que será enviada ao LLM por chat ou consulta.",
    ...
    "reset": {
      ...
      "confirm": "Você está prestes a redefinir o banco de dados vetorial deste workspace. Isso removerá todas as incorporações vetoriais atualmente embutidas.\n\nOs arquivos de origem originais permanecerão intactos. Esta ação é irreversível.",
      "error": "O banco de dados vetorial do workspace não pôde ser redefinido!",
      "success": "O banco de dados vetorial do workspace foi redefinido com sucesso!"
    }
  },
  "agent": {
    ...
    "provider": {
      ...
      "description": "O provedor e modelo específico de LLM que será usado para o agente @agent deste workspace."
    },
    "mode": {
      "chat": {
        "title": "Modelo de Chat do Agente do Workspace",
        "description": "O modelo de chat específico que será usado para o agente @agent deste workspace."
      },
      "title": "Modelo do Agente do Workspace",
      "description": "O modelo de LLM específico que será usado para o agente @agent deste workspace.",
      "wait": "-- aguardando modelos --"
    },
    "skill": {
      "title": "Habilidades padrão do agente",
      "description": "Melhore as habilidades naturais do agente padrão com essas habilidades pré-construídas. Esta configuração se aplica a todos os workspaces.",
      "rag": {
        "title": "RAG e memória de longo prazo",
        "description": "Permitir que o agente utilize seus documentos locais para responder a uma consulta ou pedir ao agente para \"lembrar\" peças de conteúdo para recuperação de memória de longo prazo."
      },
      "view": {
        "title": "Visualizar e resumir documentos",
        "description": "Permitir que o agente liste e resuma o conteúdo dos arquivos do workspace atualmente incorporados."
      },
      "scrape": {
        "title": "Raspagem de sites",
        "description": "Permitir que o agente visite e raspe o conteúdo de sites."
      },
      "generate": {
        "title": "Gerar gráficos",
        "description": "Habilitar o agente padrão para gerar vários tipos de gráficos a partir dos dados fornecidos ou dados no chat."
      },
      "save": {
        "title": "Gerar e salvar arquivos no navegador",
        "description": "Habilitar o agente padrão para gerar e gravar arquivos que podem ser salvos e baixados no seu navegador."
      },
      "web": {
        "title": "Pesquisa e navegação na web ao vivo",
        "desc-start": "Permitir que seu agente pesquise na web para responder suas perguntas conectando-se a um provedor de pesquisa na web (SERP).",
        "desc-end": "A pesquisa na web durante as sessões do agente não funcionará até que isso seja configurado."
      }
    }
  },
  "recorded": {
    "title": "Chats do Workspace",
    "description": "Estes são todos os chats e mensagens gravados que foram enviados pelos usuários ordenados por data de criação.",
    "export": "Exportar",
    "table": {
      "id": "Id",
      "by": "Enviado Por",
  ...
  "api": {
    "title": "Chaves API",
    "description": "As chaves API permitem que o titular acesse e gerencie programaticamente esta instância do AnythingLLM.",
  ...
  "llm": {
    ...
    "description": "Estas são as credenciais e configurações para seu provedor preferido de chat e incorporação de LLM. É importante que essas chaves estejam atualizadas e corretas, caso contrário, o AnythingLLM não funcionará corretamente.",
    "provider": "Provedor de LLM"
  },
  "transcription": {
    "title": "Preferência de Modelo de Transcrição",
    "description": "Estas são as credenciais e configurações para seu provedor preferido de modelo de transcrição. É importante que essas chaves estejam atualizadas e corretas, caso contrário, os arquivos de mídia e áudio não serão transcritos.",
    "provider": "Provedor de Transcrição",
    "warn-start": "Usar o modelo whisper local em máquinas com RAM ou CPU limitados pode travar o AnythingLLM ao processar arquivos de mídia.",
    "warn-recommend": "Recomendamos pelo menos 2GB de RAM e upload de arquivos <10Mb.",
    "warn-end": "O modelo embutido será baixado automaticamente no primeiro uso."
  },
  "embedding": {
    "title": "Preferência de Incorporação",
    "desc-start": "Ao usar um LLM que não suporta nativamente um mecanismo de incorporação - pode ser necessário especificar adicionalmente as credenciais para incorporação de texto.",
    "desc-end": "A incorporação é o processo de transformar texto em vetores. Essas credenciais são necessárias para transformar seus arquivos e prompts em um formato que o AnythingLLM possa usar para processar.",
    "provider": {
      "title": "Provedor de Incorporação",
      "description": "Não é necessária configuração ao usar o mecanismo de incorporação nativo do AnythingLLM."
    }
  },
  "text": {
    "title": "Preferências de Divisão e Fragmentação de Texto",
    "desc-start": "Às vezes, você pode querer alterar a maneira padrão como novos documentos são divididos e fragmentados antes de serem inseridos em seu banco de dados de vetores.",
    "desc-end": "Você só deve modificar esta configuração se entender como a divisão de texto funciona e seus efeitos colaterais.",
    ...
    "size": {
      ...
      "description": "Este é o comprimento máximo de caracteres que pode estar presente em um único vetor.",
      "recommend": "O comprimento máximo do modelo de incorporação é"
    },
    "overlap": {
      "title": "Sobreposição de Fragmento de Texto",
      "description": "Esta é a sobreposição máxima de caracteres que ocorre durante a fragmentação entre dois fragmentos de texto adjacentes."
    }
  },
  "vector": {
    "title": "Banco de Dados Vetorial",
    "description": "Estas são as credenciais e configurações de como sua instância do AnythingLLM funcionará. É importante que essas chaves estejam atualizadas e corretas.",
    "provider": {
  ...
  "embeddable": {
    ...
    "description": "Os widgets de chat incorporáveis são interfaces de chat públicas vinculadas a um único workspace. Eles permitem que você construa workspaces que você pode publicar para o mundo.",
  ...
  "embed-chats": {
    ...
    "export": "Exportar",
    "description": "Estes são todos os chats e mensagens registrados de qualquer incorporação que você publicou.",
    "table": {
      "embed": "Incorporação",
      "sender": "Remetente",
      "message": "Mensagem",
  ...
  "multi": {
    ...
    "description": "Configure sua instância para suportar sua equipe ativando o Modo Multiusuário.",
    "enable": {
      "is-enable": "Modo Multiusuário está Ativado",
      "enable": "Ativar Modo Multiusuário",
      "description": "Por padrão, você será o único administrador. Como administrador, você precisará criar contas para todos os novos usuários ou administradores. Não perca sua senha, pois apenas um usuário Administrador pode redefinir senhas.",
      "username": "Nome de usuário da conta de Administrador",
      "password": "Senha da conta de Administrador"
    },
    "password": {
      "title": "Proteção por Senha",
      "description": "Proteja sua instância do AnythingLLM com uma senha. Se você esquecer esta senha, não há método de recuperação, então certifique-se de salvar esta senha."
    },
    "instance": {
  ...
  "event": {
    ...
    "description": "Veja todas as ações e eventos acontecendo nesta instância para monitoramento.",
  ...
  "privacy": {
    ...
    "description": "Esta é a sua configuração de como os provedores de terceiros conectados e o AnythingLLM tratam seus dados.",
    "llm": "Seleção de LLM",
  ...
  "connectors": {
    ...
    "github": {
      ...
      "description": "Importe um repositório GitHub público ou privado inteiro com um único clique.",
