...
const TRANSLATIONS = {
  ...
  "model-router": {
    ...
    "no-routers": "目前还没有创建任何路由器型号。",
    "delete-confirm":
      '您确定要删除路由器 "{{name}}" 吗？\n\n这将删除所有相关规则，并断开使用该路由器的所有工作空间。\n\n此操作是不可逆的。',
    ...
    "new-router": {
      ...
      "fallback-label": "备用提供方及模型",
      "fallback-description": "当没有任何路由规则匹配时使用。",
      "cooldown-label": "缓存冷却时间 (秒)",
      "cooldown-help":
        "路由决策在重新评估规则之前，被缓存的时间长度。 设置为 0 以禁用缓存。",
      "name-required": "姓名必填。",
      "fallback-required": "需要备用提供方和模型。",
      cancel: "取消",
      creating: "创作...",
      create: "创建路由器",
      "toast-created": "路由器已成功创建",
    },
    "edit-router": {
      "back-to-routers": "返回：路由器模型",
      title: "编辑路由器：{{name}}",
      description: "更新路由器设置和备用服务提供商/型号。",
      name: "姓名",
      "description-label": "描述",
      "description-placeholder": "可选描述",
      "fallback-label": "备用服务提供商及模型",
      "fallback-description": "当没有任何路由规则匹配时使用",
      "cooldown-label": "缓存冷却时间 (秒)",
      "cooldown-help":
        "路由决策在重新评估规则之前，缓存的时间长度是多少。 将其设置为 0 以禁用缓存。",
      saving: "节省...",
      save: "保存更改",
    ...
    rules: {
      title: "路由规则",
      description:
        "规则会按照优先级从上到下进行评估。可以通过拖动来重新排序。第一个匹配的规则获胜。",
      "add-rule": "添加规则",
    ...
    "rule-form": {
      ...
      "new-title": "新的规定",
      "title-label": "标题",
      "title-help": "仅使用小写字母和下划线。保存时自动格式化。",
      "rule-type": "规则类型",
      "property-label": "房产",
      "property-select": "选择",
      ...
      "match-description-placeholder":
        "例如，用户可能在询问法律相关问题、合同、或合规性等方面",
      "match-description-help":
        "描述该规则应该在什么情况下触发。 路由器会读取用户的消息，并根据该规则来判断是否符合。",
    ...
    "provider-picker": {
      ...
      "toast-configured": "提供商配置成功",
    },
    "router-selection": {
      "loading-routers": "正在加载路由器...",
      "no-routers-prefix-settings": "目前还没有配置任何路由器型号。",
      "no-routers-prefix-workspace": "未配置任何路由器型号。",
      "no-routers-link": "在模型路由器设置中创建一项",
      "model-router-label": "型号路由器",
      "select-router": "选择一个路由器",
      "select-description": "选择用于此工作空间的路由器。",
      "no-routers-chat":
        "未配置任何路由器。请在“设置 > AI 提供方 > 路由器”中创建一个。",
      "rule-count": "（{{count}} 规则）",
    },
    metrics: {
