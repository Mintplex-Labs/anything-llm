...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "userSetup": {
      ...
      "teamHint": "默认情况下，你将是唯一的管理员。完成初始设置后，你可以创建和邀请其他人成为用户或管理员。不要丢失你的密码，因为只有管理员可以重置密码。"
    },
    "data": {
      "title": "数据处理与隐私",
  ...
  "common": {
    ...
    "no": "否",
    "search": "搜索",
    "username_requirements": "用户名必须为 2-32 个字符，以小写字母开头，只能包含小写字母、数字、下划线、连字符和句点。",
    "on": "关于",
    "none": "没有",
    "stopped": "停止",
    "loading": "正在加载…",
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        "title": "聊天",
        "description": "将提供答案，利用LLM的通用知识和提供的文档内容<b>和</b>。您需要使用@agent命令来使用工具。"
      },
      "query": {
        "title": "查询",
        "description": "将在找到文档上下文时，仅提供答案 <b>。您需要使用 @agent 命令来使用工具。"
      },
      "automatic": {
        "title": "自动",
        "description": "如果模型和提供者都支持原生工具调用，则会自动使用这些工具。<br />如果不支持原生工具调用，您需要使用 `@agent` 命令来使用工具。"
      }
    },
    "history": {
      "title": "聊天历史记录",
    ...
    "prompt": {
      "title": "系统提示词",
      "description": "将在此工作区上使用的提示词。定义 AI 生成响应的上下文和指令。你应该提供精心设计的提示，以便人工智能可以生成相关且准确的响应。",
      "history": {
        "title": "系统提示词历史",
        "clearAll": "全部清除",
    ...
    "refusal": {
      ...
      "tooltip-description": "您处于查询模式，此模式仅使用您文件中的信息。切换到聊天模式以进行更灵活的对话，或点击此处访问我们的文件以了解更多关于聊天模式的信息。"
    },
    "temperature": {
      "title": "LLM 温度",
  ...
  "vector-workspace": {
    ...
    "reset": {
      "reset": "重置向量数据库",
      "resetting": "清除向量...",
      "confirm": "你将重置此工作区的矢量数据库。这将删除当前嵌入的所有矢量嵌入。\n\n原始源文件将保持不变。此操作是不可逆转的。",
      "success": "向量数据库已重置。",
      "error": "无法重置工作区向量数据库！"
    }
  },
  "agent": {
    ...
    "skill": {
      ...
      "web": {
        "title": "实时网络搜索和浏览",
        "description": "通过连接到搜索引擎（SERP）提供商，让您的代理能够搜索互联网来回答您的问题。"
      },
      "sql": {
        "title": "SQL 连接器",
        "description": "让您的代理能够利用 SQL 来回答您的问题，只需连接到各种 SQL 数据库提供商即可。"
      },
      "default_skill": "默认情况下，这项技能已启用。但是，如果您不想让该技能被代理使用，您可以将其禁用。",
      "filesystem": {
        "title": "文件系统访问",
        "description": "允许您的代理能够读取、写入、搜索和管理指定目录中的文件。 支持文件编辑、目录导航和内容搜索功能。",
        "learnMore": "了解更多关于如何使用这项技能的信息。",
        "configuration": "配置",
        "readActions": "阅读操作",
        "writeActions": "编写操作",
        "warning": "访问文件系统可能存在风险，因为它可能修改或删除文件。在启用之前，请务必查阅<a>文档</a>。",
        "skills": {
          "read-text-file": {
            "title": "读取文件",
      ...
      "createFiles": {
        "title": "文档创建",
        "description": "允许您的代理创建二进制文档格式，例如PowerPoint演示文稿、Excel电子表格、Word文档和PDF文件。文件可以直接从聊天窗口下载。",
        "configuration": "可用的文件类型",
        "skills": {
          "create-text-file": {
            "title": "文本文件",
            "description": "创建包含任何内容和扩展名的文本文件（如 .txt、.md、.json、.csv 等）。"
          },
          "create-pptx": {
          ...
          "create-pdf": {
            "title": "PDF 文档",
            "description": "使用 Markdown 或纯文本，并进行基本的排版，创建 PDF 文档。"
          },
          "create-xlsx": {
            "title": "Excel电子表格",
      ...
      "gmail": {
        "title": "Gmail 连接器",
        "description": "让您的代理能够与Gmail互动：搜索邮件、阅读邮件线程、撰写草稿、发送邮件以及管理您的收件箱。请参考相关文档。",
        "multiUserWarning": "为了安全原因，在多用户模式下无法使用 Gmail 集成功能。请先禁用多用户模式，然后才能使用此功能。",
      ...
      "outlook": {
        "title": "Outlook 连接器",
        "description": "让您的代理通过 Microsoft Graph API 与 Microsoft Outlook 交互——搜索邮件、阅读邮件线程、撰写草稿、发送邮件以及管理您的收件箱。请查阅相关文档。",
        "multiUserWarning": "由于安全原因，在多用户模式下无法使用 Outlook 集成功能。请先关闭多用户模式，然后再使用此功能。",
        "configuration": "Outlook 设置",
        "authType": "账户类型",
        "authTypeHelp": "选择哪些类型的 Microsoft 账户可以进行身份验证。 \"所有账户\" 支持个人账户和工作/学校账户。 \"仅限个人账户\" 仅限于个人 Microsoft 账户。 \"仅限工作/学校账户\" 仅限于特定 Azure AD 租户的工作/学校账户。",
        ...
        "tenantId": "租户 ID",
        "tenantIdHelp": "您的 Azure AD 应用注册的“租户 ID”。仅在组织内部身份验证时需要。",
        "clientSecret": "客户端密钥",
        "clientSecretHelp": "您的 Azure AD 应用程序注册的客户端机密值",
        "configurationRequired": "请配置客户端 ID 和客户端密钥，以便启用 Outlook 相关功能。",
        "authRequired": "首先保存您的凭据，然后通过 Microsoft 进行身份验证以完成设置。",
      ...
      "googleCalendar": {
        "title": "Google 日历连接器",
        "description": "让您的代理能够与 Google 日历互动：查看日历、获取活动、创建和更新活动，以及管理确认回复。请参考相关文档。",
        "multiUserWarning": "由于安全原因，在多用户模式下无法使用 Google 日历集成功能。请先禁用多用户模式，然后再使用此功能。",
        "configuration": "谷歌日历配置",
        "deploymentId": "部署ID",
        "deploymentIdHelp": "您的 Google Apps Script 网页应用的部署 ID",
        "apiKey": "API 密钥",
        "apiKeyHelp": "您在 Google Apps Script 部署中配置的 API 密钥。",
        "configurationRequired": "请配置部署 ID 和 API 密钥，以启用 Google 日历功能。",
        "configured": "已配置",
        "searchSkills": "搜索技巧...",
    ...
    "mcp": {
      ...
      "tool-count-warning": "这个 MCP 服务器启用了 <b> 工具，这些工具会在每次聊天中使用上下文信息。</b> 建议禁用不需要的工具，以节省上下文。<br />",
      "startup-command": "启动命令",
      "command": "命令",
      "arguments": "争论",
      "not-running-warning": "这个 MCP 服务器目前处于停止状态，可能是因为在启动时出现了错误或被手动停止。",
    ...
    "settings": {
      ...
      "max-tool-calls": {
        "title": "每个回复的最大请求次数",
        "description": "单个代理可以使用的最大工具数量，用于生成单个响应。 这样可以防止工具调用数量过多，从而避免无限循环。"
      },
      "intelligent-skill-selection": {
        "title": "智能技能选择",
        "beta-badge": "β 版本",
        "description": "实现无限工具和按查询减少高达 80% 的 Token 使用量——AnythingLLM 能够自动选择最合适的技能，以应对每个提示。",
        "max-tools": {
          "title": "麦克斯工具",
          "description": "可以选取的工具的最大数量，用于每个查询。我们建议将此值设置为较高的值，以便在处理大型上下文模型时。"
        }
      }
    }
  },
  ...
  "llm": {
    "title": "LLM 首选项",
    "description": "这些是你首选的 LLM 聊天和嵌入提供商的凭据和设置。重要的是，确保这些密钥是最新的和正确的，否则 AnythingLLM 将无法正常运行。",
    "provider": "LLM 提供商",
    "providers": {
      "azure_openai": {
        ...
        "default": "预设",
        "reasoning": "推理",
        "model_type_tooltip": "如果您的部署使用了推理模型（例如 o1、o1-mini、o3-mini 等），请将此选项设置为“推理”。否则，您的聊天请求可能会失败。"
      }
    }
  },
  "transcription": {
    "title": "转录模型首选项",
    "description": "这些是你的首选转录模型提供商的凭据和设置。重要的是这些密钥是最新且正确的，否则媒体文件和音频将无法转录。",
    "provider": "转录提供商",
  ...
  "embedding": {
    ...
    "desc-end": "嵌入是将文本转换为矢量的过程。需要这些凭据才能将你的文件和提示转换为 AnythingLLM 可以用来处理的格式。",
    "provider": {
      "title": "嵌入引擎提供商"
    }
  },
  ...
  "embeddable": {
    "title": "可嵌入的聊天小部件",
    "description": "可嵌入的聊天小部件是与单个工作区绑定的面向公众的聊天界面。这些允许你构建工作区，然后你可以将其发布到全世界。",
    "create": "创建嵌入式对话",
    "table": {
      "workspace": "工作区",
      "chats": "已发送聊天",
  ...
  "connectors": {
    ...
    "github": {
      ...
      "token_information": "如果未填写 <b>GitHub 访问令牌</b>，由于 GitHub 的公共 API 限制，此数据连接器将只能收集仓库的 <b>顶层</b> 文件。",
    ...
    "gitlab": {
      ...
      "branch_loading": "-- 正在加载可用分支 --",
      "branch_explained": "您希望收集文件的分支。",
      "token_information": "如果未填写 <b>GitLab 访问令牌</b>，由于 GitLab 的公共 API 限制，此数据连接器将只能收集仓库的 <b>顶层</b> 文件。",
    ...
    "confluence": {
      ...
      "bypass_ssl_explained": "启用此选项以绕过对自托管 Confluence 实例的 SSL 证书验证，特别是使用自签名证书的情况。"
    },
    "manage": {
      "documents": "文档",
    ...
    "directory": {
      ...
      "delete-confirmation": "您确定要删除这些文件和文件夹吗？\n这将从系统中移除这些文件，并自动将其从所有关联工作区中移除。\n此操作无法撤销。",
    ...
    "upload": {
      ...
      "fetching": "正在获取...",
      "fetch-website": "获取网站",
      "privacy-notice": "这些文件将被上传到此 AnythingLLM 实例上的文档处理器。这些文件不会发送或共享给第三方。"
    },
    "pinning": {
      "what_pinning": "什么是文档固定？",
      "pin_explained_block1": "当您在 AnythingLLM 中<b>固定</b>一个文档时，我们会将整个文档内容注入到您的提示窗口中，让 LLM 能够完全理解它。",
      "pin_explained_block2": "这在 <b>大上下文模型</b> 或关键的小文件中效果最佳。",
      "pin_explained_block3": "如果默认情况下无法从 AnythingLLM 获取满意的答案，固定文档是提高答案质量的好方法。",
      "accept": "好的，知道了"
    },
    "watching": {
      "what_watching": "什么是监控文档？",
      "watch_explained_block1": "当您在 AnythingLLM 中<b>监控</b>一个文档时，我们会<i>自动</i>按定期间隔从其原始来源同步文档内容。系统会自动更新在所有使用该文档的工作区中的内容。",
  ...
  "chat_window": {
    ...
    "agent_skills_disabled_in_session": "在活动会话期间，无法修改技能。首先使用 /exit 命令结束会话。",
    "start_agent_session": "开始代理会",
    "use_agent_session_to_use_tools": "您可以通过在提示词的开头使用'@agent'来启动与代理的聊天，从而使用聊天工具。",
    "agent_invocation": {
      ...
      "clarifying_question_header": "代理方需要更多信息",
      "clarifying_skip": "让代理人决定",
      "clarifying_submit": "提交",
      "clarifying_skipped": "您可以让代理人来决定。",
      ...
      "batch_progress": "{{answered}} 在 {{total}} 的问题得到了解答。",
      "batch_skip_this": "跳过",
  ...
  "community_hub": {
    "publish": {
      "system_prompt": {
        ...
        "tags_label": "标签",
        "tags_description": "标签用于标记您的系统提示，以便于搜索。您可以添加多个标签。最多 5 个标签。每个标签最多 20 个字符。",
      ...
      "agent_flow": {
        ...
        "tags_label": "标签",
        "tags_description": "标签用于标记您的代理流程，以便于搜索。您可以添加多个标签。最多 5 个标签。每个标签最多 20 个字符。",
        "tags_placeholder": "输入并按 Enter 键添加标签",
        "visibility_label": "可见性",
        "submitting": "发布中...",
        "submit": "发布到社区中心",
        "privacy_note": "代理流程始终以上传为私有，以保护任何敏感资料。您可以在发布后在社区中心更改可见性。请在发布前验证您的流程不包含任何敏感或私人信息。"
      },
      "generic": {
        "unauthenticated": {
          "title": "需要验证",
      ...
      "slash_command": {
        ...
        "tags_label": "标签",
        "tags_description": "标签用于标记您的斜线指令，以便于搜索。您可以添加多个标签。最多 5 个标签。每个标签最多 20 个字符。",
        "tags_placeholder": "输入并按 Enter 键添加标签",
        "visibility_label": "可见性",
  ...
  "security": {
    ...
    "multiuser": {
      ...
      "enable": {
        "is-enable": "多用户模式已启用",
        "enable": "启用多用户模式",
        "description": "默认情况下，你将是唯一的管理员。作为管理员，你需要为所有新用户或管理员创建账户。不要丢失你的密码，因为只有管理员用户可以重置密码。",
        "username": "管理员账户用户名",
        "password": "管理员账户密码"
      }
    },
    "password": {
      "title": "密码保护",
      "description": "用密码保护你的AnythingLLM实例。如果你忘记了密码，那么没有恢复方法，所以请确保保存这个密码。",
      "password-label": "实例密码"
    }
  },
  "home": {
    ...
    "notAssigned": "你目前还没有分配到任何工作区。\n请联系你的管理员请求访问一个工作区。",
    "goToWorkspace": "前往 \"{{workspace}}\""
  },
  "telegram": {
    "title": "Telegram 机器人",
    "description": "将您的 AnythingLLM 实例与 Telegram 连接起来，这样您就可以从任何设备与您的工作空间进行聊天。",
    "setup": {
      "step1": {
        "title": "第一步：创建您的 Telegram 机器人",
        "description": "打开 Telegram 上的 @BotFather，发送 `/newbot` 到 <code>@BotFather</code>，按照提示操作，并复制 API 令牌。",
        "open-botfather": "启动 BotFather",
        "instruction-1": "1. 打开链接或扫描二维码",
        "instruction-2": "2. 将 <code>/newbot</code> 发送给 <code>@BotFather</code>",
        "instruction-3": "3. 为您的机器人选择一个名称和用户名",
        "instruction-4": "4. 复制您收到的 API 令牌"
      },
      "step2": {
        "title": "步骤 2：连接您的机器人",
        "description": "将您从 @BotFather 获得的 API 令牌粘贴到指定位置，并选择一个默认的工作区，以便您的机器人可以进行对话。",
        "bot-token": "机器人代币",
        "connecting": "正在连接...",
        "connect-bot": "连接机器人"
      },
      "security": {
        ...
        "obscure-username": "使用一个不显眼的机器人用户名，以降低其被发现的可能性。"
      },
    ...
    "users": {
      "pending-description": "等待验证的用户。请将此处显示的配对代码与他们在 Telegram 聊天中显示的配对代码进行匹配。",
      "unknown": "未知"
    }
  }
}
