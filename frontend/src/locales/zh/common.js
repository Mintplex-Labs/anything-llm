...
const TRANSLATIONS = {
  onboarding: {
    ...
    userSetup: {
      ...
      teamHint:
        "默认情况下，您将是唯一的管理员。完成入职后，您可以创建和邀请其他人成为用户或管理员。不要丢失您的密码，因为只有管理员可以重置密码。",
    },
    data: {
      title: "数据处理与隐私",
      description: "我们致力于在涉及您的个人数据时提供透明和控制。",
      settingsHint: "这些设置可以随时在设置中重新配置。",
    },
    survey: {
      title: "欢迎使用 AnythingLLM",
      description: "帮助我们为您的需求打造 AnythingLLM。可选。",
      email: "您的电子邮件是什么？",
      useCase: "您将如何使用 AnythingLLM？",
      useCaseWork: "用于工作",
      useCasePersonal: "用于个人使用",
      useCaseOther: "其他",
      comment: "您是如何听说 AnythingLLM 的？",
      commentPlaceholder:
        "Reddit，Twitter，GitHub，YouTube 等 - 让我们知道您是如何找到我们的！",
      skip: "跳过调查",
      thankYou: "感谢您的反馈！",
    },
    workspace: {
