...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "userSetup": {
      ...
      "teamHint": "默认情况下，你将是唯一的管理员。完成入职后，你可以创建和邀请其他人成为用户或管理员。不要丢失你的密码，因为只有管理员可以重置密码。"
    },
    "data": {
      "title": "数据处理与隐私",
  ...
  "chat": {
    ...
    "prompt": {
      "title": "聊天提示",
      "description": "将在此工作区上使用的提示。定义 AI 生成响应的上下文和指令。你应该提供精心设计的提示，以便人工智能可以生成相关且准确的响应。",
      "history": {
        "title": null,
        "clearAll": null,
        "noHistory": null,
  ...
  "agent": {
    ...
    "skill": {
      ...
      "web": {
        "title": "实时网络搜索和浏览",
        "desc-start": "通过连接到网络搜索（SERP）提供者，使你的代理能够搜索网络以回答你的问题。",
  ...
  "llm": {
    "title": "LLM 首选项",
    "description": "这些是你首选的 LLM 聊天和嵌入提供商的凭据和设置。重要的是，这些密钥是最新的和正确的，否则 AnythingLLM 将无法正常运行。",
    "provider": "LLM 提供商"
  },
  "transcription": {
    "title": "转录模型首选项",
