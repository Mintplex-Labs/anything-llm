...
const TRANSLATIONS = {
  ...
  lark: {
    ...
    setup: {
      title: "连接机器人",
      instructions:
        "创建一个 Lark 或飞书自建应用，启用机器人和 WebSocket 事件，然后输入应用凭据。",
      platform: "平台",
      "app-id": "App ID",
      ...
      connecting: "正在连接...",
      reconnect: "重新连接",
      "saved-secret": "除非输入新的 App Secret，否则将复用已保存的密钥。",
    ...
    connected: {
      "unknown-bot": "未知机器人",
      "no-secret": "未保存 App Secret",
      save: "保存设置",
      disconnect: "断开连接",
    },
    users: {
      title: "用户访问权限",
      description: "将待审批配对码与用户核对，然后批准或拒绝访问。",
      pending: "待审批",
      approved: "已批准用户",
    ...
    errors: {
      format_error: "消息格式被拒绝。",
      target_revoked: "原消息已不可用。",
      rate_limited: "已达到 Lark 速率限制，请稍后重试。",
      permission_denied: "请检查应用权限和已发布的应用版本。",
      upload_failed: "无法上传附件。",
      ssrf_blocked: "为确保安全，附件来源已被拦截。",
      send_timeout: "Lark 发送消息超时。",
      not_connected: "Lark 频道未连接。",
      unknown: "Lark 频道发生意外错误。",
      connect: "无法连接 Lark 频道。",
      disconnect: "无法断开 Lark 频道。",
      save: "无法保存 Lark 频道设置。",
      load: "无法加载 Lark 频道设置。",
      status: "无法刷新 Lark 频道状态。",
      users: "无法更新用户访问权限。",
    },
  },
  scheduledJobs: {
