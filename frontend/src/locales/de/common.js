...
const TRANSLATIONS = {
  ...
  "welcomeMessage": {
    ...
    "part4": "Es ist einfach. Alle Sammlungen sind in Behältern organisiert, die wir \"Arbeitsbereiche\" nennen. Arbeitsbereiche sind Behälter für Dateien, Dokumente, Bilder, PDFs und andere Dateien, die in etwas umgewandelt werden, das LLMs verstehen und in Gesprächen verwenden können.\n\nSie können jederzeit Dateien hinzufügen und entfernen.",
  ...
  "general": {
    ...
    "message": {
      ...
      "description": "Passen Sie die Nachrichten an, die Ihren Arbeitsbereich-Benutzern vorgeschlagen werden.",
    ...
    "pfp": {
      ...
      "description": "Passen Sie das Profilbild des Assistenten für diesen Arbeitsbereich an.",
      "image": "Arbeitsbereich-Bild",
      "remove": "Arbeitsbereich-Bild entfernen"
    },
    "delete": {
      "title": "Arbeitsbereich löschen",
      "description": "Löschen Sie diesen Arbeitsbereich und alle seine Daten. Dies löscht den Arbeitsbereich für alle Benutzer.",
      "delete": "Arbeitsbereich löschen",
      "deleting": "Arbeitsbereich wird gelöscht...",
      "confirm-start": "Sie sind dabei, Ihren gesamten",
      "confirm-end": "Arbeitsbereich zu löschen. Dies entfernt alle Vektoreinbettungen in Ihrer Vektordatenbank.\n\nDie ursprünglichen Quelldateien bleiben unberührt. Diese Aktion ist irreversibel."
    }
  },
  "chat": {
    "llm": {
      "title": "Arbeitsbereich-LLM-Anbieter",
      "description": "Der spezifische LLM-Anbieter und das Modell, das für diesen Arbeitsbereich verwendet wird. Standardmäßig wird der System-LLM-Anbieter und dessen Einstellungen verwendet.",
      "search": "Durchsuchen Sie alle LLM-Anbieter"
    },
    "model": {
      "title": "Arbeitsbereich-Chat-Modell",
      "description": "Das spezifische Chat-Modell, das für diesen Arbeitsbereich verwendet wird. Wenn leer, wird die System-LLM-Präferenz verwendet.",
    ...
    "prompt": {
      "title": "Prompt",
      "description": "Der Prompt, der in diesem Arbeitsbereich verwendet wird. Definieren Sie den Kontext und die Anweisungen für die KI, um eine Antwort zu generieren. Sie sollten einen sorgfältig formulierten Prompt bereitstellen, damit die KI eine relevante und genaue Antwort generieren kann.",
      "history": {
        "title": null,
        "clearAll": null,
        "noHistory": null,
  ...
  "vector-workspace": {
    ...
    "reset": {
      ...
      "confirm": "Sie sind dabei, die Vektordatenbank dieses Arbeitsbereichs zurückzusetzen. Dies entfernt alle derzeit eingebetteten Vektoreinbettungen.\n\nDie ursprünglichen Quelldateien bleiben unberührt. Diese Aktion ist irreversibel.",
      "error": "Die Arbeitsbereich-Vektordatenbank konnte nicht zurückgesetzt werden!",
      "success": "Die Arbeitsbereich-Vektordatenbank wurde zurückgesetzt!"
    }
  },
  "agent": {
    "performance-warning": "Die Leistung von LLMs, die Werkzeugaufrufe nicht explizit unterstützen, hängt stark von den Fähigkeiten und der Genauigkeit des Modells ab. Einige Fähigkeiten können eingeschränkt oder nicht funktionsfähig sein.",
    "provider": {
      "title": "Arbeitsbereich-Agent LLM-Anbieter",
      "description": "Der spezifische LLM-Anbieter und das Modell, das für den @agent-Agenten dieses Arbeitsbereichs verwendet wird."
    },
    "mode": {
      "chat": {
        "title": "Arbeitsbereich-Agent Chat-Modell",
        "description": "Das spezifische Chat-Modell, das für den @agent-Agenten dieses Arbeitsbereichs verwendet wird."
      },
      "title": "Arbeitsbereich-Agent-Modell",
      "description": "Das spezifische LLM-Modell, das für den @agent-Agenten dieses Arbeitsbereichs verwendet wird.",
      "wait": "-- warte auf Modelle --"
    },
    "skill": {
      "title": "Standard-Agentenfähigkeiten",
      "description": "Verbessern Sie die natürlichen Fähigkeiten des Standard-Agenten mit diesen vorgefertigten Fähigkeiten. Diese Einrichtung gilt für alle Arbeitsbereiche.",
      "rag": {
      ...
      "view": {
        ...
        "description": "Erlauben Sie dem Agenten, den Inhalt der aktuell eingebetteten Arbeitsbereichsdateien aufzulisten und zusammenzufassen."
      },
      "scrape": {
  ...
  "embedding": {
    ...
    "provider": {
      ...
      "description": "Bei Verwendung der nativen Einbettungs-Engine von AnythingLLM ist keine Einrichtung erforderlich."
    }
  },
  "text": {
  ...
  "embeddable": {
    ...
    "description": "Einbettbare Chat-Widgets sind öffentlich zugängliche Chat-Schnittstellen, die an einen einzelnen Arbeitsbereich gebunden sind. Diese ermöglichen es Ihnen, Arbeitsbereiche zu erstellen, die Sie dann weltweit veröffentlichen können.",
  ...
  "main-page": {
    "noWorkspaceError": "Bitte erstellen Sie einen Arbeitsbereich, bevor Sie einen Chat beginnen.",
    "checklist": {
      ...
      "tasks": {
        "create_workspace": {
          ...
          "description": "Erstellen Sie Ihren ersten Arbeitsbereich, um zu beginnen",
          "action": "Erstellen"
        },
        "send_chat": {
        ...
        "embed_document": {
          ...
          "description": "Fügen Sie Ihr erstes Dokument zu Ihrem Arbeitsbereich hinzu",
          "action": "Einbetten"
        },
        "setup_system_prompt": {
    ...
    "exploreMore": {
      ...
      "features": {
        ...
        "systemPrompts": {
          ...
          "description": "Ändern Sie die System-Eingabeaufforderung, um die KI-Antworten eines Arbeitsbereichs anzupassen.",
