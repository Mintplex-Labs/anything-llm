  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        title:
          "Ermöglichen Sie dem Agenten, Nachfragen zu stellen, um Unklarheiten zu beseitigen.",
        "beta-badge": "TESTVERSION",
        description:
          "Wenn aktiviert, können die Agenten eine kurze, klärende Frage stellen, falls Ihre Anfrage unklar ist. Standardmäßig deaktiviert. Nicht für API- oder programmatische Ausführungen von Agenten verfügbar.",
        "max-per-turn": {
          title: "Maximale Anzahl an Fragen pro Zug",
          description:
            "Wie viele Fragen der Agent in einer einzigen Antwort stellen darf. Je weniger Fragen, desto weniger störend.",
        },
        timeout: {
          title: "Timeout-Zeit (Sekunden)",
          description:
            "Wenn der Benutzer innerhalb dieser Zeitspanne nicht reagiert, trifft der Mitarbeiter die Entscheidung auf der Grundlage seines besten Urteils.",
        },
      },
    },
  },
