...
const TRANSLATIONS = {
  ...
  "embed-analytics": {
    ...
    "retention-notice": "ℹ️ DSGVO: Aufbewahrungsfrist {{days}} Tage — Heutige Chats verfallen am {{expiryDate}}",
  },
  "embed-row": {
    code: "Code",
    ...
    enable: "Aktivieren",
    "clear-chats": "Chats löschen",
    "clear-chats-hint": "Alle Chats dieser Einbettung löschen (DSGVO)",
    delete: "Löschen",
    disabled: "Einbettung wurde deaktiviert.",
    enabled: "Einbettung ist aktiv.",
    deleted: "Einbettung wurde aus dem System gelöscht.",
    "chats-cleared": "{{count}} Chat(s) erfolgreich gelöscht.",
    "no-chats": "Keine Chats zum Löschen vorhanden.",
    "all-domains": "alle",
    "confirm-disable":
    ...
    "confirm-clear-chats":
      "Möchten Sie wirklich alle {{count}} Chat(s) dieser Einbettung löschen?\n\nDiese Aktion kann nicht rückgängig gemacht werden.",
  },
  "embed-modal": {
    ...
    "confirm-clear-chats":
      "Möchten Sie wirklich alle {{count}} Chat(s) dieser Einbettung löschen?\n\nDiese Aktion kann nicht rückgängig gemacht werden.",
    "chats-cleared": "{{count}} Chat(s) erfolgreich gelöscht.",
    "clear-error": "Fehler beim Löschen der Chats.",
    "clear-chats-hint": "Manuelle Löschung aller Chats dieser Einbettung.",
    "clear-chats-button": "{{count}} Chat(s) löschen",
    cancel: "Abbrechen",
    ...
    "chat-retention": {
      label: "Chat-Aufbewahrungsfrist (DSGVO)",
      hint: "Automatische Löschung nach Ablauf der Frist. Standard ist unbegrenzte Aufbewahrung.",
      never: "Unbegrenzt",
      days: "Tage",
    },
    "model-override": {
  ...
  "embed-chats": {
    ...
    export: "Exportieren",
    "clear-all": "Alle Chats löschen",
    "clear-all-confirm":
      "Möchten Sie wirklich ALLE Embed-Chats löschen?\n\nDiese Aktion kann nicht rückgängig gemacht werden.",
