...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      "search-document": "Dokumente durchsuchen...",
      "no-documents": "Keine Dokumente gefunden",
      no_docs: "Keine Dokumente im Arbeitsbereich",
      "new-folder": "Neuer Ordner",
      "create-folder": "Ordner erstellen",
      "folder-name": "Ordnername",
      "enter-folder-name": "Ordnernamen eingeben",
      "add-tag": "Tag hinzufügen",
      "enter-tag": "Tagnamen eingeben",
      "move-to-folder": "In Ordner verschieben",
      "select-folder": "Ordner auswählen",
      "document-count": "{{count}} Dokumente",
      "rename-document": "Dokument umbenennen",
      "new-name": "Neuer Name",
      "enter-new-name": "Neuen Namen eingeben",
      "delete-confirmation":
        "Sind Sie sicher, dass Sie diese Dateien und Ordner löschen möchten?\nDies wird die Dateien aus dem System entfernen und sie automatisch aus allen vorhandenen Arbeitsbereichen entfernen.\nDiese Aktion kann nicht rückgängig gemacht werden.",
      "removing-message":
        "{{count}} Dokumente und {{folderCount}} Ordner werden entfernt. Bitte warten.",
      ...
      costs: "*Einmalige Kosten für Einbettungen",
