...
const TRANSLATIONS = {
  ...
  "appearance": {
    ...
    "logo": {
      "title": "Logo anpassen",
      "description": "Laden Sie Ihr eigenes Logo hoch, um Ihren Chatbot zu personalisieren.",
    ...
    "message": {
      ...
      "description": "Passen Sie die automatischen Nachrichten an, die Ihren Benutzern angezeigt werden.",
      "new": "Neu",
      "system": "System",
      "user": "Benutzer",
      "message": "Nachricht",
    ...
    "icons": {
      ...
      "description": "Passen Sie die Fußzeilen-Icons an, die am unteren Rand der Seitenleiste angezeigt werden.",
      "icon": "Icon",
      "link": "Link"
    }
  },
