...
const TRANSLATIONS = {
  ...
  "main-page": {
    ...
    "exploreMore": {
      ...
      "features": {
        ...
        "slashCommands": {
          "title": "Slash-Befehle",
          "description": "Sparen Sie Zeit und fügen Sie Eingabeaufforderungen mit benutzerdefinierten Slash-Befehlen ein.",
          "primaryAction": "Einen Slash-Befehl erstellen",
          "secondaryAction": "Im Hub erkunden"
        },
        "systemPrompts": {
          "title": "System-Prompts",
          "description": "Ändern Sie die System-Eingabeaufforderung, um die KI-Antworten eines Workspaces anzupassen.",
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        ...
        "description": "wird Antworten basierend auf dem allgemeinen Wissen des LLM und dem relevanten Kontext aus den Dokumenten <b> und </b> liefern. <br /> Sie benötigen den Befehl `@agent`, um die Tools zu nutzen."
      },
      "query": {
        "title": "Abfrage",
        ...
        "description": "wird nur Antworten <b> und </b> bereitstellen, falls der Kontext des Dokuments gefunden wurde.<br />Sie müssen den Befehl \"@agent\" verwenden, um die Tools zu nutzen."
      },
      "automatic": {
        "title": "Auto",
  ...
  "agent": {
    ...
    "skill": {
      ...
      "description": "Verbessern Sie die natürlichen Fähigkeiten des Standard-Agenten mit diesen vorgefertigten Fähigkeiten. Diese Einrichtung gilt für alle Workspaces.",
      "rag": {
      ...
      "save": {
        ...
        "description": "Aktivieren Sie den Standard-Agenten, um Dateien zu generieren und zu schreiben, die gespeichert und in Ihrem Browser heruntergeladen werden können."
      },
      "web": {
        "title": "Live-Websuche und -Browsing",
        "desc-start": "Ermöglichen Sie Ihrem Agenten, das Web zu durchsuchen, um Ihre Fragen zu beantworten, indem Sie eine Verbindung zu einem Websuche-Anbieter (SERP) herstellen.",
        "desc-end": "Die Websuche während Agentensitzungen funktioniert erst, wenn dies eingerichtet ist."
      }
    },
  ...
  "customization": {
    ...
    "items": {
      ...
      "welcome-messages": {
        ...
        "description": "Individualisieren Sie die angezeigten Willkommensmitteilungen für Ihre Benutzer. Diese Mitteilungen sehen nur Nicht-Administratoren.",
        "new": "Neue Nachricht",
        "system": "System",
        "user": "Benutzer",
        "message": "Nachricht",
  ...
  "community_hub": {
    "publish": {
      ...
      "slash_command": {
        ...
        "command_description": "Dies ist der Slash-Befehl, den Benutzer eingeben, um diese Voreinstellung auszulösen.",
