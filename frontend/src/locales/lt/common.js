  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        title: "Leisk agentui klausti, kad išaiškytų nesusipratimai",
        "beta-badge": "BETA",
        description:
          "Įjungus, agentai gali sustoti ir užduoti trumpas, aiškinamus klausimus, jei jūsų užduotis yra neaiškus. Pirmiausiai išjungta. Nelaidoma API arba programiniu būdu veikiančiams agentams.",
        "max-per-turn": {
          title: "Didžiausias klausimų skaičius viename raunde",
          description:
            "Kiek klausimų agentas gali užduoti vienoje atsakymo dalyje. Kuo mažiau, tuo mažiau trukdoma.",
        },
        timeout: {
          title: "Atsakymo laikas (sekundės)",
          description:
            "Jei vartotojas neatsakys per šį laiką, agentas tęs darbą remdamasis savo pačių išvados.",
        },
      },
    },
  },
