...
const TRANSLATIONS = {
  ...
  chat_window: {
    ...
    memories: {
      title: "Воспоминания",
      empty:
        "На данный момент нет никаких воспоминаний. После взаимодействия с чат-ботом, воспоминания начну заполняться или <cta>создавать новые воспоминания</cta>.",
      tab_workspace: "Рабочее пространство",
      tab_global: "Глобальный",
      toggle: {
        label: "Включите персонализацию",
        description:
          "При включении, AnythingLLM будет изучать предпочтения и контекст пользователя на основе диалогов.",
      },
      menu: {
        edit: "Редактировать",
        delete: "Удалить",
      ...
      modal: {
        ...
        create_description:
          "Эта информация будет сохранена и использована для персонализации будущих ответов.",
