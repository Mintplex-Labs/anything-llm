...
const TRANSLATIONS = {
  ...
  "model-router": {
    ...
    description:
      "Модели маршрутизаторов позволяют определять правила для автоматического перенаправления сообщений чата к различным провайдерам и моделям больших языковых моделей в зависимости от определенных условий.",
    ...
    "no-routers":
      "На данный момент не создано никаких моделей маршрутизаторов.",
    "delete-confirm":
    ...
    "new-router": {
      ...
      "fallback-label": "Альтернативный поставщик и модель",
      "fallback-description":
        "Используется в случаях, когда не выполняется ни одно из правил маршрутизации.",
      "cooldown-label": "Время охлаждения кэша (секунды)",
      "cooldown-help":
        "Как долго принимается решение о маршрутизации, прежде чем правила будут переоценены. Установите значение 0 для отключения кэширования.",
      "name-required": "Необходимо указать имя.",
      "fallback-required": "Необходим резервный поставщик и модель.",
      cancel: "Отменить",
      creating: "Создание...",
      create: "Создать маршрутизатор",
      "toast-created": "Маршрутизатор успешно создан.",
    },
    "edit-router": {
      "back-to-routers": "Вернуться к моделям маршрутизаторов",
      title: "Редактировать маршрутизатор: {{name}}",
      description:
        "Обновите настройки роутера и укажите альтернативного провайдера/модель.",
      name: "Имя",
      "description-label": "Описание",
      "description-placeholder": "Необязательное описание",
      "fallback-label": "Альтернативный поставщик и модель",
      "fallback-description":
        "Используется в случаях, когда не найдено ни одного правила маршрутизации.",
      "cooldown-label": "Время перезагрузки кэша (секунды)",
      "cooldown-help":
        "Как долго принимается решение о маршрутизации, прежде чем правила будут переоценены. Установите значение 0 для отключения кэширования.",
      saving: "Сохранение...",
      save: "Сохранить изменения",
      "toast-updated": "Маршрутизатор успешно обновлен.",
      "toast-update-failed": "Не удалось обновить настройки роутера.",
    },
    rules: {
      title: "Правила маршрутизации",
      description:
        "Правила оцениваются по приоритету, начиная с верхнего. Перетащите элементы, чтобы изменить порядок. Победителем становится первый элемент, соответствующий правилу.",
      "add-rule": "Добавить правило",
      "delete-confirm": 'Удалить правило "{{title}}"?',
      "toast-deleted": "Правило удалено",
      "toast-delete-failed": "Не удалось удалить правило.",
      "toast-reorder-failed": "Не удалось восстановить исходные правила.",
      "no-rules":
        "Пока нет никаких правил. Добавьте правило для начала маршрутизации.",
      "title-with-name": "Правила маршрутизации: {{name}}",
      "empty-description":
        "Добавьте правило, чтобы маршрутизировать сообщения чата к определенным провайдерам и моделям.",
      "new-rule-button": "Новое правило",
    },
    "rule-form": {
      "edit-title": "Изменить правило",
      "new-title": "Новое правило",
      "title-label": "Заголовок",
      "title-help":
        "Строчные буквы, только подчеркивания. Автоматически форматируется при сохранении.",
      "rule-type": "Тип правила",
      "property-label": "Недвижимость",
      "property-select": "Выбрать",
      "comparator-label": "Сравниватель",
      "value-label": "Ценность",
      ...
      "match-description-help":
        "Опишите, при каких условиях этот критерий должен быть выполнен. Модель резервного копирования маршрутизатора будет анализировать сообщение пользователя и определять, соответствует ли оно этому описанию.",
      "route-to-label": "Маршрут к поставщику и модель",
      "route-to-description":
        "Если это правило соответствует, используйте этого поставщика/модель.",
      cancel: "Отменить",
      saving: "Сохранение...",
      "update-rule": "Правило обновления",
      "create-rule": "Создать правило",
      "title-required": "Обязательно укажите название.",
      "toast-updated": "Правило обновлено",
      "toast-created": "Правило установлено",
      "toast-save-failed": "Не удалось сохранить правило",
      "comparator-select": "Выбрать",
      "logic-label": "Сопоставление",
      "logic-and": "Все перечисленное (и)",
      "logic-or": "Любой из следующих пунктов (ИЛИ)",
    ...
    "provider-picker": {
      ...
      "toast-configured": "Предоставитель успешно настроен.",
    },
    "router-selection": {
      "loading-routers": "Загрузка маршрутизаторов...",
      "no-routers-prefix-settings":
        "В настоящее время ни один из роутеров не был настроен.",
      "no-routers-prefix-workspace":
        "Не настроены никакие модели маршрутизаторов.",
      "no-routers-link": "Создайте его в настройках роутера.",
      "model-router-label": "Примерный маршрутизатор",
      "select-router": "Выберите маршрутизатор",
      "select-description":
        "Выберите, какой маршрутизатор использовать для этой рабочей зоны.",
      "no-routers-chat":
        "Не настроены маршрутизаторы. Создайте один в разделе «Настройки» > «Провайдеры ИИ» > «Маршрутизатор модели».",
      "rule-count": "({{count}} правила)",
    },
    metrics: {
      "model-router-default": "Примерный маршрутизатор",
    },
    chat: {
    ...
    "empty-description":
      "В настоящее время ни один маршрутизатор не настроен. Создайте один, чтобы начать работу.",
    "new-router-button": "Новый маршрутизатор",
  },
};
