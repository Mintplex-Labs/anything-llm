...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      "search-document": "Поиск документов...",
      "no-documents": "Документы не найдены",
      no_docs: "Нет документов в рабочем пространстве",
      "new-folder": "Новая папка",
      "create-folder": "Создать папку",
      "folder-name": "Имя папки",
      "enter-folder-name": "Введите имя папки",
      "add-tag": "Добавить тег",
      "enter-tag": "Введите имя тега",
      "move-to-folder": "Переместить в папку",
      "select-folder": "Выбрать папку",
      "document-count": "{{count}} документов",
      "rename-document": "Переименовать документ",
      "new-name": "Новое имя",
      "enter-new-name": "Введите новое имя",
      "delete-confirmation":
        "Вы уверены, что хотите удалить эти файлы и папки?\nЭто удалит файлы из системы и автоматически удалит их из всех существующих рабочих пространств.\nЭто действие нельзя отменить.",
      "removing-message":
        "Удаление {{count}} документов и {{folderCount}} папок. Пожалуйста, подождите.",
      "move-success": "{{count}} документов успешно перемещено.",
      date: "Дата",
      type: "Тип",
      select_all: "Выбрать все",
      deselect_all: "Отменить выбор",
      remove_selected: "Удалить выбранное",
      costs: "*Единоразовая стоимость для встраивания",
      save_embed: "Сохранить и встроить",
    },
    upload: {
