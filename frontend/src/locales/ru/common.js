  ...
  customization: {
    ...
    items: {
      ...
      "preferred-currency": {
        ...
        description:
          "Валюта, используемая для отображения стоимости использования больших языковых моделей (LLM). Стоимость всегда указывается в долларах США и конвертируется только для отображения.",
      },
    },
  },
  "main-page": {
