...
const TRANSLATIONS = {
  ...
  imageGeneration: {
    ...
    description:
      "Настройте провайдера, который используется для генерации изображений, при использовании команды `/img`. По умолчанию изображения генерируются в разрешении 1024x1024.",
