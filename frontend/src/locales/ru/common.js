...
const TRANSLATIONS = {
  ...
  telegram: {
    ...
    setup: {
      ...
      "toast-select-workspace": "Пожалуйста, выберите рабочее место.",
