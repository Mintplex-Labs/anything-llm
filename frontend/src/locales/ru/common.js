...
const TRANSLATIONS = {
  ...
  customization: {
    ...
    items: {
      ...
      "display-currency": {
        title: "Валюта для отображения",
        description:
          "Валюта используется для отображения стоимости использования больших языковых моделей в данном экземпляре. Все расходы фиксируются в долларах США и конвертируются по текущему курсу только для отображения.",
      },
    },
  },
  "main-page": {
