...
const TRANSLATIONS = {
  ...
  settings: {
    ...
    personalization: "Индивидуализация",
  },
  login: {
    "multi-user": {
  ...
  personalization: {
    ...
    description:
      "AnythingLLM со временем может узнать о вас больше, чтобы предоставлять более релевантные и персонализированные ответы. Воспоминания автоматически извлекаются из ваших разговоров.",
    toggle: {
      label: "Включить персонализацию",
      description:
        "При включении, AnythingLLM будет изучать предпочтения и контекст пользователя, основываясь на его взаимодействии.",
    },
    actions: {
      "run-extraction": "Запустить извлечение данных сейчас",
      extracting: "Извлечение...",
      "clear-all": "Удалить все мои воспоминания",
      clearing: "Очистка...",
    },
    global: {
      title: "Глобальные воспоминания ({{count}}, {{max}})",
      "add-button": "Добавьте глобальную память",
      description:
        "Эти воспоминания применяются во всех рабочих пространствах.",
      "applied-description": "Применяется во всех рабочих зонах.",
      placeholder: "Введите глобальную переменную (например, 'Мое имя – Сэйн')",
      "empty-title": "На данный момент нет глобальной памяти.",
      "empty-description":
        "Добавьте их вручную или распространите воспоминания о рабочем пространстве на глобальный уровень.",
    },
    workspace: {
      title: "Воспоминания о рабочем месте ({{count}}, {{max}})",
      "list-title": "Воспоминания о рабочем месте",
      "list-description":
        "Управляйте данными, специфичными для каждого рабочего места, из настроек соответствующего рабочего места.",
      "add-button": "Добавить память",
      description:
        "Специфические воспоминания, связанные с этим рабочим местом. Они автоматически извлекаются из разговоров и используются для персонализации ответов.",
      "no-workspaces": "Не найдено рабочих мест.",
      "empty-title": "Пока нет никаких воспоминаний.",
      "empty-description":
        "Воспоминания будут автоматически извлекаться из ваших разговоров, или вы можете добавить их вручную.",
    },
    form: {
      placeholder:
        "Введите предпочтение (например, «Я предпочитаю краткие ответы»)",
      save: "Сохранить",
      add: "Добавить",
      cancel: "Отменить",
      hint: "Каждый факт или предпочтение должен быть представлен в виде одной, краткой фразы.",
    },
    item: {
      edit: "Редактировать",
      "promote-to-global": "Распространить на международном уровне",
      delete: "Удалить",
    },
    scope: {
      workspace: "Рабочее пространство",
    ...
    loading: "Загрузка данных для персонализации...",
    toast: {
      "setting-update-failed": "Не удалось обновить настройку: {{error}}",
      enabled: "Функция персонализации включена.",
      disabled: "Функция персонализации отключена.",
      "extraction-failed": "Не удалось извлечь: {{error}}",
      "extraction-completed": "Извлечение данных завершено.",
      "clear-confirm":
        "Вы уверены? Это приведет к необратимой потере всех ваших настроек.",
      "clear-failed": "Не удалось очистить память: {{error}}",
      "clear-success":
        "Все сохраненные настройки и личные данные были удалены.",
      "delete-confirm": "Удалить эту запись?",
      "delete-failed": "Не удалось удалить данные из памяти.",
      "delete-success": "Данные удалены.",
      "update-failed": "Не удалось обновить память.",
      "update-success": "Память обновлена.",
      "add-failed": "Не удалось добавить память.",
      "add-global-success": "Добавлена глобальная память.",
      "add-success": "Память добавлена.",
      "promote-failed": "Не способствовал развитию памяти.",
      "promote-success": '"Memory получил повышение до глобального уровня."',
    },
  },
};
