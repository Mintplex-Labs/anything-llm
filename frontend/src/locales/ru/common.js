  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        ...
        "beta-badge": "Бета-версия",
        description:
          "При включении, агенты могут приостановить работу, чтобы задать короткие уточняющие вопросы, если ваш запрос неоднозначен. Выключено по умолчанию. Недоступно для работы агентов через API или программные интерфейсы.",
        "max-per-turn": {
          title: "Максимальное количество вопросов в каждом раунде",
          description:
            "Сколько вопросов для уточнения может задать агент в одном ответе. Чем меньше вопросов, тем меньше это будет отвлекать.",
        },
        timeout: {
          title: "Время ожидания ответа (секунды)",
          description:
            "Если пользователь не ответит в течение этого времени, агент принимает решение на основе своих лучших знаний и опыта.",
        },
      },
    },
  },
