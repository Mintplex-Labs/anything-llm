const TRANSLATIONS = {
  ...
  welcomeMessage: {
    ...
    user2:
      "האם זה כמו Dropbox AI או משהו כזה? מה לגבי צ'אט? זה צ'אטבוט לא?",
    part5:
  ...
  chat: {
    ...
    history: {
      ...
      "desc-start":
        "מספר הצ'אטים הקודמים שייכללו בזכרון קצר הטווח של התגובה.",
      recommend: "מומלץ: 20. ",
      "desc-end":
  ...
  agent: {
    ...
    skill: {
      ...
      scrape: {
        ...
        description:
          "אפשר לסוכן לבקר ולגרד את תוכן אתרי האינטרנט.",
      },
      generate: {
        title: "צור תרשימים",
        description:
      ...
      web: {
        ...
        "desc-end":
          "חיפוש באינטרנט במהלך מפגשי סוכן לא יעבוד עד שתגדיר זאת.",
      },
    },
  },
  ...
  appearance: {
    ...
    icons: {
      ...
      description:
        "התאם אישית את סמלי כותרת התחתונה המוצגים בתחתית סרגל הצד.",
      icon: "סמל",
      link: "קישור",
    },
  },
  ...
  transcription: {
    title: "העדפת דגם העתקה",
    description:
      "אלה אישורי ההרשאה וההגדרות עבור ספק דגם העתקה המועדף עליך. חשוב שאישורי ההרשאה יהיו עדכניים ונכונים אחרת קבצי מדיה ואודיו לא יעברו העתקה.",
    provider: "ספק העתקה",
    "warn-start":
    ...
    "warn-end":
      "הדגם המובנה יתורגם אוטומטית בפעם הראשונה שבה תשתמש בו.",
  },
  ...
  text: {
    ...
    size: {
      title: "גודל קטע טקסט",
      description:
        "זהו אורך הדמויות המרבי שיכול להיות נוכח בקטור יחיד.",
  ...
  "embed-chats": {
    title: "הטמעת שיחות",
    description:
      "אלה כל השיחות וההודעות שנרשמו מכל הטמעה שפרסמת.",
    table: {
      embed: "הטמעה",
      sender: "שולח",
      message: "הודעה",
  ...
  event: {
    title: "יומני אירועים",
    description:
      "הצג את כל הפעולות והאירועים שקורים במופע זה לצורך ניטור.",
