...
const TRANSLATIONS = {
  ...
  api: {
    ...
    modal: {
      ...
      helper:
        "پس از ایجاد، می‌توان از این کلید API برای دسترسی و پیکربندی برنامه‌نویسی‌شده این نمونه AnythingLLM استفاده کرد.",
      name: {
        label: "نام",
  ...
  "model-router": {
    title: "روترهای مدل",
    description:
      "روترهای مدل به شما این امکان را می‌دهند که قوانین را برای مسیریابی خودکار پیام‌های چت به ارائه دهندگان و مدل‌های مختلف LLM، بر اساس شرایط، تعریف کنید.",
    "create-router": "ایجاد روتر",
    table: {
      name: "نام",
    ...
    "no-routers": "هنوز هیچ مدل روتر ایجاد نشده است.",
    "delete-confirm":
      'آیا مطمئن هستید که می‌خواهید روتر "{{name}}" را حذف کنید؟\nاین کار تمام تنظیمات و ارتباطات آن را از بین خواهد برد و هر فضای کاری که از آن استفاده می‌کند را از آن جدا خواهد کرد.\n\nاین اقدام غیرقابل برگشت است.',
    "toast-deleted": "دستگاه روتر حذف شد",
    "toast-delete-failed": "عدم موفقیت در حذف روتر: {{error}}",
    "new-router": {
      title: "ایجاد یک روتر جدید",
      name: "نام",
      "name-placeholder": "به عنوان مثال: ابزار بهینه‌سازی هزینه",
      description: "توضیحات",
      "description-placeholder": "توضیح اختیاری",
      "fallback-label": "ارائه دهنده جایگزین و مدل پیش‌بینی",
      "fallback-description":
        "این مورد زمانی استفاده می‌شود که هیچ قانون مسیریابی با شرایط موجود مطابقت نداشته باشد.",
      "cooldown-label": "مدت زمان خنثی‌سازی (ثانیه)",
      "cooldown-help":
        "مدت زمانی که تصمیم مربوط به مسیریابی پس از بررسی مجدد قوانین، ذخیره می‌شود. برای غیرفعال کردن ذخیره‌سازی، مقدار آن را روی 0 تنظیم کنید.",
      "name-required": "نام الزامی است.",
      "fallback-required": "نیاز به یک تامین‌کننده و مدل جایگزین وجود دارد.",
      cancel: "لغو کردن",
      creating: "ایجاد...",
      create: "ایجاد روتر",
      "toast-created": "روتر با موفقیت ایجاد شد.",
    },
    "edit-router": {
      "back-to-routers": "بازگشت به روترهای مدل",
      title: "ویرایش روتر: {{name}}",
      description:
        "تنظیمات روتر را به‌روزرسانی کنید و از یک ارائه‌دهنده/مدل جایگز استفاده کنید.",
      name: "نام",
      "description-label": "توضیحات",
      "description-placeholder": "توضیحات اختیاری",
      "fallback-label": "ارائه دهنده و مدل جایگزین",
      "fallback-description":
        "این مورد زمانی استفاده می‌شود که هیچ قانون مسیریابی با شرایط موجود مطابقت نداشته باشد.",
      "cooldown-label": "مدت زمان تاخورد (ثانیه)",
      "cooldown-help":
        "مدت زمانی که تصمیم مربوط به مسیریابی، قبل از بررسی مجدد قوانین، ذخیره می‌شود. برای غیرفعال کردن ذخیره‌سازی، این مقدار را روی 0 تنظیم کنید.",
      saving: "ذخیره...",
      save: "ذخیره تغییرات",
      "toast-updated": "دستگاه روتر با موفقیت به‌روز شد.",
      "toast-update-failed": "عدم به‌روزرسانی روتر",
    },
    rules: {
      title: "قوانین مسیریابی",
      description:
        "قوانین بر اساس اولویت از بالا به پایین ارزیابی می‌شوند. برای تغییر ترتیب، موارد را بکشید و رها کنید. اولین قانون برنده می‌شود.",
      "add-rule": "اضافه کردن قانون",
      "delete-confirm": 'حذف قانون "{{title}}"؟',
      "toast-deleted": "قانون حذف شد",
    ...
    "rule-form": {
      ...
      "new-title": "قانون جدید",
      "title-label": "عنوان",
      "title-help":
        "فقط با حروف کوچک و استفاده از خط تیره. فرمت خودکار پس از ذخیره.",
      "rule-type": "نوع قانون",
      "property-label": "امکانات",
      "property-select": "انتخاب",
      "comparator-label": "مقایسه کننده",
      "value-label": "ارزش",
      "match-description-label": "شرح مسابقه",
      "match-description-placeholder":
        "به عنوان مثال، کاربر در مورد موضوعات حقوقی، قراردادها یا رعایت مقررات سوال می‌کند.",
      "match-description-help":
        "این قانون در چه شرایطی باید اعمال شود را توضیح دهید. مدل پشتیبان روتر، پیام کاربر را می‌خواند و تصمیم می‌گیرد که آیا این پیام با این توصیف مطابقت دارد یا خیر.",
      "route-to-label": "مسیر به سمت ارائه خدمات و مدل",
      "route-to-description":
        "هنگامی که این قانون برقرار باشد، از این ارائه دهنده/مدل استفاده کنید.",
      cancel: "لغو کردن",
      saving: "ذخیره...",
    ...
    "provider-picker": {
      ...
      "setup-required": "(نیاز به تنظیم دارد)",
      "loading-models": "بارگذاری مدل‌ها...",
      "select-model": "مدل مورد نظر را انتخاب کنید",
      ...
      "setup-credentials":
        "برای استفاده از {{name}} به عنوان هدف مسیریابی، اطلاعات مورد نیاز را وارد کنید.",
      cancel: "لغو کردن",
      "save-settings": "ذخیره تنظیمات",
      "toast-save-failed": "عدم موفقیت در ذخیره تنظیمات: {{error}}",
      "toast-configured": "پроваینده با موفقیت تنظیم شد.",
    },
    "router-selection": {
      "loading-routers": "بارگذاری روترها...",
      "no-routers-prefix-settings": "هنوز هیچ روتر مدل‌دار تنظیم نشده است.",
      "no-routers-prefix-workspace": "هیچ روتر مدل خاصی تنظیم نشده است.",
      "no-routers-link": "یک نمونه را در تنظیمات روتر ایجاد کنید.",
      "model-router-label": "روتر نمونه",
      "select-router": "یک روتر را انتخاب کنید.",
      "select-description":
        "انتخاب کنید که از کدام روتر برای این محیط کاری استفاده کنید.",
      "no-routers-chat":
        "هیچ روتر موجود نیست. یک روتر را در قسمت تنظیمات > ارائه‌دهندگان هوش مصنوعی > روتر مدل ایجاد کنید.",
