  ...
  customization: {
    ...
    items: {
      ...
      "preferred-currency": {
        title: "ارز ترجیحی",
        description:
          "واحد پول برای نمایش هزینه‌های استفاده از مدل‌های زبانی (LLM) استفاده می‌شود. این هزینه‌ها همیشه به دلار آمریکا ثبت می‌شوند و فقط برای نمایش تبدیل می‌شوند.",
      },
    },
  },
  "main-page": {
