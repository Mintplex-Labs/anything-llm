  ...
  customization: {
    ...
    items: {
      ...
      "display-currency": {
        title: "واحد نمایش",
        description:
          "واحد پول برای نمایش هزینه‌های استفاده از مدل‌های زبان بزرگ در این نمونه، استفاده می‌شود. هزینه‌ها همیشه به دلار ثبت می‌شوند و فقط برای نمایش، با نرخ‌های فعلی تبدیل می‌شوند.",
      },
    },
  },
  "main-page": {
