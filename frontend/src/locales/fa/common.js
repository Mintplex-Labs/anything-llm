  ...
  chat: {
    ...
    mode: {
      ...
      chat: {
        title: "گفتگو",
        description:
          "با استفاده از دانش عمومی مدل زبان بزرگ و همچنین اطلاعات موجود در مستند، پاسخ‌ها را ارائه می‌دهد. برای استفاده از ابزارها، باید از دستور @agent استفاده کنید.",
      },
      query: {
        title: "پرس‌وجو",
        description:
          'پاسخ‌ها را تنها در صورتی ارائه می‌دهد که زمینه سند مشخص باشد.\nبرای استفاده از ابزارها، باید از دستور "@agent" استفاده کنید.',
      },
      automatic: {
        title: "خودرو",
        description:
