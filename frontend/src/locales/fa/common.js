...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "AnyLLM می‌تواند با بسیاری از ارائه‌دهندگان مدل‌های زبانی کار کند. این سرویس، مسئولیت انجام مکالمات را بر عهده خواهد داشت.",
    },
    userSetup: {
  ...
  customization: {
    ...
    branding: {
      ...
      description:
        "با استفاده از برندسازی سفارشی، نمونه‌ی AnyLLM خود را با برچسب سفید (White-label) ارائه دهید.",
    },
    chat: {
      title: "چت",
