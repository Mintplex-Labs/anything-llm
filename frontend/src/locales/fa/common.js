...
const TRANSLATIONS = {
  onboarding: {
    survey: {
      ...
      useCase: "شما از ObaradaiLLM برای چه منظوری استفاده خواهید کرد؟",
      useCaseWork: "برای کار",
      useCasePersonal: "برای استفاده شخصی",
      useCaseOther: "سایر",
      comment: "شما از کجا در مورد ObaradaiLLM مطلع شدید؟",
      commentPlaceholder:
        "Reddit، توییتر، گیت‌هاب، یوتیوب و غیره - لطفاً به ما بگویید که چگونه ما را پیدا کردید!",
      skip: "پرش از نظرسنجی",
      thankYou: "از بازخورد شما سپاسگزاریم.",
      title: "به ObaradaiLLM خوش آمدید",
      description:
        "ما را در ساخت مدل ObaradaiLLM متناسب با نیازهای شما یاری دهید. (این بخش اختیاری است)",
    },
    home: {
    ...
    llm: {
      ...
      description:
        "ObaradaiLLM می‌تواند با بسیاری از ارائه‌دهندگان مدل‌های زبانی کار کند. این سرویس، مسئولیت انجام مکالمات را بر عهده خواهد داشت.",
    },
    userSetup: {
  ...
  chat: {
    ...
    mode: {
      ...
      chat: {
        title: "گفتگو",
        description:
          "با استفاده از دانش عمومی LLM و اطلاعات موجود در سند، پاسخ‌ها را ارائه می‌دهد. <b> و </b> برای استفاده از ابزارها، باید از دستور @agent استفاده کنید.",
      },
      query: {
        title: "پرس‌وجو",
        description:
          "پاسخ‌ها <b>فقط در صورت یافتن زمینه سند</b> ارائه خواهند شد.<br />برای استفاده از ابزارها، باید از دستور @agent استفاده کنید.",
      },
      automatic: {
        description:
  ...
  agent: {
    ...
    skill: {
      ...
      filesystem: {
        ...
        description:
          "به نماینده خود اجازه دهید تا فایل‌ها را در یک پوشه مشخص، خوانده، نوشته، جستجو و مدیریت کند. این قابلیت شامل ویرایش فایل‌ها، پیمایش در پوشه‌ها و جستجوی محتوا است.",
        learnMore: "در مورد نحوه استفاده از این مهارت بیشتر بدانید.",
        configuration: "تنظیمات",
        readActions: "خواندن اقدامات",
        writeActions: "اقدامات",
        warning:
          "دسترسی به سیستم فایل می‌تواند خطرناک باشد، زیرا می‌تواند فایل‌ها را تغییر دهد یا حذف کند. لطفاً قبل از فعال‌سازی، مستندات مربوطه را مطالعه کنید.",
        skills: {
          "read-text-file": {
            title: "خواندن فایل",
      ...
      gmail: {
        ...
        description:
          "به اپراتور خود اجازه دهید تا با Gmail تعامل داشته باشد: جستجو در ایمیل‌ها، خواندن موضوعات، نوشتن پیش‌نویس‌ها، ارسال ایمیل‌ها و مدیریت صندوق ورودی. برای اطلاعات بیشتر، مستندات را مطالعه کنید.",
        multiUserWarning:
          "ادغام با جی‌میل در حالت چند کاربر به دلیل مسائل امنیتی، امکان‌پذیر نیست. لطفاً حالت چند کاربر را غیرفعال کنید تا از این ویژگی استفاده کنید.",
        configuration: "تنظیمات جی‌میل",
        deploymentId: "شناسه استقرار",
        deploymentIdHelp: "شناسه (ID) مربوط به اجرای اسکریپت وب در Google Apps",
        apiKey: "کلید API",
        apiKeyHelp:
          "کلید API که در فرایند استقرار اسکریپت‌های Google Apps خود تنظیم کرده‌اید.",
        configurationRequired:
          "لطفاً شناسه استقرار و کلید API را تنظیم کنید تا قابلیت‌های Gmail فعال شوند.",
        ...
        categories: {
          ...
          threads: {
            ...
            description:
              "مدیریت تر وهای ایمیل - علامت‌گذاری به عنوان خوانده/خوانده نشده، آرشیو، حذف",
          },
          account: {
            title: "آمار ادغام",
        ...
        skills: {
          ...
          markUnread: {
            ...
            description:
              'یک موضوع را به عنوان "غیرخوانده شده" علامت‌گذاری کنید.',
          },
          moveToTrash: {
          ...
          getMailboxStats: {
            ...
            description:
              "تعداد ایمیل‌های دریافتی و آمار صندوق ایمیل را دریافت کنید.",
          },
          getInbox: {
            title: "دسترسی به صندوق ورودی",
            description:
              "یک راه ساده برای دریافت ایمیل‌های صندوق ورودی از جی‌میل",
          },
        },
      },
      outlook: {
      ...
      scheduledJob: {
        title: "ایجاد وظایف برنامه‌ریزی شده",
        description:
          "به اپراتور اجازه دهید تا وظایف تکراری را از طریق چت ایجاد کند (مثلاً: «هر روز کاری در ساعت ۹ صبح، ایمیل‌های من را خلاصه کرده و به من ارسال کنید»). این قابلیت فقط در حالت یک کاربر موجود است.",
      },
    },
    mcp: {
      title: "سرورهای MCP",
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "امکان استفاده از ابزارهای نامحدود و کاهش مصرف توکن تا 80 درصد برای هر پرس و جو را فراهم کنید - ObaradaiLLM به طور خودکار بهترین مهارت‌ها را برای هر پرس و جو انتخاب می‌کند.",
        "max-tools": {
          title: "ابزارهای مکس",
          description:
  ...
  api: {
    title: "کلیدهای API",
    description:
      "کلیدهای API به دارنده آن‌ها اجازه می‌دهند به صورت برنامه‌نویسی به این نمونه ObaradaiLLM دسترسی داشته و آن را مدیریت کنند.",
    ...
    modal: {
      ...
      helper:
        "پس از ایجاد، می‌توان از این کلید API برای دسترسی و پیکربندی برنامه‌نویسی‌شده این نمونه ObaradaiLLM استفاده کرد.",
      name: {
        label: "نام",
        placeholder: "یکپارچه‌سازی تولید",
        helper:
          "اختیاری است. از یک نام قابل‌فهم استفاده کنید تا بعداً بتوانید این کلید را تشخیص دهید.",
      },
    },
    row: {
      copy: "کپی کلید API",
      ...
      unnamed: "--",
      deleteConfirm:
        "آیا مطمئن هستید که می‌خواهید این کلید API را غیرفعال کنید؟\nپس از این کار، دیگر قابل استفاده نخواهد بود.\n\nاین عمل غیرقابل بازگشت است.",
    },
    table: {
      name: "نام",
      key: "کلید API",
  ...
  llm: {
    ...
    description:
      "این‌ها اعتبارنامه‌ها و تنظیمات ارائه‌دهنده مدل زبانی و جاسازی انتخابی شما هستند. مهم است که این کلیدها به‌روز و صحیح باشند در غیر این صورت ObaradaiLLM به درستی کار نخواهد کرد.",
  ...
  transcription: {
    ...
    "warn-start":
      "استفاده از مدل محلی Whisper روی دستگاه‌هایی با RAM یا CPU محدود می‌تواند هنگام پردازش فایل‌های رسانه‌ای باعث توقف ObaradaiLLM شود.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "جاسازی فرآیند تبدیل متن به بردارها است. این اعتبارنامه‌ها برای تبدیل فایل‌ها و درخواست‌های شما به فرمتی که ObaradaiLLM بتواند پردازش کند، ضروری هستند.",
    provider: {
  ...
  vector: {
    ...
    description:
      "این‌ها اعتبارنامه‌ها و تنظیمات نحوه عملکرد نمونه ObaradaiLLM شما هستند. مهم است که این کلیدها به‌روز و صحیح باشند.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "این پیکربندی شما برای نحوه مدیریت داده‌ها توسط ارائه‌دهندگان شخص ثالث متصل و ObaradaiLLM است.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "این فایل‌ها در پردازشگر اسناد که روی این نمونه از ObaradaiLLM در حال اجرا است، بارگذاری خواهند شد. این فایل‌ها به هیچ شخص ثالثی ارسال یا به اشتراک گذاشته نمی‌شوند.",
    },
    pinning: {
      what_pinning: "مخزن کردن اسناد چیست؟",
      pin_explained_block1:
        'هنگامی که شما یک سند را در ObaradaiLLM "فیکس" می‌کنید، محتوای کامل سند را در پنجره دستورالعمل برای مدل زبان بزرگ شما قرار می‌دهیم تا مدل بتواند به طور کامل آن را درک کند.',
      ...
      pin_explained_block3:
        "اگر به پاسخ‌های مورد نظر خود از ObaradaiLLM به طور پیش‌فرض دریافت نمی‌کنید، «پین کردن» یک راه عالی برای دریافت پاسخ‌های با کیفیت بالاتر در یک مرحله است.",
      accept: "باشه، متوجه شدم.",
    },
    watching: {
      what_watching: "تماشای یک مستند چه تاثیری دارد؟",
      watch_explained_block1:
        "هنگام مشاهده یک سند در ObaradaiLLM، محتوای سند به طور خودکار از منبع اصلی آن، در فواصل زمانی منظم، همگام‌سازی می‌شود. این کار، به‌طور خودکار محتوا را در هر فضای کاری که این فایل در آن مدیریت می‌شود، به‌روز می‌کند.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "حافظه",
        placeholder:
          'به عنوان مثال، نام کاربر "جو" است، کاربر در "ObaradaiLLM" کار می‌کند و غیره.',
        create: "ایجاد",
        save: "ذخیره",
        cancel: "لغو کردن",
      },
  ...
  customization: {
    interface: {
      ...
      description: "تنظیمات رابط کاربری خود را برای ObaradaiLLM تعیین کنید.",
    },
    branding: {
      title: "برندسازی و ارائه خدمات با برچسب سفید",
      description:
        "با استفاده از برندسازی سفارشی، نمونه‌ی ObaradaiLLM خود را با برچسب سفید (White-label) ارائه دهید.",
    },
    chat: {
      title: "چت",
      description: "تنظیم ترجیحات چت خود برای ObaradaiLLM.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "زبان نمایش",
        description:
          "زبان مورد نظر برای نمایش رابط کاربری ObaradaiLLM را انتخاب کنید - در صورت وجود ترجمه‌ها.",
      },
      logo: {
        title: "لوگوی برند",
        description:
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "شما باید قبل از انتشار مطالب، با مرکز جامعه ObaradaiLLM احراز هویت کنید.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "از نمونه ObaradaiLLM خود با رمز عبور محافظت کنید. اگر این رمز را فراموش کنید هیچ روش بازیابی وجود ندارد، پس حتماً این رمز عبور را ذخیره کنید.",
  ...
  telegram: {
    title: "ربات تلگرام",
    description:
      "با اتصال نمونه ObaradaiLLM خود به تلگرام، می‌توانید از هر دستگاهی با فضاهای کاری خود گفتگو کنید.",
    setup: {
      step1: {
