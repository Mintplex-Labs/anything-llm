  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        ...
        "beta-badge": "آلفا (به عنوان نمونه)",
        description:
          "هنگامی که فعال شود، این قابلیت به عوامل اجازه می‌دهد تا در صورت ابهام در درخواست شما، سوالات کوتاه و واضحی را پرسیده و توضیحات بیشتری ارائه دهند. به طور پیش‌فرض غیرفعال است. این قابلیت برای اجرای عوامل از طریق API یا روش‌های برنامه‌نویسی در دسترس نیست.",
        "max-per-turn": {
          title: "حداکثر تعداد سوال در هر دور",
          description:
            "آژانس می‌تواند در یک پاسخ، حداکثر چند سوال برای روشن‌سازی بپرسد؟ هرچه این تعداد کمتر باشد، مزاحمتی کمتری ایجاد می‌کند.",
        },
        timeout: {
          title: "مدت زمان انتظار (ثانیه)",
          description:
            "اگر کاربر در این مدت پاسخ ندهد، نماینده با توجه به بهترین قضاوت خود، پیش می‌رود.",
        },
      },
    },
  },
