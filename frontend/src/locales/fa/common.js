...
const TRANSLATIONS = {
  "onboarding": {
    "survey": {
      ...
      "description": "ما را در ساخت مدل AnythingLLM متناسب با نیازهای شما یاری دهید. (این بخش اختیاری است)"
    },
    "home": {
    ...
    "llm": {
      ...
      "description": "AnythingLLM می‌تواند با بسیاری از ارائه‌دهندگان مدل‌های زبانی کار کند. این سرویس، مسئولیت انجام مکالمات را بر عهده خواهد داشت."
    },
    "userSetup": {
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        "title": "گفتگو",
        "description": "با استفاده از دانش عمومی LLM و اطلاعات موجود در سند، پاسخ‌ها را ارائه می‌دهد. <b> و </b> برای استفاده از ابزارها، باید از دستور @agent استفاده کنید."
      },
      "query": {
        "title": "پرس‌وجو",
  ...
  "agent": {
    ...
    "skill": {
      ...
      "filesystem": {
        ...
        "warning": "دسترسی به سیستم فایل می‌تواند خطرناک باشد، زیرا می‌تواند فایل‌ها را تغییر دهد یا حذف کند. لطفاً قبل از فعال‌سازی، مستندات مربوطه را مطالعه کنید.",
        "skills": {
          "read-text-file": {
            "title": "خواندن فایل",
      ...
      "gmail": {
        ...
        "description": "به اپراتور خود اجازه دهید تا با Gmail تعامل داشته باشد: جستجو در ایمیل‌ها، خواندن موضوعات، نوشتن پیش‌نویس‌ها، ارسال ایمیل‌ها و مدیریت صندوق ورودی. برای اطلاعات بیشتر، مستندات را مطالعه کنید.",
      ...
      "outlook": {
        ...
        "description": "به اپراتور خود اجازه دهید تا با استفاده از Microsoft Outlook ارتباط برقرار کند: جستجو در ایمیل‌ها، خواندن موضوعات، نوشتن پیش‌نویس‌ها، ارسال ایمیل‌ها و مدیریت صندوق ورودی خود از طریق Microsoft Graph API. برای اطلاعات بیشتر، مستندات را مطالعه کنید.",
      ...
      "googleCalendar": {
        ...
        "description": "به اپراتور خود اجازه دهید تا با گوگل کالند تعامل داشته باشد: مشاهده تقویم‌ها، دریافت رویدادها، ایجاد و به‌روزرسانی رویدادها، و مدیریت پاسخ‌های حضور و غیاب. برای اطلاعات بیشتر، به مستندات مراجعه کنید.",
    ...
    "mcp": {
      ...
      "tool-count-warning": "این سرور MCP دارای ابزارهای <b> با قابلیت {{count}} است که در هر چت، از فضای مورد استفاده (context) بهره می‌برند. </b> برای صرفه‌جویی در فضای مورد استفاده، توصیه می‌شود این ابزارهای غیرضروری را غیرفعال کنید.",
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "بتا",
        "description": "امکان استفاده از ابزارهای نامحدود و کاهش مصرف توکن تا 80 درصد برای هر پرس و جو را فراهم کنید - AnythingLLM به طور خودکار بهترین مهارت‌ها را برای هر پرس و جو انتخاب می‌کند.",
        "max-tools": {
          "title": "ابزارهای مکس",
  ...
  "api": {
    ...
    "modal": {
      ...
      "helper": "پس از ایجاد، می‌توان از این کلید API برای دسترسی و پیکربندی برنامه‌نویسی‌شده این نمونه AnythingLLM استفاده کرد.",
      "name": {
        "label": "نام",
  ...
  "connectors": {
    ...
    "github": {
      ...
      "token_information": "با وارد نکردن **توکن دسترسی GitHub**، این اتصال داده فقط می‌تواند فایل‌های سطح بالایی از مخزن را جمع‌آوری کند، به دلیل محدودیت‌های نرخ دسترسی API عمومی GitHub.",
    ...
    "gitlab": {
      ...
      "token_information": "با عدم وارد کردن **توکن دسترسی GitLab**، این اتصال داده تنها قادر به جمع‌آوری **فایل‌های سطح اول** مخزن خواهد بود، به دلیل محدودیت‌های نرخ دسترسی API عمومی GitLab.",
    ...
    "upload": {
      ...
      "privacy-notice": "این فایل‌ها در پردازشگر اسناد که روی این نمونه از AnythingLLM در حال اجرا است، بارگذاری خواهند شد. این فایل‌ها به هیچ شخص ثالثی ارسال یا به اشتراک گذاشته نمی‌شوند."
    },
    "pinning": {
      "what_pinning": "مخزن کردن اسناد چیست؟",
      "pin_explained_block1": "هنگامی که شما یک سند را در AnythingLLM \"فیکس\" می‌کنید، محتوای کامل سند را در پنجره دستورالعمل برای مدل زبان بزرگ شما قرار می‌دهیم تا مدل بتواند به طور کامل آن را درک کند.",
      "pin_explained_block2": "این روش بهترین نتیجه را با مدل‌هایی که دارای **زمینه وسیع** هستند یا فایل‌های کوچک و مهم که برای پایگاه دانش آن ضروری هستند، ارائه می‌دهد.",
      "pin_explained_block3": "اگر به پاسخ‌های مورد نظر خود از AnythingLLM به طور پیش‌فرض دریافت نمی‌کنید، «پین کردن» یک راه عالی برای دریافت پاسخ‌های با کیفیت بالاتر در یک مرحله است.",
      "accept": "باشه، متوجه شدم."
    },
    "watching": {
      "what_watching": "تماشای یک مستند چه تاثیری دارد؟",
      "watch_explained_block1": "هنگام مشاهده یک سند در AnythingLLM، محتوای سند به طور خودکار از منبع اصلی آن، در فواصل زمانی منظم، همگام‌سازی می‌شود. این کار، به‌طور خودکار محتوا را در هر فضای کاری که این فایل در آن مدیریت می‌شود، به‌روز می‌کند.",
  ...
  "chat_window": {
    ...
    "agent_invocation": {
      ...
      "clarifying_question_header": "بازرس به اطلاعات بیشتری نیاز دارد.",
      "clarifying_skip": "اجازه دهید نماینده تصمیم‌گیری کند.",
      "clarifying_submit": "ارسال",
      "clarifying_skipped": "شما اجازه می‌دهید که نماینده تصمیم‌گیری کند.",
      ...
      "batch_progress": "{{answered}} از {{total}} پاسخ داده است",
      "batch_skip_this": "گذر",
      "batch_submit_all": "ارسال همه",
      "batch_next": "بعد",
      "answer_skipped": "[کاربر این مرحله را رد کرد]"
    },
  ...
  "customization": {
    ...
    "branding": {
      ...
      "description": "با استفاده از برندسازی سفارشی، نمونه‌ی AnythingLLM خود را با برچسب سفید (White-label) ارائه دهید."
    },
    "chat": {
      "title": "چت",
    ...
    "items": {
      ...
      "display-language": {
        "title": "زبان نمایش",
        "description": "زبان مورد نظر برای نمایش رابط کاربری AnythingLLM را انتخاب کنید - در صورت وجود ترجمه‌ها."
      },
      "logo": {
        "title": "لوگوی برند",
    ...
    "publish": {
      ...
      "generic": {
        "unauthenticated": {
          ...
          "description": "شما باید قبل از انتشار مطالب، با مرکز جامعه AnythingLLM احراز هویت کنید.",
  ...
  "telegram": {
    "title": "ربات تلگرام",
    "description": "با اتصال نمونه AnythingLLM خود به تلگرام، می‌توانید از هر دستگاهی با فضاهای کاری خود گفتگو کنید.",
    "setup": {
      "step1": {
        ...
        "instruction-2": "2. پیام <code>/newbot را برای <code>@BotFather ارسال کنید.",
