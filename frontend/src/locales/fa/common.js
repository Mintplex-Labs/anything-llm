...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "workspace": {
      ...
      "description": "فضای کاری خود را ایجاد کنید و با AnythingLLM شروع به کار کنید."
    }
  },
  "common": {
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        ...
        "description": "با استفاده از دانش عمومی مدل زبانی و اطلاعات موجود در سند، پاسخ‌ها را ارائه خواهد داد. برای استفاده از ابزارها، باید از دستور @agent استفاده کنید."
      },
      "query": {
        "title": "پرس‌وجو",
        ...
        "description": "پاسخ‌ها را تنها در صورت یافتن زمینه سند ارائه می‌دهد. برای استفاده از ابزارها، باید از دستور @agent استفاده کنید."
      },
      "automatic": {
        "title": "خودرو",
        "description": "اگر مدل و ارائه‌دهنده از فراخوانی ابزار به صورت پیش‌فرض پشتیبانی کنند، ابزارها به‌طور خودکار استفاده خواهند شد. <br />در صورتی که فراخوانی ابزار به صورت پیش‌فرض پشتیبانی نشود، شما باید از دستور @agent برای استفاده از ابزارها استفاده کنید."
      }
    },
    "history": {
      "title": "تاریخچه گفتگو",
  ...
  "chat_window": {
    ...
    "agents": "تمام عوامل موجود را که می‌توانید برای گفتگو استفاده کنید، مشاهده کنید.",
  ...
  "customization": {
    ...
    "items": {
      ...
      "chat-message-alignment": {
        ...
        "description": "هنگام استفاده از رابط چت، حالت هم‌تراز کردن پیام را انتخاب کنید."
      },
      "display-language": {
        "title": "زبان نمایش",
      ...
      "welcome-messages": {
        ...
        "description": "پیام‌های خوش‌آمدی که به کاربران نمایش داده می‌شوند را سفارشی کنید. فقط کاربران غیر از مدیران این پیام‌ها را مشاهده خواهند کرد.",
        "new": "نو",
        "system": "سیستم",
        "user": "کاربر",
        "message": "پیام",
  ...
  "main-page": {
    ...
    "checklist": {
      ...
      "completed": "شما در مسیر تبدیل شدن به یک متخصص در زمینه مدل‌های LLM هستید!",
      "dismiss": "بستن",
      "tasks": {
        "create_workspace": {
    ...
    "exploreMore": {
      ...
      "features": {
        "customAgents": {
          ...
          "description": "ایجاد عوامل هوش مصنوعی و اتوماسیون قدرتمند بدون نیاز به کد.",
          "primaryAction": "با استفاده از @agent\n\nبا استفاده از @agent",
          "secondaryAction": "طراحی یک جریان برای یک عامل"
        },
        "slashCommands": {
          "title": "دستورات کوتاه",
          "description": "با استفاده از دستورات سفارشی، زمان را صرفه‌جویی کنید و اعلان‌ها را فعال کنید.",
          "primaryAction": "ایجاد یک دستور Slash",
          "secondaryAction": "کاوش در هاب"
        },
        "systemPrompts": {
          "title": "دستورالعمل‌های سیستم",
          "description": "برای سفارشی‌سازی پاسخ‌های هوش مصنوعی در یک محیط کاری، دستورالعمل سیستم را تغییر دهید.",
  ...
  "community_hub": {
    "publish": {
      ...
      "agent_flow": {
        "public_description": "دسترسی به جریان‌های اطلاعاتی برای عموم مردم امکان‌پذیر است.",
        "private_description": "فقط شما می‌توانید جریان‌های مربوط به نمایندگان خصوصی را مشاهده کنید.",
        "success_title": "موفقیت!",
      ...
      "slash_command": {
        ...
        "command_description": "این دستور، همان کدی است که کاربران برای فعال کردن این تنظیمات از آن استفاده می‌کنند.",
