...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      "search-document": "جستجوی اسناد...",
      "no-documents": "هیچ سندی یافت نشد",
      no_docs: "هیچ سندی در فضای کاری وجود ندارد",
      "new-folder": "پوشه جدید",
      "create-folder": "ایجاد پوشه",
      "folder-name": "نام پوشه",
      "enter-folder-name": "نام پوشه را وارد کنید",
      "add-tag": "افزودن برچسب",
      "enter-tag": "نام برچسب را وارد کنید",
      "move-to-folder": "انتقال به پوشه",
      "select-folder": "انتخاب پوشه",
      "document-count": "{{count}} سند",
      "rename-document": "تغییر نام سند",
      "new-name": "نام جدید",
      "enter-new-name": "نام جدید را وارد کنید",
      "delete-confirmation":
        "آیا مطمئن هستید که می‌خواهید این فایل‌ها و پوشه‌ها را حذف کنید؟\nاین کار فایل‌ها را از سیستم حذف کرده و به طور خودکار از تمام فضاهای کاری موجود حذف می‌کند.\nاین عمل قابل بازگشت نیست.",
      "removing-message":
        "در حال حذف {{count}} سند و {{folderCount}} پوشه. لطفاً صبر کنید.",
      "move-success": "{{count}} سند با موفقیت منتقل شد.",
      date: "تاریخ",
      type: "نوع",
      select_all: "انتخاب همه",
      deselect_all: "لغو انتخاب همه",
      remove_selected: "حذف موارد انتخاب شده",
      costs: "*هزینه یک‌باره برای جاسازی",
      save_embed: "ذخیره و جاسازی",
    },
    upload: {
