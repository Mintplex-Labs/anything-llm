...
const TRANSLATIONS = {
  ...
  personalization: {
    title: "شخصی‌سازی",
    description:
      "AnythingLLM می‌تواند با گذشت زمان، اطلاعات بیشتری در مورد شما جمع‌آوری کند تا پاسخ‌های مرتبط‌تر و شخصی‌سازی‌شده‌تری ارائه دهد. خاطرات به طور خودکار از مکالمات شما استخراج می‌شوند.",
    toggle: {
      label: "فعال کردن شخصی‌سازی",
      description:
        "هنگامی که فعال شود، AnythingLLM قادر خواهد بود ترجیحات و زمینه گفتگوهای کاربر را یاد بگیرد.",
    },
    actions: {
      "run-extraction": "شروع استخراج داده‌ها",
      extracting: "استخراج...",
      "clear-all": "حذف تمام خاطراتم",
      clearing: "پاکسازی...",
    },
    global: {
      title: "آهنگ‌های خاطره‌انگیز (از آلبوم {{count}} / {{max}})",
      "add-button": "اضافه کردن حافظه سراسری",
      description: "این خاطرات در تمام محیط‌های کاری اعمال می‌شوند.",
      "applied-description": "این روش در تمام محیط‌های کاری قابل استفاده است.",
      placeholder:
        'وارد کردن یک حافظه سراسری (به عنوان مثال: "اسم من شان است")',
      "empty-title": "هنوز حافظه سراسری وجود ندارد.",
      "empty-description":
        "آن‌ها را به صورت دستی اضافه کنید یا خاطرات مربوط به فضای کاری را به صورت سراسری منتشر کنید.",
    },
    workspace: {
      title: "یادهای محل کار ({{count}} / {{max}})",
      "list-title": "یادهای محل کار",
      "list-description":
        "مدیریت خاطرات خاص هر فضای کاری، از طریق تنظیمات مربوط به آن فضای کاری.",
      "add-button": "اضافه کردن حافظه",
      description:
        "یادهای خاص این محیط کار. این یادها به طور خودکار از مکالمات استخراج می‌شوند و برای شخصی‌سازی پاسخ‌ها استفاده می‌شوند.",
      "no-workspaces": "هیچ فضای کاری یافت نشد.",
      "empty-title": "هنوز خاطره‌ای وجود ندارد",
      "empty-description":
        "یادداشت‌ها به‌طور خودکار از مکالمات شما استخراج خواهند شد، یا شما می‌توانید آن‌ها را به صورت دستی نیز اضافه کنید.",
    },
    form: {
      placeholder:
        "یک خاطره را وارد کنید (به عنوان مثال، 'من ترجیح می‌دهم پاسخ‌های مختصر دریافت کنم')",
      save: "ذخیره",
      add: "اضافه کردن",
      cancel: "لغو کردن",
      hint: "هر یادداشت باید یک واقعیت یا ترجیح ساده و مختصر را در یک جمله بیان کند.",
    },
    item: {
      edit: "ویرایش",
      "promote-to-global": "تبدیل به یک فعالیت جهانی",
      delete: "حذف",
    },
    scope: {
      workspace: "فضای کاری",
    ...
    loading: "بارگذاری داده‌های شخصی‌سازی...",
    toast: {
      "setting-update-failed": "عدم امکان به‌روزرسانی تنظیم: {{error}}",
      enabled: "امکان شخصی‌سازی وجود دارد.",
      disabled: "فعال‌سازی شخصی‌سازی غیرفعال شده است.",
      "extraction-failed": "استخراج ناموفق: {{error}}",
      "extraction-completed": "استخراج اطلاعات حافظه به پایان رسید.",
      "clear-confirm":
        "آیا مطمئن هستید؟ این کار تمام اطلاعات شخصی‌سازی شده شما را به طور دائم حذف خواهد کرد.",
      "clear-failed": "عدم توانایی در پاکسازی حافظه: {{error}}",
      "clear-success": "تمام خاطرات شخصی حذف شدند.",
      "delete-confirm": "آیا می‌خواهید این اطلاعات را حذف کنید؟",
      "delete-failed": "عدم توانایی حذف حافظه.",
      "delete-success": "اطلاعات حذف شد.",
      "update-failed": "عدم به‌روزرسانی حافظه.",
      "update-success": "حافظه به‌روز شد.",
      "add-failed": "عدم امکان افزودن حافظه.",
      "add-global-success": "حافظه سراسری اضافه شد.",
      "add-success": "حافظه اضافه شد.",
      "promote-failed": "ناتوانی در تقویت حافظه.",
      "promote-success": "استفاده از حافظه به صورت جهانی.",
    },
  },
};
