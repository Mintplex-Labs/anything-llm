  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        title: "Permetre que l'agent faça preguntes per aclarir aspectes.",
        "beta-badge": "Versió beta",
        description:
          "Quan està activat, els agents poden fer una pausa per fer preguntes clares si la vostra petició és ambigua. Per defecte, està desactivat. No està disponible per a execucions d'agents a través d'API/programació.",
        "max-per-turn": {
          title: "Nombre màxim de preguntes per ronda",
          description:
            "Quant preguntes de claredat pot fer l'agent en una única resposta. Menys preguntes significen menys interrupcions.",
        },
        timeout: {
          title: "Temps màxim de resposta (segons)",
          description:
            "Si l'usuari no respon en aquest temps, l'agent procedeix amb la millor decisió possible.",
        },
      },
    },
  },
