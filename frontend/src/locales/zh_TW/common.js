...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      title: "LLM 偏好",
      description:
        "PsionHQ 可搭配多種 LLM 提供者使用。這項服務會負責處理對話。",
    },
    userSetup: {
      title: "使用者設定",
      description: "設定使用者偏好。",
    ...
    survey: {
      title: "歡迎使用 PsionHQ",
      description: "協助我們打造更符合需求的 PsionHQ。此問卷為選填。",
      email: "您的電子郵件是什麼？",
      useCase: "您將如何使用 PsionHQ？",
      useCaseWork: "用於工作",
      useCasePersonal: "用於個人使用",
      useCaseOther: "其他",
      comment: "您是從哪裡知道 PsionHQ 的？",
      commentPlaceholder:
        "例如 Reddit、Twitter、GitHub、YouTube 等，告訴我們您是怎麼找到 PsionHQ 的！",
      skip: "略過問卷",
      thankYou: "感謝您的回饋！",
    },
  },
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        title: "智能技能選擇",
        description:
          "啟用無限多個工具，並將每個查詢的 token 使用量最多降低 80% — PsionHQ 能夠自動選擇最適合的技能，以處理每一個提示。",
        "max-tools": {
          title: "馬克斯工具",
          description:
  ...
  api: {
    title: "API 金鑰",
    description:
      "API 金鑰可讓持有人透過程式方式存取並管理這個 PsionHQ 系統。",
    link: "閱讀 API 文件",
    ...
    modal: {
      ...
      create: "建立 API 金鑰",
      helper:
        "建立後，API 金鑰可用於以程式方式存取並設定這個 PsionHQ 執行個體。",
      name: {
        label: "名稱",
        placeholder: "正式環境整合",
  ...
  llm: {
    title: "LLM 偏好設定",
    description:
      "這裡設定偏好的 LLM 對話與嵌入提供者之認證資訊與參數。請確認金鑰保持最新且正確，否則 PsionHQ 可能無法正常運作。",
    provider: "LLM 提供者",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    provider: "語音轉錄提供者",
    "warn-start":
      "在記憶體或 CPU 資源有限的電腦上使用本機 Whisper 模型時，處理媒體檔案可能會讓 PsionHQ 卡住。",
  ...
  embedding: {
    ...
    "desc-end":
      "嵌入是把文字轉成向量的過程。這些認證資訊用來把檔案與提示詞轉成 PsionHQ 可處理的格式。",
    provider: {
      title: "向量嵌入提供者",
    },
  },
  ...
  vector: {
    title: "向量資料庫",
    description:
      "這裡設定 PsionHQ 系統運作所需的認證資訊與參數。請務必確認金鑰保持最新且正確。",
    provider: {
      title: "向量資料庫提供者",
  ...
  privacy: {
    title: "隱私與資料處理",
    description: "這裡設定已連線的第三方提供者與 PsionHQ 會如何處理資料。",
    anonymous: "已啟用匿名遙測",
  },
  connectors: {
    ...
    upload: {
      ...
      "fetch-website": "擷取網站",
      "privacy-notice":
        "這些檔案會上傳到此 PsionHQ 系統上的文件處理器，不會傳送給或分享給第三方。",
    },
    pinning: {
      what_pinning: "什麼是文件釘選？",
      pin_explained_block1:
        "當您在 PsionHQ 中<b>釘選</b>文件時，系統會把整份文件的內容注入提示詞輸入區，讓 LLM 能完整理解。",
      pin_explained_block2:
        "這最適合搭配<b>大上下文模型</b>，或對知識庫很重要的小型文件。",
      pin_explained_block3:
        "如果 PsionHQ 在預設情況下給不出想要的答案，釘選文件是快速提升回答品質的好方法。",
      accept: "好的，明白了",
    },
    watching: {
      what_watching: "追蹤文件有何作用？",
      watch_explained_block1:
        "當您在 PsionHQ 中<b>追蹤</b>文件時，系統會<i>自動</i>定期從原始來源同步內容，並更新所有管理這份文件的工作區。",
  ...
  chat_window: {
    ...
    agent_invocation: {
      ...
      batch_progress: "{{answered}} 在 {{total}} 的問題已得到解答",
      batch_skip_this: "跳過",
    ...
    memories: {
      title: "回憶",
      empty:
        "目前還沒有相關的回憶。當您與聊天機器人互動後，相關的回憶就會逐漸產生。",
      empty_cta: "創造新的回憶",
      tab_workspace: "工作空間",
      tab_global: "全球",
      toggle: {
        label: "啟用個人化功能",
        description:
          "讓您的助手能夠回憶關於您或這個工作空間的相關資訊，並在對話中使用這些資訊。",
      },
      auto_extraction: {
        label: "自動回憶",
        description: "請讓您的助理自動在背景中建立記憶",
      },
      menu: {
        edit: "編輯",
        delete: "刪除",
        move_to_global: "擴展至全球",
      ...
      modal: {
        ...
        label: "記憶",
        placeholder: "例如：使用者姓名為 Joe，使用者正在使用 PsionHQ 等。",
        create: "創造",
        save: "儲存",
        cancel: "取消",
      },
  ...
  customization: {
    interface: {
      title: "介面偏好設定",
      description: "設定 PsionHQ 的介面偏好。",
    },
    branding: {
      title: "品牌與白標設定",
      description: "透過自訂品牌元素，將 PsionHQ 白標化。",
    },
    chat: {
      title: "對話",
      description: "設定 PsionHQ 的對話偏好。",
      auto_submit: {
        title: "語音輸入自動送出",
    ...
    items: {
      ...
      "display-language": {
        title: "顯示語言",
        description: "選擇 PsionHQ 介面的顯示語言；若已有翻譯就會套用。",
      },
      logo: {
        title: "品牌標誌",
  ...
  community_hub: {
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "需要驗證",
          description: "發布項目前，需先完成 PsionHQ 社群中心驗證。",
          button: "連接到社群中心",
        },
      },
      slash_command: {
  ...
  security: {
    ...
    password: {
      title: "密碼保護",
      description:
        "使用密碼保護 PsionHQ 系統。若忘記此密碼，將無法復原，請務必妥善保存。",
      "password-label": "系統密碼",
    },
  },
  home: {
  ...
  telegram: {
    title: "Telegram 機器人",
    description:
      "將您的 PsionHQ 實例連接到 Telegram，以便您可以在任何裝置上與您的工作空間進行對話。",
    setup: {
      step1: {
  ...
  scheduledJobs: {
    title: "排程工作",
    enableNotifications: "啟用工作結果的瀏覽器通知",
    description:
      "建立依排程重複執行的 AI 任務。每項工作會執行提示詞、視需要使用工具，並儲存結果供您檢閱。",
    newJob: "新增工作",
    loading: "載入中...",
    emptyTitle: "尚無排程工作",
    emptySubtitle: "建立一項工作以開始使用。",
    table: {
      name: "名稱",
      schedule: "排程",
      status: "狀態",
    ...
    confirmDelete: "您確定要刪除這項排程工作嗎？",
    toast: {
      deleted: "工作已刪除",
      triggered: "工作已成功觸發",
      triggerFailed: "無法觸發工作",
      triggerSkipped: "這項工作已有一個執行作業正在進行。",
      killed: "工作已成功停止",
      killFailed: "無法停止工作",
    },
    row: {
    ...
    modal: {
      ...
      promptLabel: "提示詞",
      promptPlaceholder: "每次執行時要使用的指示...",
      scheduleLabel: "排程",
      modeBuilder: "建構器",
      modeCustom: "客製化",
      cronPlaceholder: "Cron 運算式（例如：0 9 * * *）",
      currentSchedule: "目前排程：",
      toolsLabel: "工具（可選）",
      toolsDescription:
    ...
    runHistory: {
      ...
      title: "執行記錄：{{name}}",
      schedule: "排程：",
      emptyTitle: "這項工作尚無執行記錄",
      emptySubtitle: "立即執行工作並查看結果。",
      runNow: "立即執行",
      table: {
        status: "狀態",
        started: "開始時間",
    ...
    runDetail: {
      ...
      metrics: {
        promptTokens: "提示詞 Token：",
        completionTokens: "回應 Token：",
      },
      stopJob: "停止工作",
      killing: "停止...",
  ...
  "model-router": {
    title: "模型路由器",
    description:
      "模型路由器讓您能夠定義規則，根據特定條件自動將聊天訊息路由到不同的 LLM 供應商和模型。",
    table: {
      name: "姓名",
      fallback: "備用方案",
      rules: "規則",
    ...
    "no-routers": "目前還沒有推出任何型號的路由器。",
    "empty-description": "目前尚未設定任何路由器。請先建立一個，以便開始使用。",
    "new-router-button": "新的路由器",
    "delete-confirm":
      '您確定要刪除路由器 "{{name}}" 嗎？\n這將會刪除所有相關規則，並斷開使用該路由器的所有工作空間。\n\n此操作不可撤銷。',
    "toast-deleted": "路由器已刪除",
    "toast-delete-failed": "無法刪除路由器：{{error}}",
    "new-router": {
      title: "建立新的路由器",
      name: "姓名",
      "name-placeholder": "例如：成本優化器",
      description: "描述",
      "description-placeholder": "可選說明",
      "fallback-label": "主要供應商及模型",
      "fallback-description":
        "當沒有任何路由規則符合時，也會使用此方法。此外，也可用於評估由大型語言模型（LLM）分類的規則。",
      "cooldown-label": "緩存冷卻時間 (秒)",
      "cooldown-help":
        "路由決策在重新評估規則之前，會被暫存多長時間？將此設定設為 0 則會停用暫存功能。",
      "name-required": "請提供您的姓名。",
      "fallback-required": "需要提供主要供應商和模型資訊。",
      cancel: "取消",
      create: "建立路由器",
    },
    "edit-router": {
      "back-to-routers": "返回：網路路由器",
      title: "編輯路由器：{{name}}",
      save: "儲存變更",
      "toast-update-failed": "無法更新路由器",
    },
    rules: {
      title: "路由規則",
      "title-with-name": "路由規則：{{name}}",
      description: "明確說明哪些規則決定聊天訊息應該發送給哪些供應商和模型。",
      "add-rule": "新增規則",
      "delete-confirm": '刪除規則 "{{title}}"？',
      "toast-delete-failed": "刪除規則失敗",
      "toast-reorder-failed": "未能重新建立規則",
      "no-rules": "目前還沒有任何規則。",
      "empty-description": "新增規則，以便將聊天訊息路由到特定的供應商和模型。",
      "new-rule-button": "新規定",
      "calculated-section-label": "預先設定的規則 — 依照優先順序進行評估",
      "llm-section-label": "LLM 規則：若沒有任何規則符合計算結果，則判定為一組",
      "llm-rule-body":
        "執行 <desc>「{{description}}」</desc>，然後將其路由到 <route>{{route}}</route>",
      "calculated-no-conditions":
        "沒有任何限制 — 路線為 <route>{{route}}</route>",
      ...
      "badge-llm": "大型語言模型",
      "badge-calculated": "計算出來",
      "aria-drag-to-reorder": "拖動以重新排序",
      "aria-edit-rule": "編輯規則",
      "aria-delete-rule": "刪除規則",
      "quantifier-any": "任何",
      "quantifier-all": "全部",
    },
    "rule-form": {
      ...
      "property-label": "房產",
      "property-select": "選擇",
      "comparator-label": "比較器",
      "comparator-select": "選擇",
      "value-label": "價值",
      "add-condition": "添加條件",
      "remove-condition": "移除條件",
      "conditions-incomplete":
        "條件 {{index}} 尚未完成 — 請填寫「屬性」、「比較器」和「值」。",
      "match-description-label": "比賽描述",
      "match-description-placeholder":
        "例如，使用者詢問的是法律相關議題、合約或合規性等方面",
      "match-description-help":
        "說明您希望此規則適用於哪些情況。您的 LLM 將評估這些情況，以判斷是否應該使用該規則。",
      "route-to-label": "前往服務提供者及模型",
      "route-to-description": "當此規則成立時，請使用此供應商/模型。",
      cancel: "取消",
      saving: "儲存...",
      "update-rule": "更新規則",
      "create-rule": "建立規則",
      "title-required": "標題必填",
      "toast-save-failed": "未能儲存規則",
      "type-calculated-label": "計算得出",
      "type-calculated-description":
        "根據訊息的屬性，例如內容、字數或發送時間，進行比對。",
      "type-llm-label": "LLM 類別",
      "type-llm-description":
        "利用大型語言模型，根據您提供的描述，對訊息進行分類。",
      "prop-prompt-content": "提示內容",
      "prop-token-count": "對話 Token 數量",
      "prop-message-count": "對話訊息數量",
      "prop-current-hour": "當前時間 (0-23)",
      "prop-has-image": "是否包含圖片",
      "cmp-contains": "包含",
      "cmp-matches-regex": "匹配 (正規表達式)",
      "cmp-equals": "等於",
      "cmp-not-equals": "不等於",
      "cmp-greater-than": "超過",
      "cmp-greater-than-or-equal": "大於或等於",
      "cmp-less-than": "少於",
      "cmp-less-than-or-equal": "小於或等於",
      "cmp-between": "包含（包括）",
      "placeholder-between-hour": "例如：9:00-17:00",
      ...
      "placeholder-contains": "例如：程式碼、Python、Rust",
      "placeholder-matches": "例如：/\\bpython\\b/i",
      "placeholder-default": "例如：程式碼",
      "help-contains":
        "以逗號分隔的列表 — 如果提示包含任何這些值（不區分大小寫），則匹配。",
      "help-matches":
        "正規表示式模式。使用 `/模式/旗標` 進行大小寫區分 (預設為不區分大小寫)。",
      "bool-true": "正確",
      "bool-false": "錯誤",
    },
    "provider-picker": {
      "select-provider": "選擇供應商",
      "setup-required": "（需要進行設定）",
      "loading-models": "正在載入模型...",
      "select-model": "選擇模型",
      "enter-model": "請輸入模型名稱",
      "select-provider-first": "首先選擇一個供應商",
      "configure-to-continue": "設定 {{name}} 以繼續執行",
      "configure-provider": "設定 {{name}}",
      "setup-credentials": "請輸入必要的憑證，以便使用 {{name}} 作為路由目標。",
      cancel: "取消",
      "save-settings": "儲存設定",
      "toast-save-failed": "無法儲存設定：{{error}}",
    },
    "router-selection": {
      "loading-routers": "正在載入自定義路由器...",
      "no-routers-prefix-settings": "目前尚未設定任何路由器模型。",
      "no-routers-prefix-workspace": "沒有設定任何路由器。",
      "no-routers-link": "在模型路由器設定中建立一個",
