...
const TRANSLATIONS = {
  ...
  "model-router": {
    title: "模型路由器",
    description:
      "模型路由器讓您能夠定義規則，根據特定條件自動將聊天訊息路由到不同的LLM供應商和模型。",
    "create-router": "建立路由器",
    table: {
      name: "姓名",
      fallback: "備用方案",
    ...
    "no-routers": "目前尚未建立任何型號路由器",
    "delete-confirm":
      '您確定要刪除路由器 "{{name}}" 嗎？\n這將會移除所有相關規則，並斷開使用該路由器的任何工作空間。\n\n此操作不可撤銷。',
    ...
    "new-router": {
      ...
      "fallback-label": "備用供應商及模型",
      "fallback-description": "當沒有任何路由規則相符時使用",
      "cooldown-label": "緩存效能 (秒)",
      "cooldown-help":
        "路由決策在重新評估規則之前，會被暫存多長時間？設定為 0 則會關閉暫存功能。",
      "name-required": "請提供您的姓名。",
      "fallback-required": "需要指定備用供應商和模型。",
      cancel: "取消",
      creating: "創作...",
      create: "建立路由器",
      "toast-created": "路由器已成功建立",
    },
    "edit-router": {
      "back-to-routers": "返回：模型路由器",
      title: "編輯路由器：{{name}}",
      description: "更新路由器設定，以及備用網路服務供應商/型號。",
      name: "姓名",
      "description-label": "說明",
      "description-placeholder": "可選說明",
      "fallback-label": "備用供應商與模型",
      "fallback-description": "當沒有任何路由規則符合時使用",
      "cooldown-label": "緩存冷卻時間 (秒)",
      "cooldown-help":
        "路由決策在重新評估規則之前，暫存的時間長度。設定為 0 以停用暫存功能。",
      saving: "儲存...",
      save: "儲存變更",
      "toast-updated": "路由器已成功更新",
      "toast-update-failed": "無法更新路由器",
    },
    rules: {
      title: "路由規則",
      description:
        "規則會依照優先順序逐一評估。可拖曳來重新排序。先符合條件的規則獲勝。",
      "add-rule": "新增規則",
    ...
    "rule-form": {
      ...
      "new-title": "新規定",
      "title-label": "標題",
      "title-help": "僅使用小寫字母和下劃符。儲存時自動格式化。",
      "rule-type": "規則類型",
      "property-label": "房產",
      "property-select": "選擇",
      "comparator-label": "比較器",
      "value-label": "價值",
      "match-description-label": "比賽說明",
      "match-description-placeholder":
        "例如，使用者詢問的是法律相關議題、合約或合規問題。",
      "match-description-help":
        "說明在什麼情況下這個規則應該被應用。路由器會讀取使用者發送的訊息，並判斷是否符合這個描述。",
      "route-to-label": "前往服務供應商及模型",
      "route-to-description": "當此規則符合時，請使用此供應商/模型。",
      cancel: "取消",
      saving: "儲存...",
      "update-rule": "更新規則",
      "create-rule": "建立規則",
    ...
    "provider-picker": {
      ...
      "toast-configured": "供應商設定成功",
    },
    "router-selection": {
      "loading-routers": "正在載入路由器...",
      "no-routers-prefix-settings": "目前尚未配置任何路由器。",
