...
const TRANSLATIONS = {
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        ...
        "description": "將提供答案，利用 LLM 的一般知識和相關文件內容。您需要使用 `@agent` 命令來使用工具。"
      },
      "query": {
        "title": "查詢",
        "desc-start": "將",
        ...
        "description": "將提供答案，僅在找到文件上下文時 <b>。您需要使用 @agent 指令來使用工具。"
      },
      "automatic": {
        "title": "自動",
  ...
  "agent": {
    ...
    "skill": {
      ...
      "web": {
        "title": "即時網路搜尋與瀏覽",
        "desc-start": "讓您的智慧代理人能夠透過連線到網路搜尋 (SERP) 提供者來搜尋網路以回答您的問題。",
