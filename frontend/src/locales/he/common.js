...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "llm": {
      ...
      "description": "AnythingLLM יכול לעבוד עם ספקי מודלי שפה (LLM) רבים. זה יהיה השירות שיטפל בצ'אט."
    },
    "userSetup": {
      "title": "הגדרת משתמש",
    ...
    "workspace": {
      ...
      "description": "צור את סביבת העבודה הראשונה שלך והתחל לעבוד עם AnythingLLM."
    }
  },
  "common": {
  ...
  "main-page": {
    ...
    "exploreMore": {
      ...
      "features": {
        ...
        "slashCommands": {
          "title": "פקודות סלאש",
          "description": "חסוך זמן והזרק הנחיות באמצעות פקודות סלאש מותאמות אישית.",
          "primaryAction": "צור פקודת סלאש",
          "secondaryAction": "גלה במרכז הקהילה"
        },
        "systemPrompts": {
          "title": "הנחיות מערכת",
          "description": "שנה את הנחיית המערכת כדי להתאים אישית את תשובות ה-AI של סביבת עבודה.",
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        ...
        "description": "יוכל לספק תשובות בהתבסס על הידע הכללי של ה-LLM ועל ההקשר הרלוונטי מתוך המסמך. <b> ו-</b>\nתצטרכו להשתמש בפקודה \"@agent\" כדי להשתמש בכלי."
      },
      "query": {
        "title": "שאילתה",
        ...
        "description": "יספק תשובות <b>רק</b>במידה ויהיה ניתן למצוא הקשר של המסמך.<br />תצטרכו להשתמש בפקודה @agent כדי להשתמש בכלי."
      },
      "automatic": {
        "title": "רכב",
        "description": "הכלי ישתמש באופן אוטומטי בכלים אם המודל והספק תומכים בהם. <br />אם אין תמיכה בכלים מקומיים, תצטרכו להשתמש בפקודה \"@agent\" כדי להשתמש בכלים."
      }
    },
    "history": {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "description": "שפר את היכולות הטבעיות של סוכן ברירת המחדל עם כישורים מובנים אלה. הגדרה זו חלה על כל סביבות העבודה.",
      "rag": {
      ...
      "save": {
        ...
        "description": "אפשר לסוכן ברירת המחדל ליצור ולכתוב לקבצים שנשמרים וניתנים להורדה בדפדפן שלך."
      },
      "web": {
        "title": "חיפוש וגלישה באינטרנט בזמן אמת",
        "desc-start": "אפשר לסוכן שלך לחפש באינטרנט כדי לענות על שאלותיך על ידי התחברות לספק חיפוש אינטרנטי (SERP).",
        "desc-end": "חיפוש אינטרנטי במהלך סשנים של סוכן לא יעבוד עד שהגדרה זו תבוצע."
      }
    }
  },
  "recorded": {
  ...
  "customization": {
    ...
    "items": {
      ...
      "display-language": {
        "title": "שפת תצוגה",
        "description": "בחר את השפה המועדפת להצגת ממשק המשתמש של AnythingLLM - כאשר תרגומים זמינים."
      },
      "logo": {
        "title": "לוגו מותג",
      ...
      "welcome-messages": {
        "title": "הודעות פתיחה",
        "description": "התאם אישית את הודעות הפתיחה המוצגות למשתמשים שלך. רק משתמשים שאינם מנהלים יראו הודעות אלה.",
        "new": "חדש",
        "system": "מערכת",
        "user": "משתמש",
        "message": "הודעה",
  ...
  "api": {
    "title": "מפתחות API",
    "description": "מפתחות API מאפשרים למחזיק בהם לגשת ולנהל באופן תכנותי את מופע AnythingLLM זה.",
  ...
  "llm": {
    "title": "העדפות מודל שפה (LLM)",
    "description": "אלה האישורים וההגדרות עבור ספק הצ'אט וההטמעה המועדף עליך. חשוב שמפתחות אלה יהיו עדכניים ונכונים, אחרת AnythingLLM לא יפעל כראוי.",
    "provider": "ספק LLM",
    "providers": {
      "azure_openai": {
  ...
  "transcription": {
    ...
    "provider": "ספק תמלול",
    "warn-start": "שימוש במודל ה-whisper המקומי על מכונות עם זיכרון RAM או מעבד מוגבלים עלול לגרום להאטה של AnythingLLM בעת עיבוד קובצי מדיה.",
  ...
  "embedding": {
    ...
    "desc-end": "הטמעה היא תהליך של הפיכת טקסט לווקטורים. אישורים אלה נדרשים כדי להפוך את הקבצים וההנחיות שלך לפורמט ש-AnythingLLM יכול להשתמש בו לעיבוד.",
    "provider": {
      "title": "ספק הטמעה"
    }
  },
  ...
  "vector": {
    ...
    "description": "אלה האישורים וההגדרות לאופן פעולת מופע ה-AnythingLLM שלך. חשוב שמפתחות אלה יהיו עדכניים ונכונים.",
    "provider": {
  ...
  "privacy": {
    ...
    "description": "זוהי התצורה שלך לאופן שבו ספקים צד שלישי מחוברים ו-AnythingLLM מטפלים בנתונים שלך.",
  ...
  "connectors": {
    ...
    "upload": {
      ...
      "privacy-notice": "קבצים אלה יועלו למעבד המסמכים הפועל במופע זה של AnythingLLM. קבצים אלה אינם נשלחים או משותפים עם צד שלישי."
    },
    "pinning": {
      "what_pinning": "מהי הצמדת מסמכים?",
      "pin_explained_block1": "כאשר אתה <b>מצמיד</b> מסמך ב-AnythingLLM, אנו נזריק את כל תוכן המסמך לחלון ההנחיה שלך כדי שמודל השפה שלך יבין אותו במלואו.",
      "pin_explained_block2": "זה עובד בצורה הטובה ביותר עם <b>מודלים בעלי הקשר רחב</b> או קבצים קטנים שהם קריטיים לבסיס הידע שלו.",
      "pin_explained_block3": "אם אינך מקבל את התשובות הרצויות מ-AnythingLLM כברירת מחדל, הצמדה היא דרך מצוינת לקבל תשובות איכותיות יותר בלחיצה אחת.",
      "accept": "אוקיי, הבנתי"
    },
    "watching": {
      "what_watching": "מה עושה מעקב אחר מסמך?",
      "watch_explained_block1": "כאשר אתה <b>עוקב</b> אחר מסמך ב-AnythingLLM, אנו נסנכרן <i>אוטומטית</i> את תוכן המסמך שלך ממקורו המקורי במרווחי זמן קבועים. זה יעדכן אוטומטית את התוכן בכל סביבת עבודה שבה קובץ זה מנוהל.",
  ...
  "community_hub": {
    "publish": {
      ...
      "slash_command": {
        ...
        "command_label": "פקודה",
        "command_description": "זוהי פקודת הסלאש שמשתמשים יקלידו כדי להפעיל הגדרה קבועה זו.",
      ...
      "generic": {
        "unauthenticated": {
          "title": "נדרש אימות",
          "description": "עליך להתאמת עם מרכז הקהילה של AnythingLLM לפני פרסום פריטים.",
  ...
  "security": {
    ...
    "password": {
      "title": "הגנת סיסמה",
      "description": "הגן על מופע ה-AnythingLLM שלך באמצעות סיסמה. אם תשכח אותה, אין שיטת שחזור, אז ודא שאתה שומר סיסמה זו.",
