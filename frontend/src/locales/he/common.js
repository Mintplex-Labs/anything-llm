...
const TRANSLATIONS = {
  ...
  "model-router": {
    title: "נתבים לדוגמה",
    description:
      "נתב מודל מאפשר לך להגדיר כללים כך שהודעות צ'אט יועברו באופן אוטומטי לספקי ומודלים שונים של מודלים שפה, בהתאם לתנאים.",
    "create-router": "יצירת מכשיר ניתוב",
    table: {
      name: "שם",
    ...
    "no-routers": "עדיין לא נוצרו מודלים של ראוטרים.",
    "delete-confirm":
      'האם אתה בטוח שאתה רוצה למחוק את הראוטר "{{name}}"?\nפעולה זו תבטל את כל הכללים שלה ותנתק כל סביבת עבודה המשתמשת בה.\n\nפעולה זו אינה ניתנת לבטל.',
    "toast-deleted": "נת העברה הוסרה",
    "toast-delete-failed": "לא הצלחתי למחוק את המודם: {{error}}",
    "new-router": {
      title: "יצירת מכשיר ניתוב חדש",
      name: "שם",
      "name-placeholder": "למשל, כלי אופטימיזציה של עלויות",
      description: "תיאור",
      "description-placeholder": "תיאור אופציונלי",
      "fallback-label": "ספק חלופי ומודל",
      "fallback-description": "משמש כאשר אין כלל ניתוב התואם",
      "cooldown-label": "זמן קירור (שניות)",
      "cooldown-help":
        "כמה זמן החלטת המסלול נשמרת לפני שוב בדיקת הכללים. הגדרות ל-0 כדי לבטל את השמירה.",
      "name-required": "יש לציין שם.",
      "fallback-required": "יש צורך בספק ו/או במודל חלופי.",
      cancel: "ביטול",
      creating: "יצירה...",
      create: "יצירת נתב",
      "toast-created": "נת העברה נוצרה בהצלחה",
    },
    "edit-router": {
      "back-to-routers": "חזרה למודלים של רשתות",
      title: "עריכת נתב: {{name}}",
      description: "עדכן את הגדרות הראוטר והגדר את ספק/דגם החלופי.",
      name: "שם",
      ...
      "cooldown-label": "זמן קירור (שניות)",
      "cooldown-help":
        "כמה זמן החלטת המסלול מאוחסנת לפני שמתבצעים מחדש בדיקות. הגדרות ל-0 כדי לבטל את האחסון.",
      saving: "חיסכון...",
      save: "שמור שינויים",
      "toast-updated": "הנתב עודכן בהצלחה.",
      "toast-update-failed": "לא הצלחתי לעדכן את הנתב.",
    },
    rules: {
      title: "כללי ניתוב",
      description:
        "הכללים מוערכים מהחשיבות הגבוהה ביותר לנמוכה ביותר. גרור כדי לסדר מחדש. המאבק הראשון זוכה.",
      "add-rule": "הוסף כלל",
      "delete-confirm": 'מחק את הכלל "{{title}}"?',
      "toast-deleted": "הכלל הוסר",
    ...
    "rule-form": {
      ...
      "title-label": "כותרת",
      "title-help":
        "אותיות קטנות בלבד, עם תחנות מתחת. פורמט אוטומטי בעת שמירה.",
      "rule-type": "סוג כלל",
      "property-label": "רכוש",
      "property-select": "בחר",
      ...
      "match-description-placeholder":
        "לדוגמה, המשתמש שואל על נושאים משפטיים, חוזים או נושאים הקשורים לציות לחוק.",
      "match-description-help":
        "תארו את התנאים שבהם כלל זה צריך להתאים. מודל החלופה של הנתב יקרא את ההודעה של המשתמש ויחליט אם היא מתאימה לתיאור זה.",
      "route-to-label": "מסלול להגעה לספק ולמודל",
    ...
    "provider-picker": {
      ...
      "toast-configured": "הספק הוגדר בהצלחה.",
    },
    "router-selection": {
      "loading-routers": "טעינת ראוטרים...",
      "no-routers-prefix-settings":
        "טרמינלים (נתבים) מסוגים שונים עדיין לא מוגדרים.",
      "no-routers-prefix-workspace": "אין מכשירי רשת מוגדרים.",
      "no-routers-link": "צור אחת בהגדרות של רשת הווירטואלית.",
      "model-router-label": "מודל של רשת (ראוטר)",
      "select-router": "בחרו נתב",
      "select-description": "בחר את הראוטר שתרצה להשתמש עבור חלל העבודה הזה.",
      "no-routers-chat":
        'אין מכשירי רשת מוגדרים. צרו אחד בתפריט "הגדרות" > "ספקי AI" > "מכשיר רשת".',
      "rule-count": "(כללים {{count}})",
    },
    metrics: {
      "model-router-default": "מודל של רשת (ראוטר)",
    },
    chat: {
