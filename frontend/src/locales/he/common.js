...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "userSetup": {
      ...
      "adminUsernameReq": "שם המשתמש חייב להכיל לפחות 6 תווים ויכול לכלול רק אותיות קטנות, מספרים, קווים תחתונים ומקפים, ללא רווחים.",
  ...
  "welcomeMessage": {
    "part1": "ברוכים הבאים ל-AnythingLLM, כלי קוד פתוח מבית Mintplex Labs שהופך כל דבר לצ'אטבוט מאומן שאפשר לשאול ולשוחח איתו. AnythingLLM היא תוכנת BYOK (הבא-מפתחות-משלך) כך שאין מנוי, עמלה או חיובים עבור תוכנה זו מלבד השירותים שברצונך להשתמש בהם.",
    "part2": "AnythingLLM היא הדרך הקלה ביותר לשלב מוצרי AI חזקים כמו OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB ושירותים אחרים בחבילה מסודרת אחת ללא מאמץ, כדי להגביר את הפרודוקטיביות שלך פי 100.",
    "part3": "AnythingLLM יכול לרוץ באופן מקומי לחלוטין על המחשב שלך עם תקורה נמוכה, עד כדי כך שלא תשים לב שהוא שם! אין צורך ב-GPU. התקנה בענן ובשרתים מקומיים זמינה גם כן.\nמערכת כלי ה-AI מתחזקת מדי יום. AnythingLLM מקל על השימוש בה.",
    "githubIssue": "צור בעיה ב-GitHub",
    "user1": "איך אני מתחיל?!",
    "part4": "זה פשוט. כל האוספים מאורגנים בתוך מה שאנו מכנים \"סביבות עבודה\". סביבות עבודה הן מאגרים של קבצים, מסמכים, תמונות, קובצי PDF וקבצים אחרים שיהפכו למשהו שמודלי שפה (LLM) יכולים להבין ולהשתמש בו בשיחה.\n\nתוכל להוסיף ולהסיר קבצים בכל עת.",
    "createWorkspace": "צור את סביבת העבודה הראשונה שלך",
    "user2": "זה כמו דרופבוקס חכם או משהו? ומה לגבי צ'אט? זה צ'אטבוט, לא?",
    "part5": "AnythingLLM הוא יותר מדרופבוקס חכם.\n\nAnythingLLM מציע שתי דרכים לדבר עם הנתונים שלך:\n\n<i>שאילתה:</i> הצ'אטים שלך יחזירו נתונים או מסקנות שנמצאו באמצעות המסמכים בסביבת העבודה שיש לו גישה אליהם. הוספת מסמכים נוספים לסביבת העבודה הופכת אותו לחכם יותר! \n\n<i>שיחה:</i> המסמכים שלך + היסטוריית הצ'אט המתמשכת שלך תורמים שניהם לידע של מודל השפה בו-זמנית. מצוין להוספת מידע טקסטואלי בזמן אמת או תיקונים ואי-הבנות שעלולות להיות למודל השפה. \n\nתוכל לעבור בין שני המצבים \n<i>באמצע השיחה!</i>",
  ...
  "profile_settings": {
    ...
    "username": "שם משתמש",
    "username_description": "שם המשתמש חייב להכיל רק אותיות קטנות, מספרים, קווים תחתונים ומקפים, ללא רווחים",
