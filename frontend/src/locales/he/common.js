...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      "search-document": "חיפוש מסמכים...",
      "no-documents": "לא נמצאו מסמכים",
      no_docs: "אין מסמכים בסביבת העבודה",
      "new-folder": "תיקייה חדשה",
      "create-folder": "צור תיקייה",
      "folder-name": "שם התיקייה",
      "enter-folder-name": "הזן שם תיקייה",
      "add-tag": "הוסף תגית",
      "enter-tag": "הזן שם תגית",
      "move-to-folder": "העבר לתיקייה",
      "select-folder": "בחר תיקייה",
      "document-count": "{{count}} מסמכים",
      "rename-document": "שנה שם מסמך",
      "new-name": "שם חדש",
      "enter-new-name": "הזן שם חדש",
      "delete-confirmation":
        "האם אתה בטוח שברצונך למחוק קבצים ותיקיות אלה?\nזה יסיר את הקבצים מהמערכת ויסיר אותם אוטומטית מכל סביבות העבודה הקיימות.\nלא ניתן לבטל פעולה זו.",
      "removing-message":
