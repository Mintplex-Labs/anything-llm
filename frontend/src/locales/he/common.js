...
const TRANSLATIONS = {
  ...
  welcomeMessage: {
    ...
    part2:
      "AnythingLLM היא הדרך הקלה ביותר לשלב מוצרי AI חזקים כמו OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB ושירותים אחרים בחבילה מסודרת אחת ללא מאמץ, כדי להגביר את הפרודוקטיביות שלך פי 100.",
    part3:
      "AnythingLLM יכול לרוץ באופן מקומי לחלוטין על המחשב שלך עם תקורה נמוכה, עד כדי כך שלא תשים לב שהוא שם! אין צורך ב-GPU. התקנה בענן ובשרתים מקומיים זמינה גם כן.\nמערכת כלי ה-AI מתחזקת מדי יום. AnythingLLM מקל על השימוש בה.",
