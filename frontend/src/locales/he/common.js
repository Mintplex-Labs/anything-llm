  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        ...
        "beta-badge": "בטא",
        description:
          "כאשר מופעל, ניתן לבקש מהנציגים לעצור ולשאול שאלות קצרות להבהרה, במקרה שההנחיה שלכם אינה ברורה. מופעל כברירת מחדל. לא זמין לשימוש עם API או פעולות אוטומטיות.",
        "max-per-turn": {
          title: "מספר שאלות מקסימלי לסיבוב",
          description:
            "כמה שאלות הבהרה סוכן יכול לשאול בתגובה אחת. ככל שמספר השאלות יהיה נמוך יותר, כך התגובה תהיה פחות מפריעה.",
        },
        timeout: {
          title: "זמן המתנה (שניות)",
          description:
            "אם המשתמש לא יגיב בתוך זמן זה, נציג החברה יפעל על סמך שיקול דעתו הטוב ביותר.",
        },
      },
    },
  },
