  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        ...
        "beta-badge": "BETA",
        description:
          "Po aktivaci mohou agenti přerušit komunikaci a položit krátké, upřesňující otázky, pokud je váš požadavek nejasný. Je vypnuté ve výchozím nastavení. Není k dispozici pro spouštění agentů prostřednictvím API nebo programově.",
        "max-per-turn": {
          title: "Maximální počet otázek za kolo",
          description:
            "Kolik otázek může agent položit v jedné odpovědi, aby získal potřebné informace? Méně otázek znamená menší narušení.",
        },
        timeout: {
          title: "Časový limit odpovědi (sekundy)",
          description:
            "Pokud uživatel nereaguje v daném časovém rámci, zástupce jedná na základě svých nejlepších odhadů.",
        },
      },
    },
  },
