  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        ...
        description:
          "Khi được kích hoạt, các tác nhân có thể tạm dừng để đặt các câu hỏi làm rõ ngắn gọn nếu yêu cầu của bạn không rõ ràng. Tắt theo mặc định. Không khả dụng cho các tác nhân chạy bằng API/phương pháp lập trình.",
        "max-per-turn": {
          title: "Số lượng câu hỏi tối đa cho mỗi lượt",
          description:
            "Đại diện có thể đặt bao nhiêu câu hỏi để làm rõ trong một phản hồi duy nhất? Số lượng ít hơn sẽ ít gây gián đoạn hơn.",
        },
        timeout: {
          title: "Thời gian chờ phản hồi (giây)",
          description:
            "Nếu người dùng không phản hồi trong khoảng thời gian này, đại diện sẽ đưa ra quyết định dựa trên đánh giá tốt nhất của mình.",
        },
      },
    },
  },
