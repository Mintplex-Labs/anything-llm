...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      "no-documents": "Không tìm thấy tài liệu",
      no_docs: "Không có tài liệu trong không gian làm việc",
      ...
      "document-count": "{{count}} tài liệu",
      "rename-document": "Đổi tên tài liệu",
      "new-name": "Tên mới",
      "enter-new-name": "Nhập tên mới",
      "delete-confirmation":
        "Bạn có chắc chắn muốn xóa các tệp và thư mục này không?\nĐiều này sẽ xóa các tệp khỏi hệ thống và tự động xóa chúng khỏi tất cả các không gian làm việc hiện có.\nHành động này không thể hoàn tác.",
      "removing-message":
        "Đang xóa {{count}} tài liệu và {{folderCount}} thư mục. Vui lòng đợi.",
