...
const TRANSLATIONS = {
  "onboarding": {
    "survey": {
      ...
      "commentPlaceholder": "Reddit, Twitter, GitHub, YouTube, v.v. - Hãy cho chúng tôi biết bạn tìm thấy chúng tôi như thế nào!",
      "skip": "Bỏ qua Khảo sát",
      "thankYou": "Cảm ơn phản hồi của bạn!",
      "title": "Chào mừng đến với AnythingLLM",
      "description": "Giúp chúng tôi xây dựng AnythingLLM phù hợp với nhu cầu của bạn. Tùy chọn."
    },
    "home": {
      "getStarted": "Bắt đầu",
      "welcome": "Chào mừng"
    ...
    "llm": {
      "title": "Tùy chọn LLM",
      "description": "AnythingLLM có thể hoạt động với nhiều nhà cung cấp LLM. Đây sẽ là dịch vụ xử lý trò chuyện."
    },
    "userSetup": {
      ...
      "passwordWarn": "Điều quan trọng là phải lưu mật khẩu này vì không có phương pháp khôi phục.",
      ...
      "teamHint": "Theo mặc định, bạn sẽ là quản trị viên duy nhất. Sau khi hoàn tất thiết lập, bạn có thể tạo và mời người khác làm người dùng hoặc quản trị viên. Không được mất mật khẩu vì chỉ quản trị viên mới có thể đặt lại mật khẩu."
    },
    "data": {
      "title": "Xử lý Dữ liệu & Quyền riêng tư",
      "description": "Chúng tôi cam kết minh bạch và kiểm soát khi liên quan đến dữ liệu cá nhân của bạn.",
      "settingsHint": "Các cài đặt này có thể được cấu hình lại bất cứ lúc nào trong cài đặt."
    }
  },
  "common": {
    ...
    "no": "Không",
    "search": "Tìm kiếm",
    "username_requirements": "Tên người dùng phải có 2-32 ký tự, bắt đầu bằng chữ cái thường và chỉ chứa chữ cái thường, số, dấu gạch dưới, dấu gạch ngang và dấu chấm.",
    "on": "Về",
    "none": "Không",
    "stopped": "Dừng",
    "loading": "Đang tải",
  ...
  "general": {
    ...
    "message": {
      ...
      "description": "Tùy chỉnh các tin nhắn sẽ được gợi ý cho người dùng không gian làm việc của bạn.",
    ...
    "delete": {
      ...
      "description": "Xóa không gian làm việc này và tất cả dữ liệu của nó. Điều này sẽ xóa không gian làm việc cho tất cả người dùng.",
  ...
  "chat": {
    ...
    "mode": {
      ...
      "query": {
        "title": "Truy vấn",
        "description": "sẽ cung cấp câu trả lời <b>chỉ</b> nếu ngữ cảnh của tài liệu được tìm thấy.<br />Bạn sẽ cần sử dụng lệnh @agent để sử dụng các công cụ."
      },
      "automatic": {
        "title": "Tự động",
    ...
    "history": {
      ...
      "desc-start": "Số lượng cuộc trò chuyện trước đó sẽ được bao gồm trong bộ nhớ ngắn hạn của phản hồi.",
    ...
    "prompt": {
      ...
      "history": {
        ...
        "clearAllConfirm": "Bạn có chắc chắn muốn xóa tất cả lịch sử? Hành động này không thể hoàn tác.",
        "expand": "Mở rộng",
    ...
    "refusal": {
      ...
      "query": "truy vấn",
      "desc-end": ", bạn có thể muốn trả về phản hồi từ chối tùy chỉnh khi không tìm thấy ngữ cảnh.",
  ...
  "vector-workspace": {
    ...
    "doc": {
      ...
      "description": "Điểm tương đồng tối thiểu cần thiết để một nguồn được coi là liên quan đến cuộc trò chuyện. Số càng cao, nguồn phải càng tương tự với cuộc trò chuyện.",
      "zero": "Không hạn chế",
  ...
  "agent": {
    ...
    "skill": {
      "rag": {
        ...
        "description": "Cho phép agent sử dụng tài liệu cục bộ của bạn để trả lời truy vấn hoặc yêu cầu agent \"ghi nhớ\" các phần nội dung để truy xuất bộ nhớ dài hạn."
      },
      "view": {
        "title": "Xem & tóm tắt tài liệu",
        "description": "Cho phép agent liệt kê và tóm tắt nội dung của các tệp không gian làm việc hiện đang được nhúng."
      },
      "scrape": {
        "title": "Thu thập dữ liệu website",
        "description": "Cho phép agent truy cập và thu thập nội dung của các website."
      },
      "generate": {
        "title": "Tạo biểu đồ",
        "description": "Cho phép agent mặc định tạo các loại biểu đồ khác nhau từ dữ liệu được cung cấp hoặc đưa ra trong trò chuyện."
      },
      "web": {
      ...
      "filesystem": {
        ...
        "warning": "Việc truy cập hệ thống tệp có thể gây nguy hiểm vì nó có thể sửa đổi hoặc xóa các tệp. Vui lòng tham khảo tài liệu <a> trước khi kích hoạt.",
        "skills": {
          "read-text-file": {
            "title": "Đọc tệp",
            "description": "Đọc nội dung của các tệp (văn bản, mã, PDF, hình ảnh, v.v.)"
          },
          "read-multiple-files": {
            "title": "Đọc nhiều tệp",
          ...
          "edit-file": {
            "title": "Chỉnh sửa tệp",
            "description": "Thực hiện chỉnh sửa dựa trên dòng trong các tệp văn bản."
          },
          "create-directory": {
            "title": "Tạo thư mục",
          ...
          "write-text-file": {
            ...
            "description": "Tạo các tệp văn bản mới hoặc ghi đè các tệp văn bản hiện có."
          }
        }
      },
      "createFiles": {
        ...
        "skills": {
          "create-text-file": {
            "title": "Tệp văn bản",
            "description": "Tạo các tệp văn bản với bất kỳ nội dung và định dạng nào (ví dụ: .txt, .md, .json, .csv, v.v.)"
          },
          "create-pptx": {
            "title": "Bài trình bày bằng PowerPoint",
            "description": "Tạo các bài trình chiếu PowerPoint mới với các slide, tiêu đề và dấu đầu dòng."
          },
          "create-pdf": {
            "title": "Tài liệu PDF",
            "description": "Tạo tài liệu PDF từ Markdown hoặc văn bản thuần túy với các định dạng cơ bản."
          },
          "create-xlsx": {
            "title": "Bảng tính Excel",
            "description": "Tạo các tài liệu Excel cho dữ liệu dạng bảng, bao gồm các sheet và định dạng."
          },
          "create-docx": {
            "title": "Tệp Word",
            "description": "Tạo các tài liệu Word với định dạng và kiểu dáng cơ bản."
          }
        }
      },
      "gmail": {
        ...
        "deploymentIdHelp": "Mã triển khai từ ứng dụng web Google Apps Script của bạn",
        "apiKey": "Khóa API",
        "apiKeyHelp": "Khóa API mà bạn đã cấu hình trong quá trình triển khai Google Apps Script của mình.",
        "configurationRequired": "Vui lòng cấu hình ID triển khai và khóa API để kích hoạt các tính năng của Gmail.",
        ...
        "categories": {
          "search": {
            ...
            "description": "Tìm kiếm và đọc các email trong hộp thư Gmail của bạn."
          },
          "drafts": {
            "title": "Mẫu email",
          ...
          "send": {
            ...
            "description": "Gửi email và trả lời các cuộc thảo luận ngay lập tức."
          },
          "threads": {
            "title": "Quản lý các chuỗi email",
            "description": "Quản lý các chuỗi email – đánh dấu là đã đọc/chưa đọc, lưu trữ, xóa"
          },
          "account": {
        ...
        "skills": {
          ...
          "getMailboxStats": {
            ...
            "description": "Hiển thị số lượng email chưa đọc và thống kê hộp thư."
          },
          "getInbox": {
      ...
      "outlook": {
        ...
        "authTypeHelp": "Chọn loại tài khoản Microsoft nào có thể xác thực. \"Tất cả các tài khoản\" hỗ trợ cả tài khoản cá nhân và tài khoản làm việc/học. \"Chỉ tài khoản cá nhân\" giới hạn chỉ ở tài khoản Microsoft cá nhân. \"Chỉ tài khoản tổ chức\" giới hạn ở tài khoản làm việc/học từ một tenant cụ thể của Azure AD.",
        "authTypeCommon": "Tất cả các tài khoản (cá nhân và tài khoản liên quan đến công việc/học tập)",
        "authTypeConsumers": "Chỉ dành cho tài khoản Microsoft cá nhân",
        "authTypeOrganization": "Chỉ dành cho tài khoản tổ chức (cần ID của người thuê).",
        "clientId": "Mã định danh của khách hàng",
        "clientIdHelp": "Mã định danh ứng dụng (Client ID) từ quá trình đăng ký ứng dụng của bạn trong Azure AD",
        "tenantId": "Mã định danh (cho người thuê)",
        "tenantIdHelp": "Mã định danh (Tenant ID) từ ứng dụng Azure AD của bạn. Yêu cầu chỉ khi thực hiện xác thực cho riêng tổ chức.",
        "clientSecret": "Mật khẩu",
        "clientSecretHelp": "Giá trị bí mật của ứng dụng Azure AD của bạn",
        "configurationRequired": "Vui lòng cấu hình ID và bí mật của ứng dụng để kích hoạt các tính năng của Outlook.",
        "authRequired": "Trước tiên, hãy lưu thông tin đăng nhập của bạn, sau đó xác thực với Microsoft để hoàn thành quá trình thiết lập.",
        ...
        "categories": {
          "search": {
            "title": "Tìm kiếm và đọc email",
            "description": "Tìm kiếm và đọc các email trong hộp thư Outlook của bạn."
          },
          "drafts": {
            "title": "Mẫu email",
            "description": "Tạo, chỉnh sửa và quản lý bản nháp email"
        ...
        "skills": {
          ...
          "search": {
            ...
            "description": "Tìm kiếm trong các email bằng cú pháp tìm kiếm của Microsoft"
          },
          "readThread": {
          ...
          "createDraft": {
            "title": "Tạo bản nháp",
            "description": "Tạo một bản nháp email mới hoặc một bản nháp trả lời cho một tin nhắn hiện có."
          },
          "updateDraft": {
            "title": "Cập nhật bản nháp",
          ...
          "sendEmail": {
            "title": "Gửi email",
            "description": "Gửi một email mới hoặc trả lời một tin nhắn hiện có ngay lập tức."
          },
          "getMailboxStats": {
            "title": "Thống kê hộp thư",
      ...
      "googleCalendar": {
        ...
        "deploymentId": "Mã triển khai",
        "deploymentIdHelp": "Mã định danh ứng dụng từ ứng dụng web Google Apps Script của bạn",
        "apiKey": "Khóa API",
        "apiKeyHelp": "Khóa API mà bạn đã cấu hình trong quá trình triển khai Google Apps Script của mình.",
        "configurationRequired": "Vui lòng cấu hình ID triển khai và khóa API để kích hoạt các tính năng của Google Calendar.",
        "configured": "Đã được cấu hình",
        "searchSkills": "Kỹ năng tìm kiếm...",
        "noSkillsFound": "Không tìm thấy kết quả phù hợp với tiêu chí tìm kiếm của bạn.",
        "categories": {
          "calendars": {
            "title": "Lịch",
          ...
          "writeEvents": {
            ...
            "description": "Tạo các sự kiện mới và chỉnh sửa các sự kiện hiện có."
          },
          "rsvp": {
        ...
        "skills": {
          ...
          "getEventsForDay": {
            ...
            "description": "Hiển thị tất cả các sự kiện được lên lịch cho một ngày cụ thể."
          },
          "getEvents": {
            "title": "Tìm sự kiện (khoảng thời gian)",
            "description": "Lấy danh sách các sự kiện trong một khoảng thời gian tùy chỉnh."
          },
          "getUpcomingEvents": {
            "title": "Xem các sự kiện sắp tới",
            "description": "Tìm kiếm các sự kiện diễn ra hôm nay, tuần này hoặc tháng này bằng cách sử dụng các từ khóa đơn giản."
          },
          "quickAdd": {
            "title": "Thêm sự kiện nhanh chóng",
            "description": "Tạo một sự kiện từ ngôn ngữ tự nhiên (ví dụ: \"Cuộc họp vào ngày mai lúc 3 giờ chiều\")"
          },
          "createEvent": {
            "title": "Tạo sự kiện",
            "description": "Tạo một sự kiện mới với quyền kiểm soát hoàn toàn đối với tất cả các thuộc tính."
          },
          "updateEvent": {
          ...
          "setMyStatus": {
            ...
            "description": "Chấp nhận, từ chối hoặc chấp nhận một sự kiện một cách tạm thời."
          }
        }
      }
    },
    "mcp": {
      ...
      "tool-warning": "Để đạt hiệu suất tốt nhất, hãy cân nhắc việc tắt các công cụ không cần thiết để tiết kiệm tài nguyên.",
      "stop-server": "Tắt máy chủ MCP",
      "start-server": "Khởi động máy chủ MCP",
      "delete-server": "Xóa máy chủ MCP",
      "tool-count-warning": "Máy chủ MCP này có các công cụ <b> được kích hoạt, {{count}} và chúng sẽ tiêu thụ ngữ cảnh trong mọi cuộc trò chuyện.</b> Hãy cân nhắc việc tắt các công cụ không cần thiết để tiết kiệm ngữ cảnh.",
      "startup-command": "Lệnh khởi động",
      "command": "Lệnh",
      "arguments": "Luận điểm",
      "not-running-warning": "Máy chủ MCP này không hoạt động – có thể nó đã bị tắt hoặc đang gặp lỗi khi khởi động.",
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        ...
        "description": "Cho phép sử dụng không giới hạn các công cụ và giảm mức sử dụng token lên đến 80% cho mỗi truy vấn – AnythingLLM tự động chọn các kỹ năng phù hợp nhất cho mỗi yêu cầu.",
        "max-tools": {
          "title": "Công cụ Max",
          "description": "Số lượng công cụ tối đa có thể chọn cho mỗi truy vấn. Chúng tôi khuyến nghị đặt giá trị này thành các giá trị lớn hơn đối với các mô hình có ngữ cảnh lớn hơn."
        }
      }
    }
  },
  "recorded": {
    ...
    "description": "Đây là tất cả các cuộc trò chuyện và tin nhắn đã được ghi lại được gửi bởi người dùng, sắp xếp theo ngày tạo.",
    "export": "Xuất",
    "table": {
      "id": "Id",
      "by": "Gửi bởi",
  ...
  "api": {
    "title": "Khóa API",
    "description": "Khóa API cho phép người sở hữu truy cập và quản lý phiên bản AnythingLLM này theo chương trình.",
    ...
    "modal": {
      ...
      "close": "Đóng",
      "create": "Tạo khóa API",
      "helper": "Sau khi được tạo, khóa API có thể được dùng để truy cập và cấu hình phiên bản AnythingLLM này theo chương trình.",
      "name": {
        "label": "Tên",
        "placeholder": "Tích hợp production",
        "helper": "Tùy chọn. Hãy dùng tên dễ nhận biết để bạn có thể xác định khóa này sau này."
      }
    },
    "row": {
      ...
      "copied": "Đã sao chép",
      "unnamed": "--",
      "deleteConfirm": "Bạn có chắc muốn vô hiệu hóa khóa API này không?\nSau đó khóa sẽ không thể sử dụng được nữa.\n\nHành động này không thể hoàn tác."
    },
    "table": {
      "name": "Tên",
      "key": "Khóa API",
  ...
  "llm": {
    "title": "Tùy chọn LLM",
    "description": "Đây là thông tin đăng nhập và cài đặt cho nhà cung cấp LLM trò chuyện & nhúng ưa thích của bạn. Điều quan trọng là các khóa này phải chính xác, nếu không AnythingLLM sẽ không hoạt động đúng.",
    ...
    "providers": {
      "azure_openai": {
        ...
        "default": "Mặc định",
        "reasoning": "Lý luận",
        "model_type_tooltip": "Nếu triển khai của bạn sử dụng mô hình lý luận (o1, o1-mini, o3-mini, v.v.), hãy đặt thành \"Lý luận\". Nếu không, yêu cầu trò chuyện của bạn có thể thất bại."
      }
    }
  },
  "transcription": {
    ...
    "warn-start": "Sử dụng mô hình whisper cục bộ trên máy có RAM hoặc CPU hạn chế có thể làm AnythingLLM bị treo khi xử lý tệp media.",
  ...
  "embedding": {
    ...
    "desc-end": "Nhúng là quá trình chuyển đổi văn bản thành vector. Thông tin đăng nhập này cần thiết để chuyển đổi tệp và prompt của bạn thành định dạng mà AnythingLLM có thể sử dụng để xử lý.",
    "provider": {
  ...
  "text": {
    ...
    "size": {
      ...
      "description": "Đây là độ dài tối đa của các ký tự có thể có trong một vector đơn.",
      "recommend": "Độ dài tối đa của mô hình nhúng là"
    },
    "overlap": {
      "title": "Độ Chồng lấp Đoạn Văn bản",
      "description": "Đây là độ chồng lấp tối đa của các ký tự xảy ra trong quá trình tách giữa hai đoạn văn bản liền kề."
    }
  },
  "vector": {
    "title": "Cơ sở dữ liệu Vector",
    "description": "Đây là thông tin đăng nhập và cài đặt cho cách phiên bản AnythingLLM của bạn sẽ hoạt động. Điều quan trọng là các khóa này phải chính xác.",
    "provider": {
  ...
  "embed-chats": {
    ...
    "export": "Xuất",
    "description": "Đây là tất cả các cuộc trò chuyện và tin nhắn đã được ghi lại từ bất kỳ nhúng nào mà bạn đã xuất bản.",
    "table": {
      "embed": "Nhúng",
      "sender": "Người gửi",
      "message": "Tin nhắn",
  ...
  "event": {
    ...
    "description": "Xem tất cả các hành động và sự kiện đang xảy ra trên phiên bản này để giám sát.",
  ...
  "privacy": {
    ...
    "description": "Đây là cấu hình của bạn về cách các nhà cung cấp bên thứ ba được kết nối và AnythingLLM xử lý dữ liệu của bạn.",
  ...
  "connectors": {
    ...
    "github": {
      "name": "Kho GitHub",
      "description": "Nhập toàn bộ kho GitHub công khai hoặc riêng tư chỉ với một cú nhấp chuột.",
      "URL": "URL Kho GitHub",
      ...
      "token_explained_middle": ", API GitHub có thể giới hạn số lượng tệp có thể thu thập do giới hạn tốc độ. Bạn có thể ",
      "token_explained_link2": "tạo Token Truy cập tạm thời",
      "token_explained_end": " để tránh vấn đề này.",
      "ignores": "Bỏ qua Tệp",
      "git_ignore": "Danh sách theo định dạng .gitignore để bỏ qua các tệp cụ thể trong quá trình thu thập. Nhấn enter sau mỗi mục bạn muốn lưu.",
      "task_explained": "Khi hoàn tất, tất cả các tệp sẽ có sẵn để nhúng vào không gian làm việc trong bộ chọn tài liệu.",
      "branch": "Nhánh bạn muốn thu thập tệp.",
      "branch_loading": "-- đang tải các nhánh có sẵn --",
      "branch_explained": "Nhánh bạn muốn thu thập tệp.",
      "token_information": "Nếu không điền <b>Token Truy cập GitHub</b>, trình kết nối dữ liệu này chỉ có thể thu thập các tệp <b>cấp cao nhất</b> của kho do giới hạn tốc độ API công khai của GitHub.",
      "token_personal": "Nhận Token Truy cập Cá nhân miễn phí với tài khoản GitHub tại đây."
    },
    "gitlab": {
      "name": "Kho GitLab",
      "description": "Nhập toàn bộ kho GitLab công khai hoặc riêng tư chỉ với một cú nhấp chuột.",
      "URL": "URL Kho GitLab",
      ...
      "token_explained_start": "Nếu không có ",
      "token_explained_link1": "Token Truy cập Cá nhân",
      "token_explained_middle": ", API GitLab có thể giới hạn số lượng tệp có thể thu thập do giới hạn tốc độ. Bạn có thể ",
      "token_explained_link2": "tạo Token Truy cập tạm thời",
      "token_explained_end": " để tránh vấn đề này.",
      ...
      "branch_loading": "-- đang tải các nhánh có sẵn --",
      "branch_explained": "Nhánh bạn muốn thu thập tệp.",
      "token_information": "Nếu không điền <b>Token Truy cập GitLab</b>, trình kết nối dữ liệu này chỉ có thể thu thập các tệp <b>cấp cao nhất</b> của kho do giới hạn tốc độ API công khai của GitLab.",
      "token_personal": "Nhận Token Truy cập Cá nhân miễn phí với tài khoản GitLab tại đây."
    },
    "youtube": {
      "name": "Bản ghi YouTube",
      "description": "Nhập bản ghi của toàn bộ video YouTube từ một liên kết.",
      "URL": "URL Video YouTube",
      "URL_explained_start": "Nhập URL của bất kỳ video YouTube nào để lấy bản ghi. Video phải có ",
      "URL_explained_link": "phụ đề đóng",
      "URL_explained_end": " có sẵn.",
      "task_explained": "Khi hoàn tất, bản ghi sẽ có sẵn để nhúng vào không gian làm việc trong bộ chọn tài liệu."
    },
    "website-depth": {
      "name": "Trình thu thập Liên kết Hàng loạt",
      "description": "Thu thập một website và các liên kết con của nó đến một độ sâu nhất định.",
      "URL": "URL Website",
      "URL_explained": "URL của website bạn muốn thu thập.",
      "depth": "Độ sâu Thu thập",
      "depth_explained": "Đây là số lượng liên kết con mà worker sẽ theo dõi từ URL gốc.",
      "max_pages": "Số trang Tối đa",
      "max_pages_explained": "Số lượng liên kết tối đa để thu thập.",
      "task_explained": "Khi hoàn tất, tất cả nội dung đã thu thập sẽ có sẵn để nhúng vào không gian làm việc trong bộ chọn tài liệu."
    },
    "confluence": {
      "name": "Confluence",
      "description": "Nhập toàn bộ trang Confluence chỉ với một cú nhấp chuột.",
      "deployment_type": "Loại triển khai Confluence",
      "deployment_type_explained": "Xác định phiên bản Confluence của bạn được lưu trữ trên đám mây Atlassian hay tự lưu trữ.",
      ...
      "space_key_explained": "Đây là khóa không gian của phiên bản confluence của bạn sẽ được sử dụng. Thường bắt đầu bằng ~",
      "username": "Tên người dùng Confluence",
      "username_explained": "Tên người dùng Confluence của bạn",
      "auth_type": "Loại Xác thực Confluence",
      "auth_type_explained": "Chọn loại xác thực bạn muốn sử dụng để truy cập các trang Confluence của mình.",
      ...
      "token_explained_start": "Bạn cần cung cấp token truy cập để xác thực. Bạn có thể tạo token truy cập ",
      ...
      "task_explained": "Khi hoàn tất, nội dung trang sẽ có sẵn để nhúng vào không gian làm việc trong bộ chọn tài liệu.",
      "bypass_ssl": "Bỏ qua Xác thực Chứng chỉ SSL",
      "bypass_ssl_explained": "Bật tùy chọn này để bỏ qua xác thực chứng chỉ SSL cho các phiên bản confluence tự lưu trữ với chứng chỉ tự ký"
    },
    "manage": {
      "documents": "Tài liệu",
      "data-connectors": "Trình kết nối Dữ liệu",
      "desktop-only": "Chỉnh sửa các cài đặt này chỉ có sẵn trên thiết bị máy tính để bàn. Vui lòng truy cập trang này trên máy tính để bàn của bạn để tiếp tục.",
      "dismiss": "Đóng",
    ...
    "directory": {
      ...
      "delete-confirmation": "Bạn có chắc chắn muốn xóa các tệp và thư mục này?\nĐiều này sẽ xóa các tệp khỏi hệ thống và tự động xóa chúng khỏi bất kỳ không gian làm việc hiện có nào.\nHành động này không thể hoàn tác.",
      "removing-message": "Đang xóa {{count}} tài liệu và {{folderCount}} thư mục. Vui lòng chờ.",
    ...
    "upload": {
      ...
      "processor-offline-desc": "Chúng tôi không thể tải lên tệp của bạn ngay bây giờ vì trình xử lý tài liệu đang ngoại tuyến. Vui lòng thử lại sau.",
      "click-upload": "Nhấp để tải lên hoặc kéo và thả",
      "file-types": "hỗ trợ tệp văn bản, csv, bảng tính, tệp âm thanh và hơn thế nữa!",
      "or-submit-link": "hoặc gửi liên kết",
      "placeholder-link": "https://example.com",
      "fetching": "Đang lấy...",
      "fetch-website": "Lấy website",
      "privacy-notice": "Các tệp này sẽ được tải lên trình xử lý tài liệu đang chạy trên phiên bản AnythingLLM này. Các tệp này không được gửi hoặc chia sẻ với bên thứ ba."
    },
    "pinning": {
      "what_pinning": "Ghim tài liệu là gì?",
      "pin_explained_block1": "Khi bạn <b>ghim</b> một tài liệu trong AnythingLLM, chúng tôi sẽ đưa toàn bộ nội dung của tài liệu vào cửa sổ prompt của bạn để LLM hiểu đầy đủ.",
      ...
      "pin_explained_block3": "Nếu bạn không nhận được câu trả lời mong muốn từ AnythingLLM theo mặc định, ghim là một cách tuyệt vời để có được câu trả lời chất lượng cao hơn chỉ với một cú nhấp chuột.",
      "accept": "Ok, tôi hiểu rồi"
    },
    "watching": {
      "what_watching": "Theo dõi tài liệu làm gì?",
      "watch_explained_block1": "Khi bạn <b>theo dõi</b> một tài liệu trong AnythingLLM, chúng tôi sẽ <i>tự động</i> đồng bộ nội dung tài liệu của bạn từ nguồn gốc theo các khoảng thời gian đều đặn. Điều này sẽ tự động cập nhật nội dung trong mọi không gian làm việc nơi tệp này được quản lý.",
      "watch_explained_block2": "Tính năng này hiện chỉ hỗ trợ nội dung dựa trên trực tuyến và sẽ không khả dụng cho các tài liệu được tải lên thủ công.",
      "watch_explained_block3_start": "Bạn có thể quản lý những tài liệu nào đang được theo dõi từ ",
    ...
    "obsidian": {
      ...
      "vault_description": "Chọn thư mục kho Obsidian của bạn để nhập tất cả ghi chú và kết nối của chúng.",
      "selected_files": "Tìm thấy {{count}} tệp markdown",
      "importing": "Đang nhập kho...",
      "import_vault": "Nhập Kho",
      "processing_time": "Điều này có thể mất một lúc tùy thuộc vào kích thước kho của bạn.",
      "vault_warning": "Để tránh xung đột, hãy đảm bảo kho Obsidian của bạn hiện không mở."
    }
  },
  "chat_window": {
    ...
    "preset_reset_description": "Xóa lịch sử trò chuyện và bắt đầu cuộc trò chuyện mới",
    ...
    "submit": "Gửi",
    "edit_info_user": "\"Gửi\" sẽ tạo lại phản hồi của AI. \"Lưu\" chỉ cập nhật tin nhắn của bạn.",
    "edit_info_assistant": "Các thay đổi của bạn sẽ được lưu trực tiếp vào phản hồi này.",
    "see_less": "Xem ít hơn",
    "see_more": "Xem thêm",
    "tools": "Dụng cụ",
    ...
    "agent_invocation": {
      ...
      "clarifying_question_header": "Đại lý cần thêm thông tin",
      "clarifying_skip": "Để đại lý quyết định",
      "clarifying_submit": "Gửi",
      "clarifying_skipped": "Bạn để đại lý đưa ra quyết định.",
      ...
      "batch_progress": "{{answered}} từ {{total}} đã trả lời",
  ...
  "customization": {
    ...
    "branding": {
      ...
      "description": "Nhãn trắng phiên bản AnythingLLM của bạn với thương hiệu tùy chỉnh."
    },
    "chat": {
      "title": "Trò chuyện",
      ...
      "spellcheck": {
        ...
        "description": "Bật hoặc tắt kiểm tra chính tả trong trường nhập trò chuyện"
      }
    },
    "items": {
      "theme": {
      ...
      "support-email": {
        "title": "Email Hỗ trợ",
        "description": "Đặt địa chỉ email hỗ trợ mà người dùng có thể truy cập khi họ cần trợ giúp."
      },
      "app-name": {
        "title": "Tên",
        "description": "Đặt tên được hiển thị trên trang đăng nhập cho tất cả người dùng."
      },
      "display-language": {
        "title": "Ngôn ngữ Hiển thị",
        "description": "Chọn ngôn ngữ ưa thích để hiển thị giao diện người dùng của AnythingLLM - khi bản dịch có sẵn."
      },
      "logo": {
        "title": "Logo Thương hiệu",
        "description": "Tải lên logo tùy chỉnh của bạn để hiển thị trên tất cả các trang.",
      ...
      "browser-appearance": {
        ...
        "description": "Tùy chỉnh giao diện của tab trình duyệt và tiêu đề khi ứng dụng đang mở.",
        "tab": {
          "title": "Tiêu đề",
          "description": "Đặt tiêu đề tab tùy chỉnh khi ứng dụng đang mở trong trình duyệt."
        },
        "favicon": {
          "title": "Favicon",
  ...
  "community_hub": {
    "publish": {
      ...
      "agent_flow": {
        "success_title": "Thành công!",
        "success_description": "Luồng Agent của bạn đã được đăng lên Community Hub!",
        "success_thank_you": "Cảm ơn bạn đã chia sẻ với Cộng đồng!",
        "view_on_hub": "Xem trên Community Hub",
        ...
        "description_label": "Mô tả",
        "description_description": "Đây là mô tả của luồng agent của bạn. Sử dụng điều này để mô tả mục đích của luồng agent của bạn.",
        "tags_label": "Thẻ",
        "tags_description": "Thẻ được sử dụng để gắn nhãn luồng agent của bạn để dễ tìm kiếm hơn. Bạn có thể thêm nhiều thẻ. Tối đa 5 thẻ. Tối đa 20 ký tự mỗi thẻ.",
        "tags_placeholder": "Nhập và nhấn Enter để thêm thẻ",
        "visibility_label": "Hiển thị",
        "submitting": "Đang đăng...",
        "submit": "Đăng lên Community Hub",
        "privacy_note": "Luồng agent luôn được tải lên dưới dạng riêng tư để bảo vệ bất kỳ dữ liệu nhạy cảm nào. Bạn có thể thay đổi khả năng hiển thị trong Community Hub sau khi đăng. Vui lòng xác minh luồng của bạn không chứa bất kỳ thông tin nhạy cảm hoặc riêng tư nào trước khi đăng."
      },
      "slash_command": {
        "success_title": "Thành công!",
        "success_description": "Lệnh Gạch chéo của bạn đã được đăng lên Community Hub!",
        "success_thank_you": "Cảm ơn bạn đã chia sẻ với Cộng đồng!",
        "view_on_hub": "Xem trên Community Hub",
        ...
        "description_label": "Mô tả",
        "description_description": "Đây là mô tả của lệnh gạch chéo của bạn. Sử dụng điều này để mô tả mục đích của lệnh gạch chéo của bạn.",
        "tags_label": "Thẻ",
        "tags_description": "Thẻ được sử dụng để gắn nhãn lệnh gạch chéo của bạn để dễ tìm kiếm hơn. Bạn có thể thêm nhiều thẻ. Tối đa 5 thẻ. Tối đa 20 ký tự mỗi thẻ.",
        "tags_placeholder": "Nhập và nhấn Enter để thêm thẻ",
        "visibility_label": "Hiển thị",
        "public_description": "Lệnh gạch chéo công khai hiển thị cho tất cả mọi người.",
        "private_description": "Lệnh gạch chéo riêng tư chỉ hiển thị cho bạn.",
        "publish_button": "Đăng lên Community Hub",
        "submitting": "Đang đăng...",
        "prompt_label": "Prompt",
        "prompt_description": "Đây là prompt sẽ được sử dụng khi lệnh gạch chéo được kích hoạt.",
        "prompt_placeholder": "Nhập prompt của bạn ở đây..."
      },
      "generic": {
        "unauthenticated": {
          "title": "Yêu cầu Xác thực",
          "description": "Bạn cần xác thực với AnythingLLM Community Hub trước khi đăng các mục.",
  ...
  "security": {
    ...
    "multiuser": {
      ...
      "description": "Thiết lập phiên bản của bạn để hỗ trợ nhóm bằng cách kích hoạt Chế độ Đa Người dùng.",
      "enable": {
        "is-enable": "Chế độ Đa Người dùng đã Được Bật",
        "enable": "Bật Chế độ Đa Người dùng",
        "description": "Theo mặc định, bạn sẽ là quản trị viên duy nhất. Với tư cách quản trị viên, bạn sẽ cần tạo tài khoản cho tất cả người dùng hoặc quản trị viên mới. Không được mất mật khẩu vì chỉ người dùng Quản trị viên mới có thể đặt lại mật khẩu.",
    ...
    "password": {
      ...
      "description": "Bảo vệ phiên bản AnythingLLM của bạn bằng mật khẩu. Nếu bạn quên mật khẩu này, không có phương pháp khôi phục nên hãy đảm bảo lưu mật khẩu này.",
  ...
  "home": {
    ...
    "notAssigned": "Bạn hiện không được giao việc nào.\nLiên hệ với quản trị viên của bạn để yêu cầu truy cập vào khu vực làm việc.",
    "goToWorkspace": "Chuyển đến khu vực làm việc \"{{workspace}}\""
  },
  "telegram": {
    "title": "Bot Telegram",
    "description": "Kết nối phiên bản AnythingLLM của bạn với Telegram để bạn có thể trò chuyện với các không gian làm việc của mình từ bất kỳ thiết bị nào.",
    "setup": {
      "step1": {
        "title": "Bước 1: Tạo bot Telegram của bạn",
        "description": "Mở ứng dụng @BotFather trên Telegram, gửi lệnh <code>/newbot</code> đến tài khoản <code>@BotFather</code>, làm theo hướng dẫn và sao chép mã API.",
        "open-botfather": "Mở BotFather",
        "instruction-1": "1. Mở liên kết hoặc quét mã QR",
        "instruction-2": "2. Gửi <code>/newbot</code> đến <code>@BotFather</code>",
      ...
      "step2": {
        ...
        "description": "Dán mã API mà bạn nhận được từ @BotFather và chọn không gian làm việc mặc định để bot của bạn có thể trò chuyện.",
        "bot-token": "Token Bot",
        "connecting": "Kết nối...",
      ...
      "security": {
        ...
        "description": "Để tăng cường bảo mật, hãy cấu hình các cài đặt này trên tài khoản @BotFather.",
        "disable-groups": "— Ngăn chặn việc thêm bot vào các nhóm",
        "disable-inline": "— Ngăn chặn việc sử dụng bot trong tìm kiếm trực tiếp.",
        "obscure-username": "Sử dụng tên người dùng bot không phổ biến để giảm khả năng được tìm thấy."
      },
    ...
    "connected": {
      "status": "Kết nối",
      "status-disconnected": "Không kết nối — mã token có thể đã hết hạn hoặc không hợp lệ",
      ...
      "voice-always": "Luôn luôn có thể gửi phản hồi bằng giọng nói (gửi kèm âm thanh trong mỗi phản hồi).",
    ...
    "users": {
      "pending-description": "Người dùng đang chờ xác nhận. So sánh mã ghép đôi được hiển thị ở đây với mã hiển thị trong cuộc trò chuyện Telegram của họ.",
