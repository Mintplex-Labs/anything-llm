...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "workspace": {
      ...
      "description": "Tạo không gian làm việc đầu tiên của bạn và bắt đầu với AnythingLLM."
    }
  },
  "common": {
  ...
  "general": {
    ...
    "pfp": {
      ...
      "description": "Tùy chỉnh hình ảnh hồ sơ của trợ lý cho không gian làm việc này.",
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        ...
        "description": "sẽ cung cấp câu trả lời dựa trên kiến thức chung của LLM và ngữ cảnh tài liệu được cung cấp.<br />Bạn cần sử dụng lệnh @agent để sử dụng các công cụ."
      },
      "query": {
        "title": "Truy vấn",
        ...
        "description": "sẽ cung cấp câu trả lời <b>chỉ</b> khi ngữ cảnh của tài liệu được tìm thấy.<br />Bạn cần sử dụng lệnh @agent để sử dụng các công cụ."
      },
      "automatic": {
        "title": "Tự động",
        "description": "sẽ tự động sử dụng các công cụ nếu mô hình và nhà cung cấp hỗ trợ gọi công cụ gốc.<br />Nếu không hỗ trợ gọi công cụ gốc, bạn sẽ cần sử dụng lệnh `@agent` để sử dụng các công cụ."
      }
    },
    "history": {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "description": "Cải thiện khả năng tự nhiên của agent mặc định với những kỹ năng được xây dựng sẵn này. Thiết lập này áp dụng cho tất cả không gian làm việc.",
      "rag": {
      ...
      "save": {
        "title": "Tạo & lưu tệp",
        "description": "Cho phép agent mặc định tạo và ghi vào các tệp có thể lưu vào máy tính của bạn."
      },
      "web": {
        "title": "Tìm kiếm web trực tiếp và duyệt web",
        "desc-start": "Cho phép agent của bạn tìm kiếm web để trả lời câu hỏi bằng cách kết nối với nhà cung cấp tìm kiếm web (SERP).",
        "desc-end": "Tìm kiếm web trong phiên agent sẽ không hoạt động cho đến khi được thiết lập."
      }
    }
  },
  "recorded": {
  ...
  "customization": {
    ...
    "items": {
      ...
      "chat-message-alignment": {
        ...
        "description": "Chọn chế độ căn chỉnh tin nhắn khi sử dụng giao diện trò chuyện."
      },
      "display-language": {
      ...
      "welcome-messages": {
        ...
        "description": "Tùy chỉnh các tin nhắn chào mừng hiển thị cho người dùng của bạn. Chỉ người dùng không phải quản trị viên mới thấy các tin nhắn này.",
        "new": "Mới",
        "system": "hệ thống",
        "user": "người dùng",
        "message": "tin nhắn",
  ...
  "main-page": {
    "noWorkspaceError": "Vui lòng tạo một không gian làm việc trước khi bắt đầu trò chuyện.",
    "checklist": {
      "title": "Bắt đầu",
    ...
    "exploreMore": {
      ...
      "features": {
        "customAgents": {
          ...
          "description": "Xây dựng các Agent AI và tự động hóa mạnh mẽ mà không cần viết mã.",
          "primaryAction": "Trò chuyện bằng @agent",
          "secondaryAction": "Xây dựng một luồng agent"
        },
        "slashCommands": {
          "title": "Lệnh Gạch chéo",
          "description": "Tiết kiệm thời gian và đưa prompt bằng các lệnh gạch chéo tùy chỉnh.",
          "primaryAction": "Tạo một Lệnh Gạch chéo",
          "secondaryAction": "Khám phá trên Hub"
        },
        "systemPrompts": {
          "title": "System Prompt",
          "description": "Sửa đổi system prompt để tùy chỉnh các phản hồi AI của một không gian làm việc.",
  ...
  "community_hub": {
    "publish": {
      ...
      "agent_flow": {
        "public_description": "Luồng agent công khai hiển thị cho tất cả mọi người.",
      ...
      "slash_command": {
        ...
        "command_label": "Lệnh",
        "command_description": "Đây là lệnh gạch chéo mà người dùng sẽ nhập để kích hoạt cài đặt sẵn này.",
