...
const TRANSLATIONS = {
  ...
  "multi": {
    ...
    "description": "Set up your instance to support your team by activating Multi-Người dùng Mode.",
    "enable": {
      "is-enable": "Multi-Người dùng Mode is Enabled",
      "enable": "Enable Multi-Người dùng Mode",
      "description": "By default, you will be the only admin. As an admin you will need to create accounts for all new users or admins. Do not lose your password as only an Quản trị viên user can reset passwords.",
