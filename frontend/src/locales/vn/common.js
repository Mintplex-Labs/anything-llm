...
const TRANSLATIONS = {
  "onboarding": {
    "survey": {
      ...
      "useCase": "Bạn sẽ sử dụng GOV AI VN168 để làm gì?",
      "useCaseWork": "Cho công việc",
      "useCasePersonal": "Cho mục đích cá nhân",
      "useCaseOther": "Khác",
      "comment": "Bạn biết đến GOV AI VN168 như thế nào?",
      ...
      "title": "Chào mừng đến với GOV AI VN168",
      "description": "Giúp chúng tôi xây dựng GOV AI VN168 phù hợp với nhu cầu của bạn. Tùy chọn."
    },
    "home": {
      "getStarted": "Bắt đầu",
      "welcome": "Chào mừng"
  ...
  "settings": {
    ...
    "chat": "Trò chuyện",
    "mobile-app": "GOV AI VN168 Di động",
    "community-hub": {
  ...
  "general": {
    ...
    "message": {
      ...
      "body": "các lợi ích của GOV AI VN168"
    },
    "delete": {
  ...
  "agent": {
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        ...
        "description": "Cho phép sử dụng không giới hạn các công cụ và giảm mức sử dụng token lên đến 80% cho mỗi truy vấn – GOV AI VN168 tự động chọn các kỹ năng phù hợp nhất cho mỗi yêu cầu.",
        "max-tools": {
          "title": "Công cụ Max",
  ...
  "api": {
    "title": "Khóa API",
    "description": "Khóa API cho phép người sở hữu truy cập và quản lý phiên bản GOV AI VN168 này theo chương trình.",
    ...
    "modal": {
      ...
      "close": "Đóng",
      "create": "Tạo khóa API",
      "helper": "Sau khi được tạo, khóa API có thể được dùng để truy cập và cấu hình phiên bản GOV AI VN168 này theo chương trình.",
      "name": {
        "label": "Tên",
  ...
  "privacy": {
    ...
    "description": "Đây là cấu hình của bạn về cách các nhà cung cấp bên thứ ba được kết nối và GOV AI VN168 xử lý dữ liệu của bạn.",
  ...
  "connectors": {
    ...
    "upload": {
      ...
      "privacy-notice": "Các tệp này sẽ được tải lên trình xử lý tài liệu đang chạy trên phiên bản GOV AI VN168 này. Các tệp này không được gửi hoặc chia sẻ với bên thứ ba."
    },
    "pinning": {
    ...
    "watching": {
      ...
      "watch_explained_block1": "Khi bạn <b>theo dõi</b> một tài liệu trong GOV AI VN168, chúng tôi sẽ <i>tự động</i> đồng bộ nội dung tài liệu của bạn từ nguồn gốc theo các khoảng thời gian đều đặn. Điều này sẽ tự động cập nhật nội dung trong mọi không gian làm việc nơi tệp này được quản lý.",
  ...
  "chat_window": {
    ...
    "memories": {
      ...
      "modal": {
        ...
        "label": "Bộ nhớ",
        "placeholder": "Ví dụ: Tên người dùng là Joe, người dùng làm việc trên GOV AI VN168, v.v.",
        "create": "Tạo",
        "save": "Lưu",
        "cancel": "Hủy"
      }
    },
    "stt_unsupported": "Chức năng truy cập micro không được hỗ trợ trong trình duyệt này.",
  ...
  "customization": {
    "interface": {
      ...
      "description": "Đặt tùy chọn giao diện của bạn cho GOV AI VN168."
    },
    "branding": {
      "title": "Thương hiệu & Nhãn trắng",
      "description": "Nhãn trắng phiên bản GOV AI VN168 của bạn với thương hiệu tùy chỉnh."
    },
    "chat": {
      "title": "Trò chuyện",
    ...
    "items": {
      ...
      "display-language": {
        ...
        "description": "Chọn ngôn ngữ ưa thích để hiển thị giao diện người dùng của GOV AI VN168 - khi bản dịch có sẵn."
      },
      "logo": {
    ...
    "publish": {
      ...
      "generic": {
        "unauthenticated": {
          ...
          "description": "Bạn cần xác thực với GOV AI VN168 Community Hub trước khi đăng các mục.",
  ...
  "security": {
    ...
    "password": {
      ...
      "description": "Bảo vệ phiên bản GOV AI VN168 của bạn bằng mật khẩu. Nếu bạn quên mật khẩu này, không có phương pháp khôi phục nên hãy đảm bảo lưu mật khẩu này.",
  ...
  "telegram": {
    "title": "Bot Telegram",
    "description": "Kết nối phiên bản GOV AI VN168 của bạn với Telegram để bạn có thể trò chuyện với các không gian làm việc của mình từ bất kỳ thiết bị nào.",
    "setup": {
      "step1": {
  ...
  "scheduledJobs": {
    ...
    "enableNotifications": "Kích hoạt thông báo trình duyệt để nhận kết quả tìm kiếm việc làm",
    "description": "Tạo các tác vụ AI lặp đi lặp lại, chạy theo lịch trình. Mỗi tác vụ sẽ thực hiện một yêu cầu với các công cụ tùy chọn và lưu kết quả để xem xét.",
    ...
    "modal": {
      ...
      "toolsDescription": "Chọn các công cụ hỗ trợ mà công việc này có thể sử dụng. Nếu không chọn công cụ nào, công việc sẽ chạy mà không sử dụng bất kỳ công cụ nào.",
      "toolsSearch": "Tìm kiếm",
      "toolsNoResults": "Không có công cụ nào phù hợp",
      "required": "Yêu cầu",
      "requiredFieldsBanner": "Vui lòng điền đầy đủ các trường thông tin bắt buộc để tạo công việc.",
      "cancel": "Hủy",
      "saving": "Tiết kiệm...",
    ...
    "builder": {
      "fallbackWarning": "Biểu thức này không thể chỉnh sửa trực quan. Để giữ nguyên, hãy chuyển sang chế độ \"Tùy chỉnh\". Hoặc, bạn có thể thay đổi bất kỳ nội dung nào bên dưới để ghi đè lên biểu thức này.",
      "run": "Chạy",
      "frequency": {
        "minute": "mỗi phút",
        "hour": "theo giờ",
