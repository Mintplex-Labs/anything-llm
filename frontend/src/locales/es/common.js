  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        title:
          "Permitir que el agente formule preguntas para aclarar cualquier duda.",
        "beta-badge": "Versión de prueba",
        description:
          "Cuando está activado, los agentes pueden hacer pausas para hacer preguntas aclaratorias breves si su solicitud es ambigua. Desactivado por defecto. No está disponible para ejecuciones de agentes a través de API/programación.",
        "max-per-turn": {
          title: "Número máximo de preguntas por turno.",
          description:
            "¿Cuántas preguntas de aclaración puede hacer el agente en una única respuesta? Cuanto menos, menos interrupciones.",
        },
        timeout: {
          title: "Tiempo de espera (segundos)",
          description:
            "Si el usuario no responde dentro de este plazo, el agente procede basándose en su mejor criterio.",
        },
      },
    },
  },
