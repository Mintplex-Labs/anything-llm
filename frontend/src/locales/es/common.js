...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      "search-document": "Buscar documentos...",
      "no-documents": "No se encontraron documentos",
      no_docs: "No hay documentos en el espacio de trabajo",
      "new-folder": "Nueva carpeta",
      "create-folder": "Crear carpeta",
      "folder-name": "Nombre de la carpeta",
      "enter-folder-name": "Ingrese el nombre de la carpeta",
      "add-tag": "Agregar etiqueta",
      "enter-tag": "Ingrese el nombre de la etiqueta",
      "move-to-folder": "Mover a carpeta",
      "select-folder": "Seleccionar carpeta",
      "document-count": "{{count}} documentos",
      "rename-document": "Renombrar documento",
      "new-name": "Nuevo nombre",
      "enter-new-name": "Ingrese el nuevo nombre",
      "delete-confirmation":
        "¿Está seguro de que desea eliminar estos archivos y carpetas?\nEsto eliminará los archivos del sistema y los eliminará automáticamente de todos los espacios de trabajo existentes.\nEsta acción no se puede deshacer.",
      "removing-message":
        "Eliminando {{count}} documentos y {{folderCount}} carpetas. Por favor espere.",
      "move-success": "{{count}} documentos movidos exitosamente.",
      date: "Fecha",
      type: "Tipo",
      select_all: "Seleccionar todo",
      deselect_all: "Deseleccionar todo",
      remove_selected: "Eliminar seleccionados",
      costs: "*Costo único para incrustación",
