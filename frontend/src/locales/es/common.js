...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "userSetup": {
      ...
      "adminUsernameReq": "El nombre de usuario debe tener al menos 6 caracteres y solo puede contener letras minúsculas, números, guiones bajos y guiones sin espacios.",
  ...
  "welcomeMessage": {
    "part1": "Bienvenido a AnythingLLM, AnythingLLM es una herramienta de IA de código abierto de Mintplex Labs que convierte cualquier cosa en un chatbot entrenado con el que puedes consultar y chatear. AnythingLLM es un software BYOK (trae tus propias claves), por lo que no hay suscripción, tarifa ni cargos por este software fuera de los servicios que deseas utilizar con él.",
    "part2": "AnythingLLM es la forma más fácil de reunir potentes productos de IA como OpenAI, GPT-4, LangChain, PineconeDB, ChromaDB y otros servicios en un paquete ordenado y sin complicaciones para aumentar tu productividad en 100x.",
    "part3": "AnythingLLM puede ejecutarse totalmente de forma local en tu máquina con pocos recursos, ¡ni siquiera notarás que está ahí! No se necesita GPU. También está disponible la instalación en la nube y en las instalaciones.\nEl ecosistema de herramientas de IA se vuelve más poderoso cada día. AnythingLLM facilita su uso.",
  ...
  "profile_settings": {
    ...
    "username_description": "El nombre de usuario solo debe contener letras minúsculas, números, guiones bajos y guiones sin espacios",
