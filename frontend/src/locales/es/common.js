...
const TRANSLATIONS = {
  ...
  "login": {
    ...
    "password-reset": {
      ...
      "description": "Proporcione la información necesaria a continuación para restablecer su contraseña.",
  ...
  "welcomeMessage": {
    ...
    "part2": "AnythingLLM es la forma más sencilla de integrar productos de inteligencia artificial potentes como OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB y otros servicios en un paquete ordenado, sin complicaciones, para aumentar tu productividad en un 100x.",
    "part3": "AnythingLLM puede ejecutarse completamente en tu máquina local con poco impacto, ¡ni siquiera notarás que está ahí! No se necesita GPU. También está disponible la instalación en la nube y en instalaciones locales.\nEl ecosistema de herramientas de inteligencia artificial se vuelve más poderoso cada día. AnythingLLM facilita su uso.",
    "githubIssue": "Crear un problema en GitHub",
    "user1": "¿Cómo empiezo?!",
    "part4": "Es simple. Todas las colecciones se organizan en contenedores que llamamos \"Workspaces\". Los Workspaces son contenedores de archivos, documentos, imágenes, PDFs y otros archivos que se transformarán en algo que los LLM puedan entender y usar en una conversación.\n\nPuedes agregar y eliminar archivos en cualquier momento.",
  ...
  "general": {
    ...
    "delete": {
      ...
      "description": "Eliminar este espacio de trabajo y todos sus datos. Esto eliminará el espacio de trabajo para todos los usuarios.",
      "delete": "Eliminar espacio de trabajo",
      "deleting": "Eliminando espacio de trabajo...",
      "confirm-start": "Estás a punto de eliminar tu",
      "confirm-end": "espacio de trabajo. Esto eliminará todas las incrustaciones de vectores en tu base de datos de vectores.\n\nLos archivos de origen originales permanecerán intactos. Esta acción es irreversible."
    }
  },
  "chat": {
    "llm": {
      "title": "Proveedor LLM del espacio de trabajo",
      "description": "El proveedor y modelo LLM específico que se utilizará para este espacio de trabajo. Por defecto, utiliza el proveedor y configuración del sistema LLM.",
      "search": "Buscar todos los proveedores LLM"
    },
    "model": {
      "title": "Modelo de chat del espacio de trabajo",
      "description": "El modelo de chat específico que se utilizará para este espacio de trabajo. Si está vacío, se utilizará la preferencia LLM del sistema.",
    ...
    "history": {
      ...
      "desc-end": "Cualquier cosa más de 45 probablemente conducirá a fallos continuos en el chat dependiendo del tamaño del mensaje."
    },
    "prompt": {
      "title": "Prompt",
    ...
    "refusal": {
      ...
      "query": "consulta",
      "desc-end": "modo, es posible que desees devolver una respuesta de rechazo personalizada cuando no se encuentre contexto."
    },
    "temperature": {
      "title": "Temperatura de LLM",
      "desc-start": "Esta configuración controla cuán \"creativas\" serán las respuestas de tu LLM.",
      "desc-end": "Cuanto mayor sea el número, más creativas serán las respuestas. Para algunos modelos, esto puede llevar a respuestas incoherentes cuando se establece demasiado alto.",
  ...
  "vector-workspace": {
    ...
    "doc": {
      ...
      "description": "La puntuación mínima de similitud requerida para que una fuente se considere relacionada con el chat. Cuanto mayor sea el número, más similar debe ser la fuente al chat.",
    ...
    "reset": {
      ...
      "confirm": "Estás a punto de restablecer la base de datos de vectores de este espacio de trabajo. Esto eliminará todas las incrustaciones de vectores actualmente incrustadas.\n\nLos archivos de origen originales permanecerán intactos. Esta acción es irreversible.",
  ...
  "agent": {
    "performance-warning": "El rendimiento de los LLM que no admiten explícitamente la llamada de herramientas depende en gran medida de las capacidades y la precisión del modelo. Algunas habilidades pueden estar limitadas o no funcionar.",
    "provider": {
      "title": "Proveedor de LLM del agente del espacio de trabajo",
      "description": "El proveedor y modelo LLM específico que se utilizará para el agente @agent de este espacio de trabajo."
    },
    "mode": {
      "chat": {
      ...
      "description": "El modelo LLM específico que se utilizará para el agente @agent de este espacio de trabajo.",
      "wait": "-- esperando modelos --"
    },
    "skill": {
      ...
      "rag": {
        ...
        "description": "Permitir que el agente aproveche tus documentos locales para responder a una consulta o pedirle al agente que \"recuerde\" piezas de contenido para la recuperación de memoria a largo plazo."
      },
      "view": {
        "title": "Ver y resumir documentos",
        "description": "Permitir que el agente enumere y resuma el contenido de los archivos del espacio de trabajo actualmente incrustados."
      },
      "scrape": {
      ...
      "generate": {
        ...
        "description": "Habilitar al agente predeterminado para generar varios tipos de gráficos a partir de datos proporcionados o dados en el chat."
      },
      "save": {
        "title": "Generar y guardar archivos en el navegador",
        "description": "Habilitar al agente predeterminado para generar y escribir archivos que se guarden y puedan descargarse en tu navegador."
      },
      "web": {
        "title": "Búsqueda en vivo en la web y navegación",
        "desc-start": "Permitir que tu agente busque en la web para responder tus preguntas conectándose a un proveedor de búsqueda en la web (SERP).",
        "desc-end": "La búsqueda en la web durante las sesiones del agente no funcionará hasta que esto esté configurado."
      }
    }
  },
  "recorded": {
  ...
  "appearance": {
    ...
    "logo": {
      ...
      "description": "Sube tu logotipo personalizado para hacer que tu chatbot sea tuyo.",
    ...
    "message": {
      ...
      "description": "Personaliza los mensajes automáticos que se muestran a tus usuarios.",
      "new": "Nuevo",
      "system": "sistema",
      "user": "usuario",
      "message": "mensaje",
    ...
    "icons": {
      ...
      "description": "Personaliza los iconos de pie de página que se muestran en la parte inferior de la barra lateral.",
      "icon": "Icono",
      "link": "Enlace"
    }
  },
  "api": {
    "title": "Claves API",
    "description": "Las claves API permiten al titular acceder y gestionar programáticamente esta instancia de AnythingLLM.",
  ...
  "llm": {
    ...
    "description": "Estas son las credenciales y configuraciones para tu proveedor preferido de chat y incrustación de LLM. Es importante que estas claves estén actualizadas y correctas, de lo contrario AnythingLLM no funcionará correctamente.",
    "provider": "Proveedor de LLM"
  },
  "transcription": {
    "title": "Preferencia de modelo de transcripción",
    "description": "Estas son las credenciales y configuraciones para tu proveedor preferido de modelo de transcripción. Es importante que estas claves estén actualizadas y correctas, de lo contrario los archivos multimedia y de audio no se transcribirán.",
    "provider": "Proveedor de transcripción",
    "warn-start": "El uso del modelo local Whisper en máquinas con RAM o CPU limitadas puede bloquear AnythingLLM al procesar archivos multimedia.",
  ...
  "embedding": {
    ...
    "desc-start": "Cuando uses un LLM que no admita de forma nativa un motor de incrustación, es posible que necesites especificar credenciales adicionales para incrustar texto.",
    ...
    "provider": {
      ...
      "description": "No se requiere configuración cuando se utiliza el motor de incrustación nativo de AnythingLLM."
    }
  },
  "text": {
    "title": "Preferencias de división y fragmentación de texto",
    "desc-start": "A veces, es posible que desees cambiar la forma predeterminada en que los nuevos documentos se dividen y fragmentan antes de ser insertados en tu base de datos de vectores.",
    "desc-end": "Solo debes modificar esta configuración si entiendes cómo funciona la división de texto y sus efectos secundarios.",
    ...
    "overlap": {
      ...
      "description": "Esta es la superposición máxima de caracteres que ocurre durante la fragmentación entre dos fragmentos de texto adyacentes."
    }
  },
  "vector": {
    "title": "Base de datos de vectores",
    "description": "Estas son las credenciales y configuraciones para cómo funcionará tu instancia de AnythingLLM. Es importante que estas claves estén actualizadas y correctas.",
    "provider": {
  ...
  "embeddable": {
    ...
    "description": "Los widgets de chat incrustables son interfaces de chat de cara al público que están vinculadas a un solo espacio de trabajo. Esto te permite crear espacios de trabajo que luego puedes publicar al mundo.",
  ...
  "multi": {
    ...
    "enable": {
      ...
      "description": "Por defecto, serás el único administrador. Como administrador, necesitarás crear cuentas para todos los nuevos usuarios o administradores. No pierdas tu contraseña ya que solo un usuario administrador puede restablecer las contraseñas.",
    ...
    "password": {
      ...
      "description": "Protege tu instancia de AnythingLLM con una contraseña. Si olvidas esta contraseña, no hay método de recuperación, así que asegúrate de guardar esta contraseña."
    },
    "instance": {
  ...
  "privacy": {
    ...
    "description": "Esta es tu configuración para cómo los proveedores de terceros conectados y AnythingLLM manejan tus datos.",
