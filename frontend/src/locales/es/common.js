...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "workspace": {
      ...
      "description": "Crea tu primer espacio de trabajo y comienza a usar AnythingLLM."
    }
  },
  "common": {
    ...
    "exploreMore": {
      ...
      "features": {
        ...
        "slashCommands": {
          ...
          "description": "Ahorra tiempo e inyecta prompts usando comandos de barra personalizados.",
          "primaryAction": "Crear un comando de barra",
          "secondaryAction": "Explorar en el Centro"
        },
        "systemPrompts": {
          "title": "Prompts del sistema",
          "description": "Modifica el prompt del sistema para personalizar las respuestas de IA de un espacio de trabajo.",
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        ...
        "description": "proporcionará respuestas basándose en el conocimiento general del LLM y en el contexto del documento que se encuentre disponible. Para utilizar las herramientas, deberá utilizar el comando \"@agent\"."
      },
      "query": {
        "title": "Consulta",
      ...
      "automatic": {
        "title": "Coche",
        "description": "Utilizará automáticamente las herramientas si el modelo y el proveedor admiten la llamada a herramientas nativas. Si no se admiten las herramientas nativas, deberá utilizar el comando \"@agent\" para utilizar las herramientas."
      }
    },
    "history": {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "description": "Mejora las habilidades naturales del agente predeterminado con estas habilidades preconstruidas. Esta configuración se aplica a todos los espacios de trabajo.",
      "rag": {
      ...
      "save": {
        ...
        "description": "Habilita al agente predeterminado para generar y escribir en archivos que se guardan y se pueden descargar en tu navegador."
      },
      "web": {
        "title": "Búsqueda y navegación web en vivo",
        "desc-start": "Habilita a tu agente para buscar en la web para responder tus preguntas conectándose a un proveedor de búsqueda web (SERP).",
        "desc-end": "La búsqueda web durante las sesiones del agente no funcionará hasta que esto esté configurado."
      }
    }
  },
  "recorded": {
  ...
  "customization": {
    ...
    "items": {
      ...
      "chat-message-alignment": {
        ...
        "description": "Selecciona el modo de alineación de mensajes cuando utilices la interfaz de chat."
      },
      "display-language": {
      ...
      "welcome-messages": {
        ...
        "description": "Personaliza los mensajes de bienvenida que se muestran a tus usuarios. Solo los usuarios no administradores verán estos mensajes.",
        "new": "Nuevo",
        "system": "sistema",
        "user": "usuario",
        "message": "mensaje",
  ...
  "community_hub": {
    "publish": {
      ...
      "slash_command": {
        ...
        "command_description": "Este es el comando de barra que los usuarios escribirán para activar este preajuste.",
