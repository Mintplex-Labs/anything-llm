...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      "no-documents": "ドキュメントが見つかりません",
      no_docs: "ワークスペースにドキュメントがありません",
      "new-folder": "新規フォルダ",
      ...
      "rename-document": "ドキュメントの名前を変更",
      "new-name": "新しい名前",
      "enter-new-name": "新しい名前を入力",
      "delete-confirmation":
        "これらのファイルとフォルダを削除してもよろしいですか？\nこれにより、ファイルがシステムから削除され、既存のすべてのワークスペースから自動的に削除されます。\nこの操作は元に戻せません。",
      "removing-message":
        "{{count}}件のドキュメントと{{folderCount}}件のフォルダを削除中です。お待ちください。",
      "move-success": "{{count}}件のドキュメントを正常に移動しました。",
      date: "日付",
      type: "タイプ",
      select_all: "すべて選択",
      deselect_all: "選択解除",
