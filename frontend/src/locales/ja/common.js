  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        title:
          "エージェントが、不明な点を明確にするための質問をすることができるようにする。",
        "beta-badge": "ベータ版",
        description:
          "有効にすると、エージェントは、プロンプトが曖昧な場合に、簡単な確認のための質問を中断して行うことができます。デフォルトでは無効です。APIやプログラムによるエージェントの実行には使用できません。",
        "max-per-turn": {
          title: "1ターンあたりの質問数",
          description:
            "営業担当者が1回の回答で尋ねる質問の数を最小限に抑えることが望ましい。",
        },
        timeout: {
          title: "応答タイムアウト（秒）",
          description:
            "ユーザーがこの期間内に返信がない場合、担当者は自身の判断で対応を進めます。",
        },
      },
    },
  },
