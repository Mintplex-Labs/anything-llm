...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    directory: {
      ...
      "search-document": "Zoek in documenten...",
      "no-documents": "Geen documenten gevonden",
      no_docs: "Geen documenten in de werkruimte",
      "new-folder": "Nieuwe map",
      "create-folder": "Map maken",
      "folder-name": "Mapnaam",
      "enter-folder-name": "Voer mapnaam in",
      "add-tag": "Tag toevoegen",
      "enter-tag": "Voer tagnaam in",
      "move-to-folder": "Verplaats naar map",
      "select-folder": "Selecteer map",
      "document-count": "{{count}} documenten",
      "rename-document": "Document hernoemen",
      "new-name": "Nieuwe naam",
      "enter-new-name": "Voer nieuwe naam in",
      "delete-confirmation":
        "Weet je zeker dat je deze bestanden en mappen wilt verwijderen?\nDit verwijdert de bestanden uit het systeem en verwijdert ze automatisch uit alle bestaande werkruimten.\nDeze actie kan niet ongedaan worden gemaakt.",
      "removing-message":
        "{{count}} documenten en {{folderCount}} mappen worden verwijderd. Even geduld.",
      ...
      costs: "*Eenmalige kosten voor inbedding",
      save_embed: "Opslaan en inbedden",
    },
    upload: {
