  ...
  agent: {
    ...
    settings: {
      ...
      "clarifying-questions": {
        title: "Laat de agent vragen stellen om verduidelijking",
        "beta-badge": "TESTFASE",
        description:
          "Wanneer deze functie is ingeschakeld, kunnen agenten een korte, verduidelijkende vraag stellen als uw opdracht onduidelijk is. Standaard is deze functie uitgeschakeld. Deze functie is niet beschikbaar voor API- of programmeergerelateerde agentruns.",
        "max-per-turn": {
          title: "Het maximale aantal vragen per beurt",
          description:
            "Hoeveel vragen de agent maximaal kan stellen in één antwoord? Minder vragen zijn minder onderbrekend.",
        },
        timeout: {
          title: "Tijdslimiet voor antwoorden (seconden)",
          description:
            "Als de gebruiker binnen deze tijd niet reageert, neemt de medewerker het besluit op basis van zijn/haar beste oordeel.",
        },
      },
    },
  },
