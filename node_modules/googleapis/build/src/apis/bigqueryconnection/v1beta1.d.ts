...
export declare namespace bigqueryconnection_v1beta1 {
    ...
    export class Resource$Projects$Locations$Connections {
        ...
        create(params?: Params$Resource$Projects$Locations$Connections$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Connection>>;
        ...
        delete(params?: Params$Resource$Projects$Locations$Connections$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        ...
        patch(params?: Params$Resource$Projects$Locations$Connections$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Connection>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateCredential(params: Params$Resource$Projects$Locations$Connections$Updatecredential, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        updateCredential(params?: Params$Resource$Projects$Locations$Connections$Updatecredential, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
