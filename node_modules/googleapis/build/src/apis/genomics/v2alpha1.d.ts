...
export declare namespace genomics_v2alpha1 {
    ...
    export class Resource$Projects$Operations {
        ...
        list(params?: Params$Resource$Projects$Operations$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListOperationsResponse>>;
    ...
    export class Resource$Projects$Workers {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        checkIn(params: Params$Resource$Projects$Workers$Checkin, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        checkIn(params?: Params$Resource$Projects$Workers$Checkin, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$CheckInResponse>>;
    ...
    export class Resource$Workers {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        checkIn(params: Params$Resource$Workers$Checkin, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        checkIn(params?: Params$Resource$Workers$Checkin, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$CheckInResponse>>;
