...
export declare namespace displayvideo_v3 {
    ...
    export class Resource$Advertisers$Adgroups {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        bulkListAdGroupAssignedTargetingOptions(params: Params$Resource$Advertisers$Adgroups$Bulklistadgroupassignedtargetingoptions, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        bulkListAdGroupAssignedTargetingOptions(params?: Params$Resource$Advertisers$Adgroups$Bulklistadgroupassignedtargetingoptions, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$BulkListAdGroupAssignedTargetingOptionsResponse>>;
    ...
    export class Resource$Advertisers$Campaigns {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        listAssignedTargetingOptions(params: Params$Resource$Advertisers$Campaigns$Listassignedtargetingoptions, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        listAssignedTargetingOptions(params?: Params$Resource$Advertisers$Campaigns$Listassignedtargetingoptions, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$BulkListCampaignAssignedTargetingOptionsResponse>>;
    ...
    export class Resource$Advertisers$Insertionorders {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        listAssignedTargetingOptions(params: Params$Resource$Advertisers$Insertionorders$Listassignedtargetingoptions, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        listAssignedTargetingOptions(params?: Params$Resource$Advertisers$Insertionorders$Listassignedtargetingoptions, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$BulkListInsertionOrderAssignedTargetingOptionsResponse>>;
    ...
    export class Resource$Advertisers$Insertionorders$Targetingtypes$Assignedtargetingoptions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Advertisers$Insertionorders$Targetingtypes$Assignedtargetingoptions$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Advertisers$Insertionorders$Targetingtypes$Assignedtargetingoptions$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AssignedTargetingOption>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Advertisers$Insertionorders$Targetingtypes$Assignedtargetingoptions$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Advertisers$Insertionorders$Targetingtypes$Assignedtargetingoptions$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
