...
export declare namespace cloudasset_v1p7beta1 {
    ...
    export class Resource$V1p7beta1 {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        exportAssets(params: Params$Resource$V1p7beta1$Exportassets, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        exportAssets(params?: Params$Resource$V1p7beta1$Exportassets, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        exportAssets(params: Params$Resource$V1p7beta1$Exportassets, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        exportAssets(params: Params$Resource$V1p7beta1$Exportassets, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        exportAssets(params: Params$Resource$V1p7beta1$Exportassets, callback: BodyResponseCallback<Schema$Operation>): void;
