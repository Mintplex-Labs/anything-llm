...
export declare namespace cloudasset_v1p1beta1 {
    ...
    export class Resource$Iampolicies {
         ...
         */
        searchAll(params: Params$Resource$Iampolicies$Searchall, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        searchAll(params?: Params$Resource$Iampolicies$Searchall, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SearchAllIamPoliciesResponse>>;
        searchAll(params: Params$Resource$Iampolicies$Searchall, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        searchAll(params: Params$Resource$Iampolicies$Searchall, options: MethodOptions | BodyResponseCallback<Schema$SearchAllIamPoliciesResponse>, callback: BodyResponseCallback<Schema$SearchAllIamPoliciesResponse>): void;
        searchAll(params: Params$Resource$Iampolicies$Searchall, callback: BodyResponseCallback<Schema$SearchAllIamPoliciesResponse>): void;
        searchAll(callback: BodyResponseCallback<Schema$SearchAllIamPoliciesResponse>): void;
    }
    ...
    export class Resource$Resources {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        searchAll(params: Params$Resource$Resources$Searchall, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        searchAll(params?: Params$Resource$Resources$Searchall, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SearchAllResourcesResponse>>;
        searchAll(params: Params$Resource$Resources$Searchall, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        searchAll(params: Params$Resource$Resources$Searchall, options: MethodOptions | BodyResponseCallback<Schema$SearchAllResourcesResponse>, callback: BodyResponseCallback<Schema$SearchAllResourcesResponse>): void;
        searchAll(params: Params$Resource$Resources$Searchall, callback: BodyResponseCallback<Schema$SearchAllResourcesResponse>): void;
        searchAll(callback: BodyResponseCallback<Schema$SearchAllResourcesResponse>): void;
    }
