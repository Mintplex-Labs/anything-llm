...
export declare namespace eventarc_v1beta1 {
    ...
    export class Resource$Projects$Locations$Triggers {
        ...
        create(params?: Params$Resource$Projects$Locations$Triggers$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        ...
        delete(params?: Params$Resource$Projects$Locations$Triggers$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        ...
        patch(params?: Params$Resource$Projects$Locations$Triggers$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
