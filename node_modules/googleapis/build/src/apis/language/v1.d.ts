...
export declare namespace language_v1 {
    ...
    export interface Schema$XPSStructStats {
         ...
         */
        fieldStats?: {
            [key: string]: Schema$XPSDataStats;
        } | null;
    }
    /**
    ...
    export interface Schema$XPSTableSpec {
         ...
         */
        columnSpecs?: {
            [key: string]: Schema$XPSColumnSpec;
        } | null;
        /**
    ...
    export class Resource$Documents {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        analyzeEntitySentiment(params: Params$Resource$Documents$Analyzeentitysentiment, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        analyzeEntitySentiment(params?: Params$Resource$Documents$Analyzeentitysentiment, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AnalyzeEntitySentimentResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        classifyText(params: Params$Resource$Documents$Classifytext, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        classifyText(params?: Params$Resource$Documents$Classifytext, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ClassifyTextResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        moderateText(params: Params$Resource$Documents$Moderatetext, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        moderateText(params?: Params$Resource$Documents$Moderatetext, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ModerateTextResponse>>;
        moderateText(params: Params$Resource$Documents$Moderatetext, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        moderateText(params: Params$Resource$Documents$Moderatetext, options: MethodOptions | BodyResponseCallback<Schema$ModerateTextResponse>, callback: BodyResponseCallback<Schema$ModerateTextResponse>): void;
        moderateText(params: Params$Resource$Documents$Moderatetext, callback: BodyResponseCallback<Schema$ModerateTextResponse>): void;
        moderateText(callback: BodyResponseCallback<Schema$ModerateTextResponse>): void;
    }
