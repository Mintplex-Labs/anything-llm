...
export declare namespace domains_v1alpha2 {
    ...
    export class Resource$Projects$Locations$Registrations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        configureContactSettings(params: Params$Resource$Projects$Locations$Registrations$Configurecontactsettings, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        configureContactSettings(params?: Params$Resource$Projects$Locations$Registrations$Configurecontactsettings, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        configureDnsSettings(params: Params$Resource$Projects$Locations$Registrations$Configurednssettings, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        configureDnsSettings(params?: Params$Resource$Projects$Locations$Registrations$Configurednssettings, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        configureManagementSettings(params: Params$Resource$Projects$Locations$Registrations$Configuremanagementsettings, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        configureManagementSettings(params?: Params$Resource$Projects$Locations$Registrations$Configuremanagementsettings, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Registrations$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Registrations$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        export(params: Params$Resource$Projects$Locations$Registrations$Export, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        export(params?: Params$Resource$Projects$Locations$Registrations$Export, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Registrations$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Registrations$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Registration>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getIamPolicy(params: Params$Resource$Projects$Locations$Registrations$Getiampolicy, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getIamPolicy(params?: Params$Resource$Projects$Locations$Registrations$Getiampolicy, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Policy>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        import(params: Params$Resource$Projects$Locations$Registrations$Import, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        import(params?: Params$Resource$Projects$Locations$Registrations$Import, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        initiatePushTransfer(params: Params$Resource$Projects$Locations$Registrations$Initiatepushtransfer, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        initiatePushTransfer(params?: Params$Resource$Projects$Locations$Registrations$Initiatepushtransfer, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        initiatePushTransfer(params: Params$Resource$Projects$Locations$Registrations$Initiatepushtransfer, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        initiatePushTransfer(params: Params$Resource$Projects$Locations$Registrations$Initiatepushtransfer, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        initiatePushTransfer(params: Params$Resource$Projects$Locations$Registrations$Initiatepushtransfer, callback: BodyResponseCallback<Schema$Operation>): void;
        initiatePushTransfer(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Registrations$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Registrations$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListRegistrationsResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Registrations$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Registrations$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        register(params: Params$Resource$Projects$Locations$Registrations$Register, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        register(params?: Params$Resource$Projects$Locations$Registrations$Register, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        renewDomain(params: Params$Resource$Projects$Locations$Registrations$Renewdomain, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        renewDomain(params?: Params$Resource$Projects$Locations$Registrations$Renewdomain, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        renewDomain(params: Params$Resource$Projects$Locations$Registrations$Renewdomain, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        renewDomain(params: Params$Resource$Projects$Locations$Registrations$Renewdomain, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        renewDomain(params: Params$Resource$Projects$Locations$Registrations$Renewdomain, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        resetAuthorizationCode(params: Params$Resource$Projects$Locations$Registrations$Resetauthorizationcode, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        resetAuthorizationCode(params?: Params$Resource$Projects$Locations$Registrations$Resetauthorizationcode, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AuthorizationCode>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        retrieveAuthorizationCode(params: Params$Resource$Projects$Locations$Registrations$Retrieveauthorizationcode, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        retrieveAuthorizationCode(params?: Params$Resource$Projects$Locations$Registrations$Retrieveauthorizationcode, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AuthorizationCode>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        retrieveGoogleDomainsDnsRecords(params: Params$Resource$Projects$Locations$Registrations$Retrievegoogledomainsdnsrecords, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        retrieveGoogleDomainsDnsRecords(params?: Params$Resource$Projects$Locations$Registrations$Retrievegoogledomainsdnsrecords, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$RetrieveGoogleDomainsDnsRecordsResponse>>;
        retrieveGoogleDomainsDnsRecords(params: Params$Resource$Projects$Locations$Registrations$Retrievegoogledomainsdnsrecords, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        retrieveGoogleDomainsDnsRecords(params: Params$Resource$Projects$Locations$Registrations$Retrievegoogledomainsdnsrecords, options: MethodOptions | BodyResponseCallback<Schema$RetrieveGoogleDomainsDnsRecordsResponse>, callback: BodyResponseCallback<Schema$RetrieveGoogleDomainsDnsRecordsResponse>): void;
        retrieveGoogleDomainsDnsRecords(params: Params$Resource$Projects$Locations$Registrations$Retrievegoogledomainsdnsrecords, callback: BodyResponseCallback<Schema$RetrieveGoogleDomainsDnsRecordsResponse>): void;
        retrieveGoogleDomainsDnsRecords(callback: BodyResponseCallback<Schema$RetrieveGoogleDomainsDnsRecordsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        retrieveGoogleDomainsForwardingConfig(params: Params$Resource$Projects$Locations$Registrations$Retrievegoogledomainsforwardingconfig, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        retrieveGoogleDomainsForwardingConfig(params?: Params$Resource$Projects$Locations$Registrations$Retrievegoogledomainsforwardingconfig, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$RetrieveGoogleDomainsForwardingConfigResponse>>;
        retrieveGoogleDomainsForwardingConfig(params: Params$Resource$Projects$Locations$Registrations$Retrievegoogledomainsforwardingconfig, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        retrieveGoogleDomainsForwardingConfig(params: Params$Resource$Projects$Locations$Registrations$Retrievegoogledomainsforwardingconfig, options: MethodOptions | BodyResponseCallback<Schema$RetrieveGoogleDomainsForwardingConfigResponse>, callback: BodyResponseCallback<Schema$RetrieveGoogleDomainsForwardingConfigResponse>): void;
        retrieveGoogleDomainsForwardingConfig(params: Params$Resource$Projects$Locations$Registrations$Retrievegoogledomainsforwardingconfig, callback: BodyResponseCallback<Schema$RetrieveGoogleDomainsForwardingConfigResponse>): void;
        retrieveGoogleDomainsForwardingConfig(callback: BodyResponseCallback<Schema$RetrieveGoogleDomainsForwardingConfigResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        retrieveImportableDomains(params: Params$Resource$Projects$Locations$Registrations$Retrieveimportabledomains, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        retrieveImportableDomains(params?: Params$Resource$Projects$Locations$Registrations$Retrieveimportabledomains, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$RetrieveImportableDomainsResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        retrieveRegisterParameters(params: Params$Resource$Projects$Locations$Registrations$Retrieveregisterparameters, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        retrieveRegisterParameters(params?: Params$Resource$Projects$Locations$Registrations$Retrieveregisterparameters, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$RetrieveRegisterParametersResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        retrieveTransferParameters(params: Params$Resource$Projects$Locations$Registrations$Retrievetransferparameters, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        retrieveTransferParameters(params?: Params$Resource$Projects$Locations$Registrations$Retrievetransferparameters, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$RetrieveTransferParametersResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        searchDomains(params: Params$Resource$Projects$Locations$Registrations$Searchdomains, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        searchDomains(params?: Params$Resource$Projects$Locations$Registrations$Searchdomains, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SearchDomainsResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        setIamPolicy(params: Params$Resource$Projects$Locations$Registrations$Setiampolicy, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        setIamPolicy(params?: Params$Resource$Projects$Locations$Registrations$Setiampolicy, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Policy>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        testIamPermissions(params: Params$Resource$Projects$Locations$Registrations$Testiampermissions, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        testIamPermissions(params?: Params$Resource$Projects$Locations$Registrations$Testiampermissions, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$TestIamPermissionsResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        transfer(params: Params$Resource$Projects$Locations$Registrations$Transfer, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        transfer(params?: Params$Resource$Projects$Locations$Registrations$Transfer, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
